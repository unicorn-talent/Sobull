    ...
    NhD9: function (t, e, i) {
      ...
      (function (t) {
        ...
        Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          (r = '<div class="tv-tabbed-dialog__pages-container"></div>'),
          (n = { tabs: [] });
      }.call(this, i('OiQe')));
    },
    pIOw: function (t, e, i) {
        ...
        (g = (function () {
          function t(t, e, i) {
            void 0 === i && (i = {}),
              ...
              (this._prevWidth = -1),
              (this._bindings = []),
              (this._options = Object(r.deepExtend)({}, _, i)),
          ...
          return (
            ...
            (t.prototype.checkScrollArrows = function (t) {
              ...
              void 0 === t && (t = !1),
                ...
                (r = this._getElWidth(this._elScrollWrap)),
                (n = 1),
                (l = this._elScrollWrap.scrollWidth - r - 2),
                this._elArrowLeft &&
                  (a >= n
                    ? e(this._elArrowLeft)
                    : (a <= n || this._elScrollWrap.scrollWidth <= r) &&
                      i(this._elArrowLeft, u.Left)),
                this._elArrowRight &&
                  (l - a > 1
                    ? e(this._elArrowRight)
                    : (a >= l || this._elScrollWrap.scrollWidth <= r) &&
            ...
            (t.prototype.updateSlider = function (t, e, i) {
              ...
              this._options.noSlider ||
                ...
                (n =
                  a.offsetLeft + parseInt(r.getPropertyValue('padding-left'))),
            ...
            (t.prototype._findOrCreateElement = function (t, e, i, s) {
              ...
              if (!n)
                if (
                  ...
                  for (
                    o = Array.prototype.slice.call(e.childNodes), r = 0;
                    r < o.length;
                    r++
                  )
                    n.appendChild(o[r]);
            ...
            (t.prototype._bindEvents = function () {
              ...
              this.getTabsArray().forEach(this._bindTabEvents.bind(this)),
                      ...
                      p.IS_RTL && i.reverse(),
                        ...
                        s().then(function () {
                          $.Velocity.animate(e._elScrollWrap, 'scroll', {
                            ...
                            offset: Math.floor(
                              a - n - e._getElWidth(e._elArrowLeft),
                            ),
                            queue: !1,
                          });
                        });
                  ...
                  this._bindOneEvent({
                    ...
                    listener: function (t) {
                      var i = e.getTabsArray(),
                        ...
                        n = p.IS_RTL
                          ? 0
                          : e._elScrollWrap.scrollLeft +
                            e._getElWidth(e._elScrollWrap);
                      p.IS_RTL && i.reverse(),
                        i.forEach(function (t) {
                          if (0 === r) {
                            var e = t.offsetLeft + t.offsetWidth;
                          ...
                          $.Velocity.animate(e._elScrollWrap, 'scroll', {
                            ...
                            offset: Math.ceil(
                              r -
                                n +
                                e._getElWidth(
                                  Object(a.ensureDefined)(e._elArrowRight),
                                ),
                            ),
                            queue: !1,
                          });
                      ...
                      listener: function (t) {
                        if (!e._animating) {
                          ...
                          i &&
                            ...
                            i.classList &&
                            i.classList.contains(e._options.activeTabClass) &&
                            e._hoverSlider(i);
                        }
                      },
                      target: t,
                ...
                this._bindOneEvent({
                  eventName: 'resize',
                  listener: function () {
                    e.checkScrollArrows(!0),
                      e._options.noSlider || e.resizeSlider();
                  },
                  target: window,
                });
            }),
            ...
            (t.prototype._hoverSlider = function (t) {
              ...
              s().then(function () {
                $.Velocity.animate(i._elSlider, { left: n }, l),
            ...
            (t.prototype._unhoverSlider = function (t) {
              ...
              s().then(function () {
                $.Velocity.animate(e._elSlider, { left: n }, c),
