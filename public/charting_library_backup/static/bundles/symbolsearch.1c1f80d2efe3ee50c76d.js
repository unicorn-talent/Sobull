    ...
    m5UM: function (t, e, i) {
      ...
      (function (e) {
        ...
        i('jgM0'),
          ...
          (p = i('c2JX').Spinner),
          (u = i('glKZ')),
          (h = i('dTSQ').regExpEscape),
          (d = i('ePL1')),
          (g = i('wmOI')),
          (f = i('+GxX').isFeatureEnabled),
          (_ = i('GAqT').TVOldDialogs),
          (m = i('jAh7').getRootOverlapManager),
          (y = i('0waE').guid),
          (v = i('h24c')),
          (b = v.sanitizeIntervalValue),
          (S = v.canShowSpreadActions),
          (E = v.skipAccept),
          (I = v.syncSymbolSearch),
          (x = v.setLinkingResolution),
          (T = v.globalKeypressMatches),
          (w = f('futures-descriptions')),
          (C =
          ...
          (L = (function () {
            function t(i) {
              ...
              for (
                this._state = {},
                  ...
                  n = this._boundListener = this._eventListener.bind(this),
                ...
                M[o].immediate
                  ? $(this._inputElement).on(M[o].name, n)
                  : $(this._inputElement).on(M[o].name, s);
            ...
            function v(t, e) {
              ...
              if (
                ...
                (s = TVSettings.getValue('symboledit.exchangefilter')),
                (i = /_MINI$/.test(s) ? '' : s),
            ...
            return (
              ...
              (t.registerAutoFocus = function (e) {
                if (
                  (e instanceof jQuery &&
                    (e = e.data('symbol-search-instance')),
                  !(e instanceof t))
                )
                  throw new TypeError(
              ...
              (t.prototype._moveSelection = function (t, e) {
                var i, n, s, o, r, a, l, c;
                this.$list &&
                  ((n = (i = this.$list.find('table.symbol-edit-popup')).find(
                    'tr:not(.hidden)',
                  )),
                  (o =
                    0 !==
                    (s = i
                      ...
                      .removeClass('symbol-edit-popup-active')).length
                      ? n.index(s)
                      : -1) !==
                    (r =
                      1 === t
                        ...
                        : Math.max(-1, o + t)) &&
                    (a = n.get(r)) &&
                    ((l = this._getItemByElement(a)),
                    A.isRoot(l)
                      ? ((c = a.getAttribute('data-root')),
              ...
              (t.prototype._onKeyDown = function (t) {
                (t.keyCode !== g.DOWN_ARROW && t.keyCode !== g.UP_ARROW) ||
                  (this._moveSelection(t.keyCode === g.DOWN_ARROW ? 1 : -1, !0),
                  t.preventDefault(),
                  t.stopPropagation()),
                  t.keyCode === g.ENTER && t.stopPropagation(),
                  !this._selectedGroupRoot ||
                    (t.keyCode !== g.LEFT_ARROW &&
                      t.keyCode !== g.RIGHT_ARROW) ||
              ...
              (t.prototype._onKeyPress = function (t) {
                if (t.keyCode === g.DOWN_ARROW || t.keyCode === g.UP_ARROW) {
                  ...
                  this._moveSelection(t.keyCode === g.DOWN_ARROW ? 1 : -1),
                    t.preventDefault();
                }
                t.keyCode === g.ENTER &&
                  (this._selectedGroupRoot
              ...
              (t.prototype._eventListener = function (t, i) {
                ...
                e.enabled('uppercase_instrument_names') &&
                  ...
                  (o = this._limitInputSelectionValue('selectionStart')),
                  this._state.selectionStart !== o &&
                    ((this._state.selectionStart = o), (s = !0)),
                  (r = this._limitInputSelectionValue('selectionEnd')),
                  this._state.selectionEnd !== r &&
                    ((this._state.selectionEnd = r), (s = !0)),
                  this._state.selectionDirection !== l.selectionDirection &&
                    ((this._state.selectionDirection = l.selectionDirection),
                    (s = !0)),
                  (n || (s && this._inputParserMixin)) &&
                    (this._onSelectionChanged(void 0, i),
                    (a = !1),
                    this._getInputValue() !== this._state.value &&
                      (this._setInputValue(this._state.value), (a = !0)),
                    (a ||
              ...
              (t.prototype._onSelectionChanged = function (t, e) {
                function i(t, e, i, n, o) {
                  (s._state.contextTicker = t),
                    (s._state.contextExchange = e),
                    (s._state.contextType = i),
                    (s._state.contextTradable = o),
                    (s._state.keepListFor && s._state.keepListFor === n) ||
                      (s._getSuggestList(), delete s._state.keepListFor);
                }
                var n,
                  s = this,
                  o = F.some(function (t) {
                    return t.test(s._state.value);
                  });
                !o &&
              ...
              (t.prototype._doGetSuggestList = function () {
                ...
                this._clearSearchTimeout(),
                  ...
                  ChartApiInstance.searchSymbols(
                    ...
                    r,
                    function (t) {
                      e !== (l._state.contextTicker || '') ||
                        i !==
                          (l._state.contextExchange ||
                            l.getExchangeFilter() ||
                            '') ||
                        n !== (l._state.typeFilter || '') ||
                        (n === d.types.QUANDL &&
                          (t = l._processQuandlResponse(t)),
                        l._renderSuggestList(t),
                        l._onResponse(t));
                    },
                  );
              }),
              ...
              (t.prototype._showLoading = function () {
                if (this.$list && !this._spinner) {
                  ...
                  this._spinner = new p('medium').spin(t.get(0));
                }
              }),
              (t.prototype._groupContracts = function (t) {
                var e,
                  ...
                  s,
                  o,
                  r = ChartApiInstance.futuresRegex(),
                  a = {},
                  l = [];
                for (e = 0; e < t.length; ++e) {
                  if ((i = t[e]).prefix || Array.isArray(i.contracts)) return t;
                  'futures' === i.type
                    ? (n = r.exec(i.symbol))
                      ? ((s = n[1]) in a
                          ? (o = a[s])
                          : ((o = l.length),
                            ...
                            l.push({
                              ...
                              full_name: i.exchange + ':' + s,
                              contracts: [],
                            })),
                        l[o].contracts.push(i))
                      : l.push(i)
                    : l.push(i);
                }
                return l;
              ...
              (t.prototype._renderSuggestList = function (i) {
                ...
                if (this.$list)
                  if (
                    ...
                    (s = this._state),
                    this._clearSuggestList(),
                    (o = h(s.contextTicker).trim()),
                    (r = new RegExp(
                      o.replace(' ', '|'),
                      'i' + (o.length > 1 ? 'g' : ''),
                    )),
                    delete s.highlightedItem,
                    this._hidePro &&
                    ...
                    for (
                      (a = document.createElement('table')).setAttribute(
                        'class',
                        'symbol-edit-popup',
                      ),
                        l = {},
                        c = new t.GroupListHandler(a, r, l),
                        p = null,
                      ...
                      (d = i[u]),
                        c.append(d),
                        p ||
                          d.ticker !== s.contextTicker ||
                          d.exchange !== s.contextExchange ||
                          (p = d),
                        this._renderedResponse.push(d);
                    e.enabled('expand_symbolsearch_items') || c.collapse(),
                      (this._groupListHandler = c),
                      p && this._highlightItem(d),
                      $(a)
              ...
              (t.prototype._isEmptySuggestList = function () {
                return !Boolean(
              ...
              (t.prototype._highlightItem = function (t, e, i) {
                var n,
                  ...
                  o = this._state;
                o.highlightedItem &&
                  (n = this._getElementByItem(o.highlightedItem)) &&
                  $(n).removeClass('symbol-edit-popup-active'),
                  (o.highlightedItem = t),
                  (s = this._getElementByItem(o.highlightedItem)) &&
              ...
              (t.prototype._replaceCurrentSymbol = function (t) {
                ...
                if (o.highlightedItem) {
                  if (
                    ...
                    if (
                      !(s = this._inputParserMixin.replaceCurrentSymbol(e)).ok
                    )
                      return;
                    (i = s.newValue),
                      (n = s.newCaretPos),
                      (o.keepListFor = s.keepListFor);
                  } else
                    (this._state._selectedTicker = e.ticker || e.symbol),
                      (o.keepListFor = this._state._selectedTicker),
                      (n = (i =
                        !0 === t && e.full_name && this._inputParserMixin
                          ? e.full_name
                          : e.symbol).length);
                  this._setInputValue(N ? i.replace(O, '') : i),
                ...
                var n = this,
                  s = function () {
                    if ((i = i || e) || ('' === i && n.acceptEmpty)) {
                      ...
                      var s = n._ignoreInterval ? void 0 : t.getInterval(!0);
                      (n._inputElement.value = e),
                        n._eventListener(),
                        n._callback && n._callback(i, s),
              ...
              (t.prototype.selectExchangeFilter = function () {
                this.$filterContainer.find('.exchange-filter').hide(),
                  this._state.typeFilter === d.types.QUANDL
                    ? this.$filterContainer.find('#quandl-filter').show()
                    : this._state.typeFilter !== d.types.ECONOMIC &&
              ...
              (t.prototype._getUnhideSymbolSearchGroups = function () {
                var t,
                  e = '',
                  i = n();
                return (
                  i &&
                    ((t = i.metainfo().configFlags
                      .supportUnhideSymbolSearchGroups),
                    i.connectionStatus() === CONNECTSTATUSES.CONNECTED &&
                      t &&
                      (e = i.unhideSymbolSearchGroups().join(',')),
                    tradingService().trackEvent(
                      'Symbol Search Tradable checkbox',
                      s() && this._state.tradableFilter ? 'on' : 'off',
                    )),
                  e
                );
              }),
              ...
              (t.createSuggestListRow = function (e, i, n, s) {
                var a, l, c, p, u, h, d, g, f, _, m, y, v, b;
                return (
                  s || (s = {}),
                  (a = document.createElement('tr')),
                  (l = 'symbol-edit-popup'),
                  s.addClass && (l += ' ' + s.addClass),
                  ...
                  (u = c
                    ? e.symbol.replace(i, '<strong>$&</strong>')
                    : e.symbol),
                  (h = s.nameContent || u),
                  e.broker_symbol &&
                    (h =
                      ...
                      ' (' +
                      (c
                        ? e.broker_symbol.replace(i, '<strong>$&</strong>')
                        : e.broker_symbol) +
                      ')'),
                  (p.innerHTML = h),
                  (d = document.createElement('td')).setAttribute(
                    'class',
                  ...
                  w &&
                    ...
                    (g += (f = R.exec(e.contractDescription))
                      ? ' (' + r(n, f[1]) + ' ' + f[2] + ')'
                      : ' (' + r(n, e.contractDescription) + ')'),
                  (d.innerHTML =
                    !c || i.test(e.symbol)
                      ? g
                      : g.replace(i, '<strong>$&</strong>')),
                  (_ = document.createElement('td')).setAttribute(
                    'class',
                  ...
                  s.typeContent
                    ? (m = s.typeContent)
                    : (e.params &&
                        ~e.params.indexOf('eod') &&
                        (m = '<i class="eod">eod</i>&nbsp;'),
                      (y = r(n, e.type)),
                      e.exchange ? (m += y + ' - ' + o(e)) : (m += y)),
                  (_.innerHTML = m),
                  (v = document.createElement('td')).setAttribute(
                    'class',
                    'symbol-edit-popup-td flag apply-overflow-tooltip',
                  ),
                  (v.innerHTML = t.getItemFlag(e)),
                  (b = v.getElementsByTagName('svg')[0]) &&
                    b.setAttribute('class', 'flag'),
                  a.appendChild(p),
                  a.appendChild(d),
                  a.appendChild(_),
                  a.appendChild(v),
              ...
              (V = function (t, i, n, s) {
                !(i = l.displayedExchangesFilter(i)).some(function (t) {
                  return t.value === n;
                }) &&
                  i.length > 0 &&
                  (n = i[0].value);
                var o = $('<select>').appendTo(s);
              ...
              (t.showDialog = function (e) {
                var n, s, o, r, a, l, c, p, u, h, d, g;
                if (((e = e || {}), (n = 'Symbol Search'), !_.get(n)))
                  return (
                    (s = _.createDialog(n, {
                      hideTitle: !0,
                      hideCloseCross: !0,
                    ...
                    (r = (o = s
                      ...
                      .addClass('symbol-search-dialog')).find('.results')),
                    (a = o.find('input').get(0)),
                    e.initialValue && (a.value = e.initialValue),
                    'selectionStart' in a &&
                      (a.selectionStart = a.selectionEnd = a.value.length),
                    a.focus(),
                    S() &&
                      (e.ignoreInterval ||
                        ((c = t.getInputValueGetter(a)),
                        (p = t.getInputValueSetter(a))),
                      (l = SymbolSearchInputParserMixin.addSpreadActions(
                    ...
                    (u = new t({
                      ...
                      callback: function (t, i) {
                        e.callback && e.callback(t, i), _.destroy(n);
                      },
                      onParse: l,
                    ...
                    (d = i(u, h)),
                    (g = L(u)),
                    d || g || h.attr('style', 'display: none'),
                    _.resizeContent(s.height(), r),
                    _.applyHandlers(s),
                    _.positionDialog(s),
              ...
              (t.bindToInput = function (n, s) {
                function o() {
                  b &&
                    ...
                    (b = null),
                    u.hide(),
                    'function' == typeof s.onPopupClose && s.onPopupClose());
                }
                function r(t) {
                  t.preventDefault();
                }
                ...
                var c, p, h, d, f, _, v, b, T, w, C, k, R, A, F, O;
                return (
                  (s = s || {}),
                  (n = $(n).eq(0)),
                  (c = y()),
                  (p = n.prop('ownerDocument')),
                  (h = s.overlapManager || m(p)),
                  (d = s.callback),
                  (f = null),
                  (_ = null),
                  (v = !1),
                  (b = null),
                  (w = s.spreadActions && $(s.spreadActions).eq(0)) &&
                    w.size() &&
                    S() &&
                    (s.ignoreInterval ||
                      ((C = t.getInputValueGetter(n.get(0))),
                      (k = t.getInputValueSetter(n.get(0)))),
                    (T = SymbolSearchInputParserMixin.addSpreadActions(
                      w,
                      n.get(0),
                      C,
                      k,
                  ...
                  (R = new t({
                    ...
                    onValueChanged: function () {
                      var t, n, o, a, l;
                      b ||
                        ((t = h.ensureWindow(c, { position: 'relative' })),
                        (n = (function (t, e) {
                          var n,
                            s,
                            o,
                            ...
                            p,
                            u,
                            h = $('<div class="symbol-edit-popup">').appendTo(
                              e,
                            ),
                            d = $('<div class="filter">').appendTo(h);
                          return (
                            (t.$filterContainer = d),
                            i(t, d),
                            L(t),
                            (n = $('<div class="table-wrapper">').appendTo(h)),
                            (o = (s = $(t._inputElement)).offset()),
                            (r = 0),
                            (a = Math.max(
                              0,
                              Math.min(
                                o.left + r,
                                $(window).width() - h.outerWidth(),
                              ),
                            )),
                            h.css('left', a + 'px'),
                            h.css('top', o.top + s.outerHeight() + 1),
                            (l = d.outerHeight()),
                            (c = $(window).scrollTop()),
                            (p = s.height()),
                            (u =
                              ...
                              (o.top - c) -
                              p / 2),
                            n.css('maxHeight', u - p - l + 'px'),
                            { popup: h, listWrapper: n }
                          );
                        })(R, t)),
                        (b = n.popup),
                        R.bindListWrapper(n.listWrapper),
                        b.on('focus', r),
                        b.on('click', r),
                        b.on('mousedown', r),
                        b.on('focus', '*', r),
                        b.on('click', '*', r),
                        b.on('mousedown', '*', r),
                        'function' == typeof s.onPopupOpen &&
                          s.onPopupOpen(n.popup)),
                        e.enabled('charting_library_base') &&
                          (o = this._state).keepListFor &&
                          (o.highlightedItem
                            ? ((a = o.highlightedItem),
                              (l = this._getInputValue()),
                              e.enabled('uppercase_instrument_names') &&
                                (l = l.toUpperCase()),
                              a.symbol !== l && delete this._state.keepListFor)
                            : delete this._state.keepListFor);
                    },
                    callback: function (t, e) {
                      o(),
                        ('function' == typeof _ && _(t, e)) ||
                          ('function' == typeof d && d(t, e),
                          'function' == typeof f && f(t, e)),
                        s.clearAfterAccept && n.val(''),
                        s.keepFocus ? n.get(0).focus() : n.get(0).blur(),
                        R.resetState();
                    },
                    hidePro: s.hidePro,
                    autoFocus: s.autoFocus,
                    onEmptyApply: s.onEmptyApply,
                    onParse: T,
                    acceptEmpty: s.acceptEmpty,
                    dontUseInputParser: s.dontUseInputParser,
                    allowMultipleSymbols: s.allowMultipleSymbols,
                    ignoreInterval: s.ignoreInterval,
                  })),
                  (A = !1),
                  (F = !0),
                  TradingView.isMobile.iOS() &&
                    $('body').css('cursor', 'pointer'),
                  n.on('focus', function (t, e) {
                    (A = !0),
                      (v = !0),
                      R._skipAutoFocus
                        ? delete R._skipAutoFocus
                        : setTimeout(function () {
                            A && n.get(0).select();
                          }, 0);
                  }),
                  n.on('blur', function (t) {
                    ...
                    TradingView.isMobile.iOS() && F && ((F = !1), (A = !0)),
                      TradingView.isMobile.iOS() &&
                      A &&
                      null === t.relatedTarget
                        ? ((r = function (t) {
                            $(t.target).closest(b).length ||
                              ($(a).is($(t.target))
                                ? $(document).off('touchend', 'body', r)
                                : ((A = !1),
                                  setTimeout(function () {
                                    o(), $(document).off('touchend', 'body', r);
                                  }, 0)));
                          }),
                  ...
                  s.syncWithChartWidget &&
                    (l(!0),
                    a.seriesShortSymbol.subscribe(function () {
                      l(!0);
                    }),
                    (f = function (t, e) {
                      (v = !(t || e)), t && a.symbol.setValue(t), e && x(e);
                    }),
                    (_ = E),
                    s.syncOnBlur &&
                      n.on('blur', function () {
              ...
              (A.prototype.addRoot = function (t, e) {
                var i, n;
              ...
              (A.prototype.append = function (e) {
                ...
                if (A.isRoot(e))
                  for (
                    i = e.symbol,
                      ...
                      c = t.createSuggestListRow(
                        ...
                        this._translationCache,
                        {
                          nameContent:
                            ...
                            '</div>',
                          typeContent:
                            r(this._translationCache, e.type) +
                            (e.exchange && ' - ' + o(e)),
                      ...
                      s = 0;
                    s < e.contracts.length;
                    ++s
                  )
                    (a = e.contracts[s]),
                      (l = t.createSuggestListRow(
                        a,
                        this._tickerRegExp,
                        this._translationCache,
                      )),
                      (p = a.ticker || a.full_name),
                      (this._itemsByTicker[p] = a),
                      l.setAttribute('data-item-ticker', p),
                ...
                (p = e.ticker || e.full_name),
                  (this._itemsByTicker[p] = e),
                  c.setAttribute('data-item-ticker', p);
              }),
              (A.prototype.toggleCollapsed = function (t, e) {
                var i;
                if (t)
                  (i = this._roots[t]) &&
              ...
              (A.prototype.collapse = function (t) {
                this.toggleCollapsed(t, !0);
              }),
              (A.prototype.expand = function (t) {
                this.toggleCollapsed(t, !1);
              }),
              (A.prototype.getItemByTicker = function (t) {
                return this._itemsByTicker[t] || null;
              }),
              (t.GroupListHandler = A),
              ...
              (t.detachStoreInterval = function (e) {
                var i = t.detachInterval(e);
                return i
                  ? ((D = i.detached), (P = b(D)), i.rest)
                  : (t.resetStoredInterval(), e);
              }),
              ...
              (t.getInterval = function (e) {
                var i = P;
                return !0 === e && t.resetStoredInterval(), i;
              }),
