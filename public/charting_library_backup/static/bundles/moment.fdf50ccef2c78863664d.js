      ...
      (function (e) {
        e.exports = (function () {
          ...
          function Y(e, t) {
            var n;
            return (
              e && (n = void 0 === t ? L(e) : D(e, t)) && (xe = n), xe._abbr
            );
          }
          function D(e, t) {
            return null !== t
          ...
          function P(e, t) {
            ...
            var i = 5;
            for (Et.lastIndex = 0; i >= 0 && Et.test(e); )
              (e = e.replace(Et, n)), (Et.lastIndex = 0), (i -= 1);
            return e;
          }
          function x(e, t, n) {
            var i;
            ...
            if (!e._d) {
              for (
                i = (function (e) {
                  ...
                  e._w &&
                    ...
                    (function (e) {
                      ...
                      null != (t = e._w).GG || null != t.W || null != t.E
                        ? ((s = 1),
                          (o = 4),
                          (n = $(t.GG, e._a[rn], q(te(), 1, 4).year)),
                          (i = $(t.W, 1)),
                          (a = $(t.E, 1)))
                        : ((s = e._locale._week.dow),
                          (o = e._locale._week.doy),
                          (n = $(t.gg, e._a[rn], q(te(), s, o).year)),
                          (i = $(t.w, 1)),
                          null != t.d
                            ? (a = t.d) < s && ++i
                            : (a = null != t.e ? t.e + s : s)),
                  ...
                  e._dayOfYear &&
                    ((a = $(e._a[rn], i[rn])),
                    e._dayOfYear > R(a) && (d(e)._overflowDayOfYear = !0),
                    (n = V(a, 0, e._dayOfYear)),
          ...
          function X(e) {
            if (e._f !== t.ISO_8601) {
              ...
              var n,
                ...
                l = 0;
              for (
                a = P(e._f, e._locale).match(Nt) || [], n = 0;
                n < a.length;
                n++
              )
                (s = a[n]),
          ...
          for (
            W('M', ['MM', 2], 'Mo', function () {
              ...
              x('hh', $t, Vt),
              C(['H', 'HH'], ln),
              C(['a', 'A'], function (e, t, n) {
                (n._isPm = n._locale.isPM(e)), (n._meridiem = e);
              }),
              C(['h', 'hh'], function (e, t, n) {
            ...
            x(ot, en);
          for (ot = 'S'; ot.length <= 9; ot += 'S') C(ot, Le);
          return (
            (rt = v('Milliseconds', !1)),
            W('z', 0, 0, 'zoneAbbr'),
            W('zz', 0, 0, 'zoneName'),
            ...
            (Ft = We('years')),
            (Pt = Math.round),
            (xt = { s: 45, m: 45, h: 22, d: 26, M: 11 }),
            (zt = Math.abs),
            ((Ct = ie.prototype).abs = function () {
              var e = this._data;
              return (
            ...
            (t.relativeTimeThreshold = function (e, t) {
              return (
                void 0 !== xt[e] && (void 0 === t ? xt[e] : ((xt[e] = t), !0))
              );
            }),
            t
          );
