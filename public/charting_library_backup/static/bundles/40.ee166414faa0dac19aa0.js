    ...
    bvfV: function (e, t, n) {
      ...
      function i(e) {
        var t = e.property,
          ...
          o = e.className,
          l = e.name,
          c = Q.a.createElement('span', { className: oe.title }, i);
        return Q.a.createElement(
          r,
          { className: o },
          t &&
      ...
      function c(e) {
        ...
        return Q.a.createElement(
          le.a,
          Object(q.__assign)({}, e, { lineStyle: a, lineStyleChange: r }),
        );
      }
      function s(e) {
        function t(e, t) {
        ...
        return Q.a.createElement(ce.a, {
          ...
          items:
            ((n = i),
            n.map(function (e) {
              return { value: e, selectedContent: t(e, !0), content: t(e) };
            })),
          value: a,
          onChange: l,
      ...
      function u(e) {
        ...
        return Q.a.createElement(
          s,
          Object(q.__assign)({}, e, { value: a, onChange: r }),
        );
      }
      function d(e, t, n) {
      ...
      function p(e) {
        ...
        return Q.a.createElement(
          m,
          Object(q.__assign)({}, n, { valueHash: r, sharedBuffer: s }),
        );
      }
      function m(e) {
        ...
        return Q.a.createElement(
          ...
          Object(q.__assign)({}, i, {
            ...
            onKeyDown: function (e) {
              if (!e.defaultPrevented && !p.flushed)
                switch (Object(me.hashFromEvent)(e.nativeEvent)) {
                  case 27:
                    s(), (p.flushed = !0);
                    break;
                  case 13:
                    e.preventDefault();
                    var t = Object(pe.ensureNotNull)(
                      d.current,
                    ).getClampedValue();
            ...
            onBlur: function (e) {
              var t,
                n = Object(pe.ensureNotNull)(u.current);
              n.contains(document.activeElement) ||
                n.contains(e.relatedTarget) ||
                null ===
                  (t = Object(pe.ensureNotNull)(d.current).getClampedValue()) ||
                p.flushed ||
                (l(t), c(), (p.flushed = !0));
            },
            value: o,
      ...
      function f(e, t, n) {
        return (
          null !== (t = g(t)) && void 0 !== n && (n = Math.max(b(t), n)),
          (function (e, t) {
            if (null === e) return '';
      ...
      function b(e) {
        ...
        return Object(he.clamp)(
          be.NumericFormatter.formatNoE(e).length - t.length - 1,
          0,
          15,
        );
      }
      ...
      function E(e) {
        var t = e.color,
          ...
          o = i[0],
          l = i[1],
          c = $(n ? { property: n } : { defaultValue: void 0 }),
          s = c[0],
          u = c[1];
        return Q.a.createElement(
          we.a,
          Object(q.__assign)({}, e, {
            ...
            onColorChange: function (e) {
              var t = o
                ? Object(Ne.alphaToTransparency)(Object(ye.parseRgba)(o)[3])
                : 0;
            ...
            onOpacityChange: r
              ...
              : function (e) {
                  l(
                    Object(Ne.generateColor)(
                      o,
                      Object(Ne.alphaToTransparency)(e),
                      !0,
                    ),
                  );
                },
      ...
      function _(e) {
        ...
        return Q.a.createElement(
          Me,
          Object(q.__assign)({}, e, { lineEnd: a, lineEndChange: r }),
        );
      }
      function y(e) {
        var t = e.children,
        ...
        return K.createElement(
          ...
          K.Children.map(t, function (e) {
            return K.isValidElement(e)
              ? K.createElement(
                  'span',
                  { key: null === e.key ? void 0 : e.key, className: Te.row },
                  e,
                )
              : e;
          }),
      ...
      function w(e) {
        var t,
          ...
          O = e.offset,
          V = $({ property: l, defaultValue: !0 })[0],
          j = $({ property: s, defaultValue: !1 })[0],
          x = Re({ watchedValue: g, defaultValue: void 0 }),
          M = Re({ watchedValue: w, defaultValue: void 0 }),
          T = Re({ watchedValue: N, defaultValue: void 0 }),
          P = Re({ watchedValue: C, defaultValue: void 0 }),
          R = e.disabled || !V;
        return Q.a.createElement(
          K.Fragment,
          null,
          Q.a.createElement(
            ...
            Q.a.createElement(
              y,
              { className: Fe.line, breakPoint: 'Small' },
              Q.a.createElement(
                K.Fragment,
                null,
                (function () {
                ...
                (n = e.definition.properties.style) &&
                  Q.a.createElement(
                    'span',
                    { className: Fe.control },
                    Q.a.createElement(c, { property: n, disabled: R }),
                  ),
              ),
              (d || m || f) &&
                Q.a.createElement(
                  ...
                  f &&
                    Q.a.createElement(
                      ...
                      Q.a.createElement('span', { className: Fe.valueUnit }, P),
                    )),
                ),
            ),
          ),
      ...
      function N(e) {
        var t = e.definition,
          ...
          u = t.noAlpha,
          d = e.offset,
          p = $({ property: l, defaultValue: !0 })[0],
          m = $({ property: c, defaultValue: !1 })[0],
          f = e.disabled || !p;
        return Q.a.createElement(
          o,
          { id: n, offset: d, checked: l, title: s, disabled: e.disabled || m },
          Q.a.createElement(
            r,
            null,
            Q.a.createElement(E, { color: i, disabled: f, noAlpha: u }),
          ),
        );
      }
      function C(e) {
      ...
      function S(e) {
        ...
        return K.createElement(
          C,
          Object(q.__assign)({}, n, { value: r, onChange: i }),
        );
      }
      function k(e) {
        var t = e.definition,
          ...
          s = t.title,
          u = e.offset,
          d = $({ property: l, defaultValue: !0 })[0],
          p = $({ property: c, defaultValue: !1 })[0],
          m = e.disabled || !d;
        return Q.a.createElement(
          o,
          { id: n, offset: u, checked: l, title: s, disabled: e.disabled || p },
          Q.a.createElement(
            r,
            null,
            Q.a.createElement(S, { property: i, disabled: m }),
          ),
        );
      }
      function O(e) {
        function t(e, t) {
          return Q.a.createElement(
            ...
            Q.a.createElement(E, { color: e, disabled: v, noAlpha: t }),
          );
        }
        var n = e.definition,
          a = n.id,
          ...
          m = n.noAlpha2,
          f = e.offset,
          h = $({ property: s, defaultValue: !0 })[0],
          b = $({ property: u, defaultValue: !1 })[0],
          v = e.disabled || !h;
        return Q.a.createElement(
          o,
          { id: a, offset: f, checked: s, title: d, disabled: e.disabled || b },
          Q.a.createElement(r, { className: Ie.twoColors }, t(l, p), t(c, m)),
        );
      }
      function V(e) {
        var t = e.property,
      ...
      function j(e) {
        var t = e.definition,
          ...
          v = t.type,
          g = e.offset,
          E = $({ property: i, defaultValue: !0 })[0],
          _ = $({ property: s, defaultValue: !1 })[0],
          w = Re({ watchedValue: u, defaultValue: void 0 }),
          N = Re({ watchedValue: d, defaultValue: void 0 }),
          C = Re({ watchedValue: m, defaultValue: void 0 }),
          S = Re({ watchedValue: h, defaultValue: void 0 }),
          k = Object(K.useContext)(De.b),
          O = e.disabled || !E;
        return Q.a.createElement(
          o,
          { id: n, offset: g, checked: i, title: f, disabled: e.disabled || _ },
          Q.a.createElement(
            r,
            null,
            Q.a.createElement(
            ...
            Q.a.createElement('span', { className: Le.unit }, S),
          ),
        );
      }
      function x(e) {
        var t = e.definition,
          ...
          c = t.title,
          s = e.offset,
          u = $({ property: r, defaultValue: !0 })[0],
          d = $({ property: i, defaultValue: !1 })[0],
          p = e.disabled || !u;
        return Q.a.createElement(
          Q.a.Fragment,
          null,
      ...
      function T(e) {
        ...
        return Q.a.createElement(
          ...
          Q.a.createElement(Ue.a, { className: Xe.icon, icon: a }),
        );
      }
      function P(e) {
        var t = e.icon,
      ...
      function R(e) {
        ...
        return K.createElement(
          ...
          l && K.createElement('span', { className: ae(qe.shadow, _) }),
        );
      }
      function F(e) {
        return (
          (e = Object(Ye.a)(e)), K.createElement(R, Object(q.__assign)({}, e))
        );
      }
      function B(e) {
        var t = e.property,
      ...
      function z(e) {
          ...
          return Q.a.createElement(
            ...
            u &&
              Q.a.createElement(
                ...
                Q.a.createElement(E, { color: u, disabled: te }),
              ),
            d &&
              V &&
              Q.a.createElement(M, { property: d, fontSizes: V, disabled: te }),
          );
        }
        function a() {
          return Q.a.createElement(
        ...
        var l = e.definition,
          ...
          W = $({ property: p, defaultValue: !0 })[0],
          L = $({ property: m, defaultValue: !1 })[0],
          H = $({ property: g, defaultValue: void 0 }),
          U = H[0],
          X = H[1],
          G = $({ property: v, defaultValue: void 0 }),
          Y = G[0],
          q = G[1],
          J = $({ property: _, defaultValue: !1 })[0],
          Z = $({ property: N, defaultValue: !1 })[0],
          te = e.disabled || !W;
        return Q.a.createElement(
          K.Fragment,
          null,
          O
            ? Q.a.createElement(
                ...
                Q.a.createElement(y, { breakPoint: 'Small' }, n(), a()),
              )
            : Q.a.createElement(
                ee.a.Row,
                null,
      ...
      function A(e) {
        var t = e.definition,
          ...
          E = Re({ watchedValue: l, defaultValue: void 0 }),
          _ = Re({ watchedValue: c, defaultValue: void 0 }),
          w = Re({ watchedValue: s, defaultValue: void 0 }),
          N = Re({ watchedValue: u, defaultValue: void 0 }),
          C = Re({ watchedValue: d, defaultValue: void 0 }),
          S = Re({ watchedValue: m, defaultValue: void 0 });
        return Q.a.createElement(
          ee.a.Row,
          null,
          Q.a.createElement(
            ...
            Q.a.createElement('span', { className: $e.coordinates }, f),
          ),
          (a || r) &&
            Q.a.createElement(
              ee.a.Cell,
              { placement: 'last', offset: v, 'data-section-name': o },
              Q.a.createElement(
                y,
                { breakPoint: 'Medium' },
                r &&
      ...
      function I(e) {
        var t = e.definition,
          ...
          u = t.options,
          d = e.offset,
          p = $({ property: i, defaultValue: !0 })[0],
          m = $({ property: c, defaultValue: !1 })[0],
          f = Object(K.useContext)(De.b),
          h = e.disabled || !p;
        return Q.a.createElement(
          o,
          { id: n, offset: d, checked: i, title: s, disabled: e.disabled || m },
          Q.a.createElement(
            r,
            null,
            Q.a.createElement(V, {
      ...
      function D(e) {
        ...
        var a = e.definition,
          ...
          b = a.min,
          v = e.offset,
          g = $({ property: c, defaultValue: !0 })[0],
          E = $({ property: s, defaultValue: !1 })[0],
          _ = Re({ watchedValue: b, defaultValue: void 0 }),
          w = Re({ watchedValue: h, defaultValue: void 0 }),
          N = $({ property: u }),
          C = N[0],
          S = N[1],
          k = d(C, S),
        ...
        return Q.a.createElement(
          o,
          { id: i, offset: v, checked: c, title: f, disabled: e.disabled || E },
          Q.a.createElement(
            r,
            { className: it.range },
            _ && w
        ...
        return Q.a.createElement(
          ...
          Q.a.createElement(
            ...
            t.map(function (e) {
              return Q.a.createElement(
                'div',
                { className: lt.item, key: e.id, 'data-section-name': e.id },
                Q.a.createElement(U, { definition: e }),
              );
            }),
          ),
        );
      ...
      function H(e) {
        ...
        return Q.a.createElement(
          ...
          Q.a.createElement(
            ...
            Q.a.createElement(U, { definition: t }),
          ),
        );
      }
      function U(e) {
        var t = e.definition,
          ...
          f = t.widthValues,
          h = t.styleValues,
          b = $({ property: o, defaultValue: !0 })[0],
          v = $({ property: r, defaultValue: !1 })[0],
          g = v || !b;
        return Q.a.createElement(
          Q.a.Fragment,
          null,
          Q.a.createElement(i, {
            ...
            title: m && Q.a.createElement('span', { className: lt.title }, m),
            property: o,
            disabled: v,
          }),
          s &&
      ...
      function X(e) {
        var t = e.definition,
          ...
          d = t.optionsItems2,
          p = e.offset,
          m = $({ property: l, defaultValue: !0 })[0],
          f = $({ property: c, defaultValue: !1 })[0],
          h = e.disabled || !m;
        return Q.a.createElement(
          o,
          { id: n, offset: p, checked: l, title: s, disabled: e.disabled || f },
          Q.a.createElement(
            y,
        ...
        if (
          ...
          return (
            ...
            Q.a.createElement(
              K.Fragment,
              null,
              a.title && Q.a.createElement(W, { title: a.title, name: a.id }),
              t &&
                ((n = t.value()),
                n.reduce(function (e, t) {
                  ...
                  return Array.isArray(t)
                    ...
                    : Q.a.createElement(
                        G,
                        Object(q.__assign)({ key: t.id }, e, { definition: t }),
                      );
                }),
              'general' === a.groupType &&
                Q.a.createElement(ee.a.GroupSeparator, { size: 1 }),
            )
          );
        switch (a.propType) {
          case 'line':
            return Q.a.createElement(
              w,
              Object(q.__assign)({}, e, { definition: a }),
            );
          case 'checkable':
            return Q.a.createElement(
              l,
      ...
      var Y,
        ...
        ge = (function (e) {
          function t(t) {
            ...
            return (
              (a._selection = null),
              (a._restoreSelection = !1),
              (a._input = null),
              (a._handleSelectionChange = function () {
                a._restoreSelection ||
                  document.activeElement !==
                    Object(pe.ensureNotNull)(a._input) ||
                  a._saveSelection(Object(pe.ensureNotNull)(a._input));
              }),
              (a._handleInputReference = function (e) {
                (a._input = e),
                  a.props.inputReference && a.props.inputReference(e);
              }),
              ...
              (a._onValueChange = function (e) {
                ...
                a.setState({ displayValue: o }),
                  o !== i &&
                  ((t = a.state.displayValue),
                  (n = (n = o).replace(/,/g, '.')),
                  (t = t.replace(/,/g, '.')).includes('.') || !n.includes('.'))
                    ? ((a._restoreSelection = !0), a.forceUpdate())
                    : a._saveSelection(r),
                  c.value &&
                    f(a.props, l) === o &&
                    a.props.onValueChange(l, 'input');
              }),
              (a._onValueByStepChange = function (e) {
                ...
                isNaN(p) ||
                  ...
                  (r = t.mod(n)),
                  (i = t.plus(e * d)),
                  !r.eq(0) && s && (i = i.plus((e > 0 ? 0 : 1) * d).minus(r)),
                  (o = Number(i)),
                  a._checkValueBoundaries(o).value &&
                    (a.setState({ displayValue: f(a.props, o, h(a.props)) }),
          ...
          return (
            ...
            (t.prototype.componentDidUpdate = function () {
              var e,
                t,
                n,
                a = Object(pe.ensureNotNull)(this._input),
                r = this._selection;
              null !== r &&
              ...
              return t.value !== a || t.valueHash !== n
                ? {
                    ...
                    displayValue: f(
                      0,
                      a,
                      t.focused && t.valueHash === n ? void 0 : h(e),
                    ),
                  }
                : null;
            }),
        ...
        je = n('8XTa'),
        xe = [
          { type: Ce.LineEnd.Normal, icon: Oe, label: window.t('Normal') },
          { type: Ce.LineEnd.Arrow, icon: Ve, label: window.t('Arrow') },
        ],
        Me = (function (e) {
          function t(t) {
            ...
            return (
              (n._items = []),
              (n._items = xe.map(function (e) {
                return {
                  value: e.type,
                  selectedContent: Q.a.createElement(Se.a, { icon: e.icon }),
        ...
        at = (function (e) {
          ...
          return (
            ...
            (t.prototype._getNewPosition = function (e) {
              ...
              return (
                Object(tt.isRtl)() && (s = l.width - s - c),
                Object(he.clamp)(s / (l.width - c), 0, 1) * r + n
              );
            }),
            (t.prototype._detectPointerMode = function (e) {
              ...
              return 0 !== c
                ? c
                : ((t = this._getNewPosition(e)),
                  (r =
                    (n = Math.abs(o - t)) === (a = Math.abs(l - t))
                      ? t < o
                        ? 1
                        : 2
                      : n < a
                      ? 1
                      : 2),
                  this.setState({ pointerDragMode: r }),
                  r);
            }),
