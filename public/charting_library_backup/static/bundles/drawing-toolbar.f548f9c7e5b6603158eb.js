(window.webpackJsonp = window.webpackJsonp || []).push([
  ['drawing-toolbar'],
  {
    '5f7t': function (e, t, o) {
      ...
      function n(e) {
        ...
        return u.createElement(
          ...
          u.createElement(
            ...
            r &&
              ('string' == typeof r
                ? u.createElement(j.a, { className: m.icon, icon: r })
                : u.createElement('span', { className: m.icon }, r)),
            i,
          ),
        );
      }
      ...
      function r() {
        Object(ee.saveDefaultProperties)(!0),
          _.properties()
            .childs()
            .magnet.setValue(!_.properties().childs().magnet.value()),
          Object(ee.saveDefaultProperties)(!1);
      }
      function s() {
        Object(be.trackEvent)('GUI', 'Magnet mode', 'Weak'),
          Object(ee.saveDefaultProperties)(!0),
          _.properties().childs().magnetMode.setValue(ge.MagnetMode.WeakMagnet),
          _.properties().childs().magnet.setValue(!0),
          Object(ee.saveDefaultProperties)(!1);
      }
      function l() {
        Object(be.trackEvent)('GUI', 'Magnet mode', 'Strong'),
          Object(ee.saveDefaultProperties)(!0),
          _.properties()
            .childs()
            .magnetMode.setValue(ge.MagnetMode.StrongMagnet),
          _.properties().childs().magnet.setValue(!0),
          Object(ee.saveDefaultProperties)(!1);
      }
      var c,
      ...
      o.r(t),
        ...
        (L = [
          ...
          },
          {
            ...
            items: [
              ...
              { name: 'LineToolHorzLine', hotkeyHash: E.Modifiers.Alt + 72 },
              { name: 'LineToolHorzRay' },
              { name: 'LineToolVertLine', hotkeyHash: E.Modifiers.Alt + 86 },
              { name: 'LineToolCrossLine', hotkeyHash: E.Modifiers.Alt + 67 },
              { name: 'LineToolArrow' },
              { name: 'LineToolRay' },
          ...
          },
          {
            ...
            items: [
              ...
              Object(M.isFeatureEnabled)('remove-line-tool-ghost-feed')
                ? null
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return d.a.createElement(
                ...
                d.a.createElement(
                  'div',
                  { className: x.wrap, onMouseOver: p, onMouseOut: h },
                  d.a.createElement(
                    'div',
                    {
                      className: g()(
                        x.scrollWrap,
                        ((e = {}), (e[x.noScrollBar] = !l), e),
                      ),
                    ...
                    d.a.createElement(
                      ...
                      d.a.createElement('div', { className: x.content }, s),
                    ),
                  ),
                  c &&
                  ...
                  u &&
                    d.a.createElement(
                      ...
                      d.a.createElement(
                        ...
                        d.a.createElement(j.a, { icon: B, className: x.icon }),
                      ),
                    ),
                  u &&
                    d.a.createElement(
                ...
                u.createElement(
                  ...
                  !m &&
                    ...
                    u.createElement(
                      ...
                      u.createElement(j.a, { className: Q.arrowIcon, icon: K }),
                    ),
                ),
                !m &&
                  u.createElement(
        ...
        (J = o('KKsp')),
        (Y = o('EA32')),
        (X = { icon: window.t('Icon'), dropdownTooltip: window.t('Icons') }),
        (Z = 10),
        ($ = (function (e) {
          function t(t) {
            var o = e.call(this, t) || this;
            return (
              ...
              (o._handleSelect = function (e) {
                var t, n;
                Object(G.saveDefaults)(
                  'linetoolicon',
                  Object(c.__assign)(
                    Object(c.__assign)({}, Object(G.defaults)('linetoolicon')),
                    { icon: e },
                  ),
                ),
                  _.tool.setValue('LineToolIcon'),
                  -1 !== (n = (t = o.state.recents).indexOf(e)) &&
                    t.splice(n, 1),
                  (t = Object(c.__spreadArrays)([e], t.slice(0, Z - 1))),
                  Object(v.setJSON)('linetoolicon.recenticons', t),
          ...
          return (
            Object(c.__extends)(t, e),
            (t.prototype.componentDidMount = function () {
              _.tool.subscribe(this._onChangeDrawingState),
                v.onSync.subscribe(this, this._onSyncSettings);
            }),
            (t.prototype.componentWillUnmount = function () {
              _.tool.unsubscribe(this._onChangeDrawingState),
                v.onSync.unsubscribe(this, this._onSyncSettings);
            }),
            (t.prototype.render = function () {
              var e = this,
                t = this.props,
              ...
              return u.createElement(
                ...
                s && [
                  u.createElement(
                    'div',
                    { key: 'recent', className: Y.wrap },
                    s.map(this._renderItem),
                  ),
                  u.createElement(J.a, { key: 'separator' }),
                ],
                u.createElement(
                  'div',
                  { key: 'all', className: Y.wrap },
          ...
          function t(t) {
            ...
            return (
              ...
              (o._onChange = function () {
                o.setState({ isActive: _.tool.value() === o.props.toolName });
              }),
              (o.state = {
        ...
        (se = (function (e) {
            ...
            return (
              ...
              (n._handleClickFavorite = function (e) {
                n.state.favState && n.state.favState[e]
                  ? ie.a.removeFavorite(e)
                  : ie.a.addFavorite(e);
              }),
              (n._onAddFavorite = function (e) {
                var t;
                n.setState({
                  favState: Object(c.__assign)(
                    Object(c.__assign)({}, n.state.favState),
                    ((t = {}), (t[e] = !0), t),
                  ),
                });
              }),
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              _.tool.subscribe(this._onChangeDrawingState),
                ie.a.favoriteAdded.subscribe(null, this._onAddFavorite),
                ie.a.favoriteRemoved.subscribe(null, this._onRemoveFavorite),
                ie.a.favoritesSynced.subscribe(null, this._onSyncFavorites);
            }),
            (t.prototype.componentWillUnmount = function () {
              _.tool.unsubscribe(this._onChangeDrawingState),
                ie.a.favoriteAdded.unsubscribe(null, this._onAddFavorite),
                ie.a.favoriteRemoved.unsubscribe(null, this._onRemoveFavorite),
                ie.a.favoritesSynced.unsubscribe(null, this._onSyncFavorites);
            }),
            (t.prototype.componentDidUpdate = function (e, t) {
                ...
                u.createElement(
                  ...
                  i.map(function (t, i) {
                    ...
                    return u.createElement(re.b, {
                      ...
                      shortcut: t.hotkeyHash
                        ? Object(E.humanReadableHash)(t.hotkeyHash)
                        : void 0,
                      icon: r.icon,
                      isActive: d && s === i,
                      appearAsDisabled: c,
        ...
        (ue = o('g5Qf')),
        (de = o('85c9')),
        (pe = window.t('Show Favorite Drawings Toolbar')),
        (he = (function (e) {
          function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              var e = this,
                t = (this._promise = Object(h.ensureNotNull)(
          ...
          function t() {
            ...
            return (
              (t._toggleVisibility = function () {
                N.isDrawingToolbarVisible.setValue(
                  !N.isDrawingToolbarVisible.value(),
                );
              }),
              t
            );
        ...
        (Pe = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (o._handleMouseOver = function (e) {
                Object(fe.a)(e) && o.setState({ isHovered: !0 });
              }),
              (o._handleMouseOut = function (e) {
                Object(fe.a)(e) && o.setState({ isHovered: !1 });
              }),
              ...
              (o._updateMagnetEnabled = function () {
                var e = { magnet: Object(T.a)().value() };
                o.setState(e);
              }),
              (o._updateMagnetMode = function () {
                var e = { magnetMode: Object(T.b)().value() };
                o.setState(e);
              }),
              _.init(),
              (o._toolsFilter = new S(o.props.drawingsAccess)),
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              N.isDrawingToolbarVisible.subscribe(this._handleChangeVisibility),
                I.a.subscribe(this, this._handleGlobalClose),
                Object(T.a)().subscribe(this._updateMagnetEnabled),
                Object(T.b)().subscribe(this._updateMagnetMode),
                (this._tool = _.tool.spawn()),
                this._tool.subscribe(this._updateHotkeys.bind(this)),
                this._initHotkeys();
            }),
            (t.prototype.componentWillUnmount = function () {
              N.isDrawingToolbarVisible.unsubscribe(
                this._handleChangeVisibility,
              ),
                I.a.unsubscribe(this, this._handleGlobalClose),
                Object(T.a)().unsubscribe(this._updateMagnetEnabled),
                Object(T.b)().unsubscribe(this._updateMagnetMode),
                this._tool.destroy(),
            ...
            (t.prototype.componentDidUpdate = function (e, t) {
              ...
              o !== t.isVisible &&
                (y.emit('toggle_sidebar', !o),
                v.setValue('ChartDrawingToolbarWidget.visible', o),
            ...
            (t.prototype.render = function () {
              var e,
                ...
                g = p.magnet,
                v = p.magnetMode,
                f = { backgroundColor: a && '#' + a };
              return (
                (t = u.createElement(Le, { toolbarVisible: m })),
                u.createElement(
                  ye.a.Provider,
                  { value: De },
                  u.createElement(
                      ...
                      u.createElement(
                        ...
                        !d &&
                          u.createElement(
                            'div',
                            { className: Ne.group, style: f },
                            u.createElement(oe, { toolName: 'measure' }),
                            u.createElement(oe, { toolName: 'zoom' }),
                            u.createElement(ne, { chartWidgetCollection: c }),
                          ),
                        !d &&
                          u.createElement(
                            'div',
                        ...
                        !d &&
                          ...
                          u.createElement(
                            'div',
                            { className: b(Ne.group, Ne.lastGroup), style: f },
                            !1,
                            this._features.tools &&
                              this._features.favoriting &&
                              u.createElement(he, { id: ve.FavoriteDrawings }),
                            this._features.tools &&
                              u.createElement(i, {
                                id: ve.ObjectTree,
                                action: function () {
            ...
            (t.childContextTypes = { chartWidgetCollection: m.any.isRequired }),
            t
          );
        })(u.PureComponent)),
          ...
          function e(e, t) {
            ...
            (this._component = null),
              ...
              p.render(
                u.createElement(
                  Pe,
                  Object(c.__assign)({}, t, { ref: this._handleRef }),
                ),
                this._container,
              );
          }
    ...
    N5tr: function (e, t, o) {
      ...
      function n(e) {
        var t = e.reference,
          ...
          n = Object(r.__assign)(Object(r.__assign)({}, o), { ref: t });
        ...
        return l.a.createElement(
          ...
          Object(r.__assign)({}, P, {
            ...
            onClick: function (t) {
              ...
              y ||
                (a && Object(d.trackEvent)(a.category, a.event, a.label),
                n && n(i, t),
                o || Object(u.b)());
            },
          ...
          l.a.createElement(
            ...
            l.a.createElement('div', { className: D.label }, k),
          ),
          (void 0 !== v || f) &&
            l.a.createElement(
              'div',
    ...
    nPPD: function (e, t, o) {
      ...
      function n(e, t, o) {
        ...
        for (
          ...
          (s = o[(r = a[i])] || r) in e && (n[r] = [e[s], t[r]].join(' '));
        return n;
      }
      function i(e, t, o) {
