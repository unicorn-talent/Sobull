      ...
      function o(e) {
        ...
        return (
          Object(r.useLayoutEffect)(
            function () {
              var e = { click: t, mouseDown: n, touchEnd: o, touchStart: a };
      ...
      function o(e) {
        return u.createElement(
          ...
          u.createElement(
            'td',
            null,
            u.createElement('div', { className: _.line }),
          ),
          u.createElement(
            'td',
            null,
            u.createElement('div', { className: _.line }),
            e.hint
              ? u.createElement('div', { className: _.hint }, e.hint)
              : null,
          ),
        );
      }
      function r(e) {
        return u.createElement(E, { icon: g, onClick: e.onClick });
      }
      function i(e) {
        return u.createElement('span', { className: v.shortcut }, e.text);
      }
      function s(e) {
        return u.createElement(O, {
          label: u.createElement(
            ...
            u.createElement(j.a, { className: I.loader, color: 'gray' }),
          ),
          noInteractive: !0,
              ...
              return u.createElement(
                ...
                u.createElement(
                  'tr',
                  {
                    className: m(
                      v.item,
                      !this.props.noInteractive && v.interactive,
                      this.props.hovered && v.hovered,
                      this.props.disabled && v.disabled,
                      this.props.active && v.active,
                    ),
                  ...
                  u.createElement(
                    'td',
                    { className: m(v.iconCell), 'data-icon-cell': !0 },
                    this._icon(),
                  ),
                  u.createElement(
                    'td',
                    ...
                    u.createElement(
                      ...
                      !t &&
                        n &&
                        !C.CheckMobile.any() &&
                        u.createElement(i, { text: n }),
                      !t && !n && o && u.createElement(i, { text: o }),
                    ),
                  ),
                ),
                u.createElement(
              ...
              return this.props.checkable
                ? this.props.checked
                  ? ((e = !this.props.icon && !this.props.iconChecked),
                    (t = this.props.iconChecked || this.props.icon || b),
                    u.createElement('span', {
                  ...
                  : u.createElement('span', { className: v.icon })
                : this.props.icon
                ? u.createElement('span', {
                    className: v.icon,
                    dangerouslySetInnerHTML: { __html: this.props.icon },
              ...
              return this.props.toolbox
                ? u.createElement(
                    'span',
                    {
                      className: m(
                        v.toolbox,
                        this.props.showToolboxOnHover && v.showToolboxOnHover,
                      ),
            ...
            return (
              ...
              (n._handleClick = function (e) {
                e.isDefaultPrevented() ||
                  ...
                  (n._hasSubItems()
                    ? n._showSubMenu()
                    : (n.state.doNotCloseOnClick || Object(x.b)(),
              ...
              (n._calcSubMenuPos = function (e) {
                return (function (e, t, n) {
                  ...
                  return (
                    void 0 === n && (n = { x: 0, y: 10 }),
                    t
                      ? ((r = (o = t.getBoundingClientRect()).left),
                        (i = o.right),
                        (s = o.top),
              ...
              (n.state = Object(c.__assign)({}, n.props.action.getState())),
              n
            );
          }
          return (
          ...
          return (
            ...
            (t.prototype.render = function () {
              return this.state.failed
                ...
                : this.state.loaded
                ? u.createElement(M, Object(c.__assign)({}, this.props))
                : u.createElement(s, { onMouseOver: this._handleMouseOver });
            }),
        ...
        (R = (function (e) {
          ...
          return (
            ...
            (t.prototype._item = function (e) {
              switch (e.type) {
                case f.a.Separator:
                  return u.createElement(o, { key: e.id, hint: e.getHint() });
                case f.a.Action:
          ...
          return (
            (e.prototype.show = function (e, t, n) {
              ...
              this._onShow && this._onShow(),
                (this._isShown = !0),
                this._render(
                  Object(c.__assign)(Object(c.__assign)({}, this._props), {
                    position: function (t, o) {
                      return (
                        ...
                        {
                          x:
                            !n && Object(N.isRtl)() ? e.clientX - t : e.clientX,
                          y: e.clientY,
            ...
            (e.prototype.destroy = function () {
              (this._isShown = !1),
                this._root &&
                  (l.unmountComponentAtNode(this._root),
            ...
            (e.prototype._render = function (e) {
              this._root ||
                ...
                l.render(u.createElement(A, e), this._root);
            }),
            e
          );
        })());
