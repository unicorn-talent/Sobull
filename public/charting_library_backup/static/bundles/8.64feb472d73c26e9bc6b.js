                    ...
                    objectOf: function (e) {
                      return p(function (t, n, r, o, i) {
                        ...
                        for (c in s)
                          if (
                            s.hasOwnProperty(c) &&
                            (f = e(s, c, r, o, i + '.' + c, a)) instanceof Error
                          )
                            return f;
                        return null;
                      });
            ...
            e.exports = (function () {
              ...
              : function (e, t) {
                  ...
                  for (
                    ...
                    for (c in (i = Object(arguments[a])))
                      r.call(i, c) && (u[c] = i[c]);
                    if (n)
                      for (s = n(i), f = 0; f < s.length; f++)
    ...
    bdgK: function (e, t, n) {
      ...
      n.r(t),
        function (e) {
              ...
              ? ((i =
                  (o = (function (e) {
                    var t,
                      ...
                      u = {};
                    for (t = 0, r = s; t < r.length; t += 1)
                      (i = e['padding-' + (o = r[t])]), (u[o] = n(i));
                    return u;
          ...
          (j.prototype.addObserver = function (e) {
            ~this.observers_.indexOf(e) || this.observers_.push(e),
              this.connected_ || this.connect_();
          }),
            (j.prototype.removeObserver = function (e) {
            ...
            (j.prototype.onTransitionEnd_ = function (e) {
            ...
            (j.getInstance = function () {
              return (
                this.instance_ || (this.instance_ = new j()), this.instance_
              );
            }),
            (j.instance_ = null),
            (u = function (e, t) {
            ...
            (y = function (e) {
              ...
              if (!arguments.length)
                throw new TypeError('1 argument required, but only 0 present.');
              (t = j.getInstance()), (n = new d(e, t, this)), h.set(this, n);
            }),
