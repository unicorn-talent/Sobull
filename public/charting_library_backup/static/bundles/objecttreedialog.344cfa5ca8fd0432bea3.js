        ...
        (a = e.DropdownView = (function () {
          function t(e) {
            ...
            !(function (t, e) {
              ...
              (this._maxHeight = e.data('maxHeight') || i.maxHeight),
              (this._dropdownWidth =
                e.data('dropdownWidth') || i.dropdownWidth),
              (this._boundingElement = i.boundingElement),
              this.$wrap
            ...
            i(t, [
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  setTimeout(function () {
                    t.$body.on('clickoutside', function (e) {
                      (t._checkIgnoreClickOutside.length &&
                        t._checkIgnoreClickOutside.some(function (t) {
                          return t(e);
                        })) ||
                        t.close(!0);
                    });
              ...
              {
                key: 'setCheckIgnoreClickOutside',
                value: function (t) {
                  this._checkIgnoreClickOutside.push(t);
                },
              },
              {
                key: 'dropCheckIgnoreClickOutside',
                value: function (t) {
                  var e = this._checkIgnoreClickOutside.indexOf(t);
                  -1 !== e && this._checkIgnoreClickOutside.splice(e, 1);
                },
              },
              {
                key: 'close',
              ...
              },
              {
                ...
                value: function () {
                  var t,
                    ...
                    d = 25,
                    h = this.$body,
                    u = this.$wrap.get(0).getBoundingClientRect(),
                    p = this._boundingElement
                    ...
                    _ = parseFloat(h.css('padding-top')),
                    v = parseFloat(h.css('padding-bottom')),
                    m = this.$inScroll.outerHeight(!0) + _ + v;
                  if (
                    (this.scroll && this.scroll.scrollToStart(),
                    this._adaptOnlyInScrollHeight)
                  )
                    return (
                      (e = (t = h.find('.js-dropdown-dummy'))
                      ...
                      void this.$el
                        ...
                        .css('maxHeight', p.bottom - v - o - d)
                    );
                  (i = this._maxHeight || m),
                    (s = u.top + i + d <= p.bottom),
                    (n = p.top + c + i <= u.bottom),
                    (r = this._maxHeight || 'auto'),
                    (l = void 0),
                    s
                      ? (l = -_)
                      : n
                      ? (l = -i + u.height + v)
                      : ((l = -u.top + p.top + c),
                        i > (a = p.height - c - d) && (r = a)),
                    h.css('top', l),
                    h.height(r),
                    this._dropdownWidth && h.width(this._dropdownWidth);
                },
              },
              {
                key: 'fitHorizontally',
                ...
                isClickOutFn: function (t) {
                  if (
                    $(t.target)
                      ...
                      .andSelf()
                      .is(
                        '._tv-dialog, .colorpicker, .tvcolorpicker-popup, .symbol-edit-popup, .context-menu, .js-dialog, [data-name="indicator-properties-dialog"], [data-name="drawings-settings-dialog"]',
                      )
                  )
                    return !1;
                },
          ...
          (s.prototype._setDataSourceIcon = function (t, e) {
            ...
            o.removeClass('i-text-icon i-empty'),
              null === e
                ? o.addClass('i-empty')
                : 'svg' === e.type
                ? $(e.svgCode).attr({ width: 20, height: 20 }).appendTo(o)
                : 'text' === e.type &&
    ...
    zqKs: function (t, e, o) {
      ...
      o('q42M'),
        ...
        (i.prototype._removeSourceFromView = function (t) {
          ...
          i &&
            ((this._selectedItemIds = this._selectedItemIds.filter(function (
              e,
            ) {
              return e !== t;
            })),
        ...
        (i.prototype._onZorderChanged = function (t, e) {
          if (t && t.length)
            if (e) {
              var o = this._getItemForSourceId(t[0].id());
              1 === e ? this._moveItemUp(o) : this._moveItemDown(o);
            } else
              this._renderView(
                function () {
                  this._scroll.scrollTo(this._getItemForSourceId(t[0].id()));
                }.bind(this),
              );
        }),
        (i.prototype._subscribeListeners = function () {
