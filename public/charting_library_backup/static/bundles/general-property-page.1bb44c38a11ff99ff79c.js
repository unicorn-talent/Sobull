(window.webpackJsonp = window.webpackJsonp || []).push([
  ['general-property-page'],
  {
    '1ANp': function (e, t, i) {
      ...
      function a() {
        if (!d) {
          (d = Object(l.a)()).setValue(
            r(c.getValue('NavigationButtons.visibility')),
          ),
            d.subscribe(d, function (e) {
      ...
      function s() {
        return [
          ...
          { value: h.AlwaysOn, title: window.t('Always Visible') },
          { value: h.AlwaysOff, title: window.t('Always Invisible') },
        ];
      }
      function o() {
        var e, t;
        return (
          p ||
            ...
            (t = function () {
              ...
              t !== h.AlwaysOn &&
                t !== h.AlwaysOff &&
                (t = Modernizr.mobiletouch ? h.AlwaysOn : h.VisibleOnMouseOver),
                p && p.setValue(t);
            }),
            (e = a()).subscribe(p, t),
            t()),
    ...
    '5lPo': function (e, t, i) {
      ...
      i.r(t),
        ...
        (b = i('qFKp')),
        (g = window.t('Symbol')),
        (w = window.t('OHLC Values')),
        (y = window.t('Bar Change Values')),
        (O = window.t('Indicator Titles')),
        (v = window.t('Indicator Arguments')),
        (m = window.t('Indicator Values')),
        (P = window.t('Background')),
        (f = window.t('Wrap text')),
        (j = b.CheckMobile.any()),
        (_ = i('oXaB')),
        (S = i('Z5lT')),
        (C = window.t('Symbol Name Label')),
        (V = window.t('Symbol Last Value Label')),
        window.t('Symbol Previous Close Value Label (Intraday Only)'),
        (L = window.t('Indicator Name Label')),
        (M = window.t('Indicator Last Value Label')),
        window.t('Financials Name Label'),
        window.t('Financials Last Value Label'),
        (k = window.t('Countdown To Bar Close')),
        (x = window.t('Scales Placement')),
        (A = window.t('Date Format')),
        (B = window.t('Lock Price to Bar Ratio')),
        (z = window.t('No Overlapping Labels')),
        (T = [
          {
        ...
        (H = window.t('Vert Grid Lines')),
        (N = window.t('Horz Grid Lines')),
        (R = window.t('Session Breaks')),
        (F = window.t('Scales text')),
        (G = window.t('Scales lines')),
        (I = window.t('Crosshair')),
        (W = window.t('Watermark')),
        (E = window.t('Top Margin')),
        (q = window.t('Navigation Buttons')),
        (K = window.t('Bottom Margin')),
        (U = window.t('Right Margin')),
        (Z = window.t('bars', { context: 'unit' })),
        (Q = i('e1ZQ')),
        (Y = i('ZZnO')),
        (J = i('gQ5K')),
        (X = i('+6ja')),
          ...
          return (
            ...
            (e.prototype._createSeriesViewModel = function () {
              var e = {
                ...
                values: X.availableTimezones.map(function (e) {
                ...
                i = (function (e, t, i) {
                  ...
                  return (
                    ...
                    Object(r.__spreadArrays)(
                      [Object(c.k)(b, 'generalLegendVisibilityGroup')],
                      d,
                    )
                  );
                })(this._undoModel, e, t);
              return Object(h.a)(i, 'legend', le, oe.legend);
            }),
            (e.prototype._createScalesPropertyPage = function () {
              var e = this._createScalesDefinitions();
              return Object(h.a)(e, 'scales', ce, oe.scales);
            }),
            (e.prototype._createScalesDefinitions = function () {
              var e,
                ...
                v,
                m,
                P = this._chartWidgetProperties.childs(),
                f = P.scalesProperties.childs(),
                j = {
                  property: this._model.properties()
                    .priceScaleSelectionStrategyName,
                  values: Object(p.allPriceScaleSelectionStrategyInfo)().map(
                    function (e) {
                ...
                _ = {
                  property: Y.dateFormatProperty,
                  values:
                    ((e = new Date(Date.UTC(1997, 8, 29))),
                    Q.availableDateFormats.map(function (t) {
                      return {
                        value: t,
                        title: new J.DateFormatter(t).format(e),
                      };
                    })),
                },
                D = this._model.mainSeriesScaleRatioProperty();
              return (
                (t = this._undoModel),
                ...
                (a = {
                  ...
                  mainSeriesScaleRatioProperty: D,
                  scalesPlacementPropertyObj: j,
                  dateFormatPropertyObj: _,
                }),
                (O = a.seriesPriceScale.properties().childs()),
                (v = []),
                (m = []),
                a.seriesHasClosePrice &&
                  ((o = Object(c.c)(
                    {
                      checked: Object(c.b)(
                        t,
                    ...
                    { id: 'symbolNameLabel', title: C },
                  )),
                  (n = Object(c.j)(
                    {
                      checked: Object(c.b)(
                        t,
                        r.showSeriesLastValue,
                        'Change Symbol Last Value Visibility',
                      ),
                      option: Object(c.b)(
                        t,
                        r.seriesLastValueMode,
                ...
                (h = Object(c.c)(
                  {
                    checked: Object(c.b)(
                      t,
                      r.showStudyPlotLabels,
                      'Show Study Plots Labels',
                    ),
                  },
                  { id: 'studyNameLabel', title: L },
                )),
                (d = Object(c.c)(
                  {
                    checked: Object(c.b)(
                      t,
                      r.showStudyLastValue,
                      'Change Indicator Last Value Visibility',
                    ),
                  },
                  { id: 'studyLastValueLabel', title: M },
                )),
                m.push(h, d),
                (u = Object(c.c)(
                  {
                  ...
                  { id: 'noOverlappingLabels', title: z },
                )),
                m.push(u),
                s.enabled('countdown') &&
                  ((b = Object(c.c)(
                    ...
                    { id: 'countdown', title: k },
                  )),
                  m.push(b)),
                v.push(Object(c.k)(m, 'generalScalesLabelsGroup')),
                (g = Object(c.i)(
                  {
                    checked: Object(c.v)(
                      t,
                    ...
                    value: Object(c.x)(
                      t,
                      a.mainSeriesScaleRatioProperty,
                  ...
                  },
                  {
                    ...
                    step: new l.a(
                      a.mainSeriesScaleRatioProperty.getStepChangeValue(),
                    ),
                  },
                )),
                (w = Object(c.j)(
                  {
                    option: Object(c.w)(
                      t,
                      a.scalesPlacementPropertyObj.property,
                    ),
                  },
                  {
                    id: 'scalesPlacement',
                ...
                (y = Object(c.j)(
                  {
                    option: Object(c.b)(
                      t,
                      a.dateFormatPropertyObj.property,
                      'Change Date Format',
                    ),
                  },
                  {
            ...
            (e.prototype._createAppearancePropertyPage = function () {
              var e,
                ...
                i,
                r,
                o = this._chartWidgetProperties.childs(),
                n = o.paneProperties.childs(),
                p = o.scalesProperties.childs(),
                u = this._model.watermarkSource(),
                b = null;
              return (
                null !== u && (b = u.properties().childs()),
                (e = { property: d.property(), values: d.availableValues() }),
                (t = this._model
                  .sessions()
                  .properties()
                  .childs()
                ...
                (i = Object(a.ensureNotNull)(
                  this._maxRightOffsetPropertyObject,
                )),
                (r = (function (e, t, i, r, a, o, n, h) {
                  var d,
                    p,
                    u,
                    b,
                    ...
                    O = Object(c.e)(
                      ...
                      { id: 'chartBackground', title: D, noAlpha: !0 },
                    ),
                    ...
                    L = Object(c.h)(
                      ...
                      { id: 'crossHair', title: I },
                    );
                  return (
                    y.push(O, m, f, j, _, C, L),
                    null !== i &&
                      ((d = Object(c.e)(
                        {
                          checked: Object(c.b)(
                    ...
                    (w = [Object(c.k)(y, 'generalAppearanceGroup'), u, b]),
                ...
                Object(h.a)(r, 'appearance', he, oe.appearance)
              );
            }),
            (e.prototype._createTradingPropertyPage = function () {
              ...
              return pe
                ? null === ue
                  ? null
                  : ((e = this._model.properties().tradingProperties.childs()),
                    (t = getTradingPropertiesDefinitions(
                      this._undoModel,
                      e,
                      ue,
                    )),
                    Object(h.a)(t, 'trading', de, oe.trading))
                : null;
            }),
