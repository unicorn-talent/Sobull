(window.webpackJsonp = window.webpackJsonp || []).push([
  ['floating-toolbars'],
  {
    '0ZwQ': function (t, e, o) {
      'use strict';
      function i() {
        return Object(p.ensureNotNull)(window.containerElement);
      }
      function n() {
        var t, e, o, n;
        return s
          ...
          return (
            ...
            (t.prototype._updateAxisOption = function () {
              if (this._options.dragOnlyInsideToolbar) {
                ...
                Object(b.lazyJqueryUI)(c()(this._content)).sortable(
                  'option',
                  'axis',
                  t,
                );
            ...
            (t.prototype._savePosition = function () {
              ...
              Object(h.setJSON)(this._options.positionSettingsKey, {
                left: t.left,
                top: t.top,
              });
            }),
            (t.prototype._init = function () {
              this._loadPosition(),
                Object(b.lazyJqueryUI)(c()(this._widget)).draggable({
                  containment: 'window',
        ...
        return t in $.fn
          ...
          : (s ||
              (s = new Promise(function (t) {
                Promise.all([o.e(76), o.e('lazy-jquery-ui')])
                  .then(
                    function (e) {
                      o('ONnG'), t();
                    }.bind(null, o),
    ...
    tPkB: function (t, e, o) {
      ...
      (function (e, i) {
        ...
        var l,
          ...
          L = x.ColorBinding,
          T = o('mMWL'),
          P = o('bR4N').bindPopupMenu,
          S = o('Ocx9').DefaultProperty,
          E = o('my99').GroupButtonFloatingToolbar,
          k = o('a7Ha').LineEnd,
          B = o('VNzU').isMultipleLayout,
          z = o('yMne'),
          V = o('CW80'),
          A = V.createLineToolProperties,
          F = V.isLineTool,
          M = o('PC8g').trackEvent;
        o('m/4m'),
          o('nSyy'),
          ...
          (n.prototype._init = function () {
            (this._floatingToolbar = new E({
              addClass: 'tv-linetool-properties-toolbar',
              defaultPosition: {
                top: z.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15,
          ...
          (n.prototype.attachHandlers = function () {
            T.tool.subscribe(this.onToolChanged.bind(this), {
              callWithLast: !0,
            }),
          ...
          (n.prototype._cloneButtonTitle = function () {
            ...
            return (
              ...
              B(this._chartWidgetCollection.layout.value()) &&
                (t += ', ' + $.t('Sync')),
              t
            );
          }),
          ...
          (n.prototype._getCloneActions = function () {
            var t,
              e = this.activeChartWidget().model(),
          ...
          (n.prototype._defaultToolProperties = function () {
            return [
              ...
              },
              {
                ...
                inputType: 'combobox',
                comboboxOptions: [
                  { value: k.Normal, iconSvgCode: g },
                  { value: k.Arrow, iconSvgCode: _ },
              ...
              },
              {
                ...
                inputType: 'combobox',
                comboboxOptions: [
                  { value: k.Normal, iconSvgCode: f },
                  { value: k.Arrow, iconSvgCode: b },
          ...
          (n.prototype._trackContextAction = function (t) {
            M('GUI', 'Context action on drawings', t);
          }),
