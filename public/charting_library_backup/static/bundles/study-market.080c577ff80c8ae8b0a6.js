  ...
  ['study-market'],
  {
    '24k8': function (t, e, i) {
      ...
      (function (e, s) {
        ...
        i('pfXf'),
          ...
          (h = i('TcSq')),
          h.extractPineId,
          (l = h.isPublisedPineId),
          (u = i('YDhE').createDialog),
          i('oNDq').createConfirmDialog,
          (_ = i('UIZs').createSearchControl),
          (p = i('j1f4')),
          (g = i('Vdly')),
          (v = i('33OQ')),
          (f = i('6et/')),
          ...
          (b = i('emGF').getFavoritesInfo),
          (C = i('GVHu').Study),
          (E = i('CW80').tryFindStudyLineToolNameByStudyId),
          (P = i('mMWL')),
          ...
          i('m/4m'),
          (A =
            '<div class="tv-insert-indicator-dialog__body js-dialog__scroll-wrap"><div class="tv-insert-indicator-dialog__left-panel">{{^minimized}}<div id="js-search-placeholder"></div>{{/minimized}}<div class="tv-insert-indicator-dialog__left-panel-content-wrapper js-left-panel-wrapper"><div class="tv-insert-indicator-dialog__tabs-viewport js-tabs-viewport"><div class="tv-insert-indicator-dialog__tabs-container js-tabs-container" data-role="group" data-name="indicators-dialog-tabs-container"></div></div></div></div><div class="tv-insert-indicator-dialog__right-panel js-right-panel">{{#minimized}}{{#withSearch}}<div id="js-search-placeholder"></div>{{/withSearch}}{{/minimized}}<div class="tv-insert-indicator-dialog__pages js-pages"><div id="js-search-results-placeholder"></div></div></div></div>'),
          (I =
          ...
          (w =
            '<div class="js-study-item tv-insert-study-item {{^withFavorites}}i-without-stars{{/withFavorites}}">{{#withFavorites}}<div class="tv-insert-study-item__favorite-icon js-favorite-icon" data-role="button" data-name="indicators-dialog-favourite-button"><span class="tv-insert-study-item__star tv-insert-study-item__star--filled">' +
            i('HHbT') +
          ...
          (a.prototype.setupStudyInfo = function () {
            var t = this._chartWidgetCollection.activeChartWidget
                ...
                .metaInfoRepository(),
              e = Promise.resolve([]);
            return Promise.all([t.findAllJavaStudies(), e]).then(
              function (t) {
                var e = t[0],
                  i = t[1],
                  s = e.concat(i);
          ...
          (a.prototype.prepareLayout = function () {
            ...
            (this._dialog = u({
              ...
              this._switchPagesContainer(v.device, ''),
          ...
          (a.prototype._fillScriptsMetainfo = function (t, e) {
            ...
            for (i = 0; i < t.length; i++)
              (s = (void 0)(t[i])),
                TradingView.merge(s, c.parseIdString(s.id)),
                e.push(s);
          }),
          ...
          (a.prototype._createItemsList = function () {
            return $(
              '<div class="tv-insert-indicator-dialog__items-list" data-role="group" data-name="indicators-dialog-items-list">',
            );
          }),
          ...
          (a.prototype.addSearchPage = function () {
            ...
            (this._tabs.search = e.$control.data('title', 'search')),
              (this._pages.search = $(
              ...
              (this._search_input = e.$input),
              e.inputChangedDelegate.subscribe(
                null,
                function () {
                  t && clearTimeout(t),
                    (t = setTimeout(
              ...
              c.done(
                function (e) {
                  ...
                  if (h._currentAsyncSearchDfd === c) {
                    for (
                      (i = Object.keys(h._studies)).indexOf(
                        h._PUBLISHED_STUDIES_PACKAGE_NAME,
                      ) < 0 && i.push(h._PUBLISHED_STUDIES_PACKAGE_NAME),
                        i.sort(),
                        r = (n = [
                    ...
                    for (u = {}, _ = 0, p = 0; p < i.length; p++) {
                      for (
                        g = i[p],
                          v = [],
                          f = h._studies[g],
                          g === h._PUBLISHED_STUDIES_PACKAGE_NAME && (f = e),
                          r = 0;
                        r < f.length;
                        r++
                      )
                        if (((y = f[r]), o.length))
                          for (S = 0; S < o.length; S++)
                            ((m = o[S].re).lastIndex = 0),
                              (b = o[S].fullMatch),
                              (C = y.shortDescription) &&
                              C.toLowerCase() === t.toLowerCase()
                                ? s(v, y, C, 3, !0, b)
                                : C && b.test(C)
                                ? s(v, y, C, 2, !0, b)
                      ...
                      if ((v = h._applyGlobalFilter(v)).length) {
                        switch (((E = g), g)) {
                          ...
                          case h._PUBLISHED_STUDIES_PACKAGE_NAME:
                            ...
                            break;
                          default:
                            g in h._packagesWithTabNames &&
                              (E = h._packagesWithTabNames[E]);
                        }
                        E in u || (u[E] = []),
                          (u[E] = u[E].concat(v)),
                          (_ += v.length);
                    ...
                    for (
                      ...
                      if (
                        ...
                        (I = this._createItemsGroup(
                          v,
                          this._options.minimized ? '' : $.t(E),
                          o,
                        )),
                        a.append(I),
                        (this._selectedStudy = null),
                        P && P.pine && P.pine.version < 0)
                      )
                        for (
                          w = this.currentPage().find('.js-study-item'), S = 0;
                          S < w.length;
                          ++S
                        )
          ...
          (a.prototype._getOrCreateMarketTab = function () {
            return (
              this._w_market_tabs ||
                (v.device === a._breakpointDevice &&
                  g.setValue('studyMarket.marketTabIsOpen', !1),
          ...
          (a.prototype._onDialogClosed = function () {
            null !== this._hotkeys &&
              ...
              f.removeListener('StudyMarketDialog');
          }),
                ...
                (t in this._pages &&
                  ...
                  ? ((i = (e =
                      ...
                      Object.keys(this._pages).find(function (t) {
                        return (
                          t in r._pages && !r._pages[t].hasClass('i-hidden')
                        );
                      }))
                      ? this.getPage(e)
                      : void 0),
                    ...
                    this._selectedStudy &&
                      ...
                      (this._selectedStudy = null)),
                    (o = '' !== this._currentPageTitle),
                    this._widget
                      .find('.js-tabs-viewport')
                      .toggleClass('i-active', !o),
                    this._w_pages.toggleClass('i-active', o),
                    this._showHideBackButton(),
                    o || this._search_input.blur(),
                    this._updateDialogTitleText())
                  : this.selectPage(this._BASIC_STUDIES_PAGE_NAME));
          }),
          (a.prototype.attachHandlers = function () {
            ...
            Modernizr.mobiletouch &&
              ...
              this._search_input[0].addEventListener('keydown', function (t) {
                ...
                13 === i
                  ? e._onEnterKeyHandler(t)
                  : 38 === i
                  ? e._onUpKeyHandler(t)
                  : 40 === i && e._onDownKeyHandler(t);
              });
          }),
          ...
          (a.prototype.toggleFavorite = function (t) {
            this.favsModel.isFav(t)
              ? this.favsModel.removeFavorite(t)
              : this.favsModel.addFavorite(t);
          }),
          ...
          (a.prototype.updateFavorites = function () {
            ...
            this._w_pages &&
              ...
              (e = function (e) {
                ...
                if (t._tabs.favorites && 0 === e.length) d();
                  ...
                  for (i = [], s = 0; s < e.length; s++)
                    (o = (n = e[s]).info.studyMarketShittyObject),
                      'pine' === n.item.type
                        ? l(n.item.pineId)
                          ? null != (r = o).imageUrl &&
                            i.push(this._createPublishedScriptMetaInfo(r))
                          : i.push((void 0)(o))
                        : i.push(o);
                  0 === i.length ? d() : this._tabs.favorites.show(),
                    (i = this._applyStrategiesFilter(i)),
                    this.preparePageStudies(this._pages.favorites, i),
              ...
              Promise.resolve(this.studiesReady.promise())
                .then(
                  function () {
                    return b(
                      this.getVisibleFavorites(),
          ...
          (a.prototype.checkExcludePackageStudies = function (t) {
            return t.filter(function (t) {
              ...
              return (
                i === this._PUBLISHED_STUDIES_PACKAGE_NAME ||
                (!!(
                  this._studies &&
                  this._studies[i] &&
                  $.grep(this._studies[i], function (t) {
                    return t.id.indexOf(e) >= 0;
                  }).length > 0
                ) &&
                  (i === this._BASIC_STUDIES_PACKAGE_NAME ||
                    i === this._STANDARD_STUDIES_PACKAGE_NAME ||
                    i === this._CUSTOM_STUDIES_PACKAGE_NAME ||
                    i === this._SCRIPTING_PACKAGE_NAME ||
                    (pro.hasPackage(i) && i in this._studies)))
              );
            }, this);
          }),
              ...
              for (
                ...
                if (
                  ...
                  (h = o.exec(N))
                    ...
                    : (!(h = d.exec(N)) && r && (h = r.exec(N)),
                      (i[a].fuzzyHighlight = !0)),
                  h)
                )
                  if (i[a].fuzzyHighlight)
                    for (l = h.index, u = 1; u < h.length; u++)
                      (_ = h[u].length), u % 2 && (x[l] = !0), (l += _);
                  else for (p = 0; p < h[0].length; p++) x[h.index + p] = !0;
            return (
              ...
              (P = f && E && void 0 !== t.pine.userHaveAccess),
              (A = f && t.pine.userHaveAccess),
              ...
              T ||
                D.find('.js-show-source-btn')
                  .removeClass('js-show-source-btn')
                  .addClass('i-empty'),
              D.data('study', t),
              void 0 !== t.isCustomIndicator && D.addClass('custom-indicator'),
              n.enabled('items_favoriting') &&
                ((M = D.find('.js-favorite-icon')).toggleClass(
                  'i-starred',
                  !!U,
                ),
                M.attr('title', this.favTitle(!!U))),
            ...
            null === o
              ? (e = this._chartWidgetCollection.activeChartWidget.value()) &&
                ((i = t.isStub
                  ...
                  : { type: 'java', studyId: t.id }),
                (s = this),
                (a = this._dialog.focus.bind(this._dialog)),
                (s._doNotCloseDialog = !0),
                (n = function () {
                  a(), (s._doNotCloseDialog = !1);
                }),
                e
                  .insertStudy(i, this._parentSource, t.description)
                  .then(n)
                  .catch(n))
              : P.tool.setValue(o);
          }),
          (a.prototype.onPackagesUpdated = function () {
            ...
            window.is_authenticated
              ? (e.onConnected().subscribe(this, this.update, !0),
                e.chartSession().isConnected().value() &&
                  t.reconnectChartApi(!0))
              : this.update();
          }),
          ...
          (a.prototype.getStudyPackageName = function (t) {
            ...
            if (t)
              return (i = 1 === (e = t.split('@')).length) ||
                (s = c.getPackageName(t)) === this._SCRIPTING_PACKAGE_NAME
                ? ((a = e[0]),
        ...
        (u = (function () {
          function t() {
            ...
            (this._favorites = []),
              ...
              n.TVXWindowEvents.on('StudyFavoritesChanged', function (e) {
                var i = JSON.parse(e);
                t._loadFromState(i.favorites || []);
              }),
              a.onSync.subscribe(this, this._loadFavs),
              this._loadFavs();
          }
          return (
            ...
            (t.prototype.addFavorite = function (t) {
              var e = this.favId(t);
              this._favorites.push(s(e)),
                this._favoritesChanged.fire(),
                this._saveFavs();
            }),
            (t.prototype.removeFavorite = function (t) {
              var e = this.favId(t),
                i = this._findFavIndex(e);
              -1 !== i &&
                (this._favorites.splice(i, 1), this._favoritesChanged.fire()),
                this._saveFavs();
            }),
    ...
    UIZs: function (t, e, i) {
      ...
      function a(t) {
        ...
        return (
          ...
          t.dataName && e.attr('data-name', t.dataName),
      ...
      i.r(e),
        ...
        (c = i('EulZ')),
        (h =
          '<div class="tv-search-row"><input class="tv-search-row__input js-input-control" type="text" name="q" value="" autocomplete="off" data-role="search"><span class="tv-search-row__input-reset i-hidden js-reset-button">' +
          r +
    ...
    emGF: function (t, e, i) {
      ...
      function s(t, e) {
        ...
        return 0 === t.length
          ? Promise.resolve([])
          : (o.logNormal('Requesting favorites info'),
            (i = []),
            (s = new Map()),
            (n = new Map()),
            (r = new Map()),
            t.forEach(function (t) {
              switch (t.type) {
                ...
                default:
                  Object(a.assert)(
                    !1,
                    'unknown favorite type ' + JSON.stringify(t),
                  );
              }
            }),
            0 !== r.size &&
                ...
                e
                  ...
                  .then(function (t) {
                    var e,
                      ...
                      a =
                        ((i = t),
                        (s = { items: [], notFoundItems: [] }),
                        r.forEach(function (t, e) {
                          var a = i.get(e);
                          void 0 !== a
                            ? s.items.push({ item: t, info: a })
                            : s.notFoundItems.push(t);
                        }),
                        s);
                    return (
                      0 !== a.notFoundItems.length &&
                        ((e = a.notFoundItems.map(function (t) {
                          return t.studyId;
                        })),
                        o.logWarn(
            ...
            Promise.all(i).then(function (t) {
              return (
                o.logNormal('Requesting favorites info finished'),
      ...
      var a, n, o;
      i.r(e),
        i.d(e, 'getFavoritesInfo', function () {
          return s;
        }),
        (a = i('Eyy1')),
        (n = i('uOxu')),
        (o = Object(n.getLogger)('FavoritesInfo'));
    },
    'm/4m': function (t, e, i) {},
    pfXf: function (t, e, i) {
      'use strict';
        ...
        (function (t) {
          ...
          function s(t) {
            var e = t.css('background-color'),
              ...
              n = s.duration || h,
              o = s.easing || l;
            t.animate({ 'background-color': a }, n, o).animate(
              { 'background-color': e },
              n,
              o,
              i.bind(t, t),
