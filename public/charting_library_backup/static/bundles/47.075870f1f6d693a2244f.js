(window.webpackJsonp = window.webpackJsonp || []).push([
  [47],
  {
    '1yQO': function (e, i, t) {
      ...
      function o(e, i, t, o) {
        void 0 === o && (o = null);
        var n = { id: i, title: t, definitions: new r.a(e) };
    ...
    Equz: function (e, i, t) {
      ...
      function o(e, i, t, o) {
        var n = Object(h.c)(t),
          r = Object(s.r)(
            ...
            { id: o + 'Symbol' + n + 'CandlesColor', title: C },
          ),
          l = Object(s.r)(
            {
              checked: Object(s.b)(
            ...
            { id: o + 'Symbol' + n + 'BordersColor', title: v },
          ),
          c = Object(s.r)(
            {
              checked: Object(s.b)(
            ...
            { id: o + 'Symbol' + n + 'WickColors', title: j },
          );
        return [r, l, c];
      }
      function n(e, i, t, n, a) {
          ...
          case 0:
            return (function (e, i, t) {
              var o = Object(s.c)(
                  ...
                  { id: t + 'SymbolBarStyleBarColorsOnPrevClose', title: p },
                ),
                n = Object(s.c)(
                  {
                    checked: Object(s.b)(e, i.dontDrawOpen, 'Change HLC Bars'),
                  },
                  { id: t + 'SymbolDontDrawOpen', title: w },
                ),
                r = Object(s.e)(
                  {
                    color: Object(s.u)(
                ...
                l = Object(s.e)(
                  ...
                  { id: t + 'SymbolDownColor', title: f },
                ),
                c = Object(s.c)(
                  { checked: Object(s.b)(e, i.thinBars, 'Change Thin Bars') },
                  { id: t + 'SymbolBarThinBars', title: S },
                );
              return [o, n, r, l, c];
          ...
          case 1:
            return (function (e, i, t) {
              var n = Object(s.c)(
                ...
                { id: t + 'SymbolCandleStyleBarColorsOnPrevClose', title: p },
              );
            ...
            return (function (e, i, t, o, n) {
              var r = Object(s.j)(
                ...
                l = Object(s.j)(
                  ...
                  { id: n + 'SymbolStyleType', title: m, options: new u.a(o) },
                ),
                c = Object(s.h)(
                  {
                  ...
                  { id: n + 'SymbolLineStyle', title: _ },
                );
              return [r, l, c];
            })(
              e,
              i.lineStyle.childs(),
              n.seriesPriceSources,
              n.lineStyleTypes,
              a,
            );
          case 3:
            return (function (e, i, t, o) {
              var n = Object(s.j)(
                ...
                r = Object(s.h)(
                  ...
                  { id: o + 'SymbolAreaLineStyle', title: _ },
                ),
                l = Object(s.r)(
                  {
                    color1: Object(s.u)(
            ...
            return (function (e, i, t, o) {
              var n = Object(s.j)(
                ...
                l = Object(s.h)(
                  ...
                  { id: o + 'SymbolBaseLineBottomLine', title: P },
                ),
                c = Object(s.r)(
                  {
                    color1: Object(s.u)(
                  ...
                  { id: o + 'SymbolBaseLineTopFills', title: B },
                ),
                a = Object(s.r)(
                  {
                    color1: Object(s.u)(
                  ...
                  { id: o + 'SymbolBaseLineBottomFills', title: M },
                ),
                d = Object(s.i)(
                  {
                    value: Object(s.b)(
        ...
        return (
          (h = i),
          n.isJapaneseChartsAvailable && 8 === t
            ? (function (e, i, t) {
                var n = Object(s.c)(
                    {
                      checked: Object(s.b)(
                    ...
                    { id: t + 'SymbolRealLastPrice', title: T },
                  ),
                  l = Object(s.c)(
                    {
                      checked: Object(s.b)(
                    ...
                    { id: t + 'SymbolHAStyleBarColorsOnPrevClose', title: p },
                  );
                return Object(r.__spreadArrays)(
                  [n, l],
                  o(e, i, 'Heikin Ashi', t),
                );
              })(e, h.haStyle.childs(), a)
            : (n.isJapaneseChartsAvailable &&
                d.enabled('japanese_chart_styles'),
              d.enabled('chart_style_hilo') && 12 === t
                ? ((C = h.hiloStyle.childs()),
                  (v = Object(c.chartStyleStudyId)(12)),
                  (function (e, i, t, o) {
                    var n = Object(s.e)(
                        {
                          color: Object(s.u)(
                      ...
                      r = Object(s.e)(
                        ...
                        { id: o + 'SymbolBorderColor', title: A },
                      ),
                      l = t.map(function (e) {
      ...
      t.d(i, 'a', function () {
        ...
        (b = t('Z5lT')),
        (h = t('LIFs')),
        (p = window.t('Color Bars Based on Previous Close')),
        (w = window.t('HLC Bars')),
        (y = window.t('Up Color')),
        (f = window.t('Down Color')),
        (S = window.t('Thin Bars')),
        (C = window.t('Candles')),
        (v = window.t('Borders')),
        (j = window.t('Wick')),
        ...
        (_ = window.t('Line')),
        (g = window.t('Top Line')),
        (P = window.t('Bottom Line')),
        (L = window.t('Fill')),
        (B = window.t('Fill Top Area')),
        (M = window.t('Fill Bottom Area')),
        window.t('Up bars'),
        window.t('Down bars'),
    ...
    zqjM: function (e, i, t) {
                ...
                return 'float' === t.type
                  ? ((b = void 0),
                    (b =
                      (function (e, i) {
                        return !(
                          ((i === Object(D.chartStyleStudyId)(4) ||
                            i === Object(D.chartStyleStudyId)(6)) &&
                            'boxSize' === e) ||
                          (i === Object(D.chartStyleStudyId)(5) &&
                            'reversalAmount' === e)
                        );
                      })(c, i) || null === r.value()
                        ? new T.a(t.min)
      ...
      t.d(i, 'd', function () {
        ...
        (l = window.t('Last value line')),
        window.t('Previous close value line'),
        (s = window.t('Precision')),
        (c = window.t('Time Zone')),
        (a = window.t('Open')),
        (u = window.t('High')),
        (d = window.t('Low')),
        (b = window.t('Close')),
        (h = window.t('(H + L)/2')),
        (p = window.t('(H + L + C)/3')),
        (w = window.t('(O + H + L + C)/4')),
        (y = window.t('Simple')),
        (f = window.t('With Markers')),
        (S = window.t('Step')),
        (C = window.t('Default')),
        ((r = {})[Object(D.chartStyleStudyId)(12)] = [
          7,
          8,
          9,
          10,
        ...
        (m = [
          { title: y, value: k.STYLE_LINE_TYPE_SIMPLE },
          { title: f, value: k.STYLE_LINE_TYPE_MARKERS },
          { title: S, value: k.STYLE_LINE_TYPE_STEP },
        ]),
        (_ = !0),
        (g = (function () {
          ...
          return (
            ...
            (e.prototype._updateSeriesMinTickWV = function () {
              null === this._seriesMinTickWV
                ? (this._seriesMinTickWV = new T.a(this._seriesMinTick()))
                : this._seriesMinTickWV.setValue(this._seriesMinTick());
            }),
            (e.prototype._updateDefinitions = function () {
              var e = this;
              null !== this._definitions && Object(B.t)(this._definitions),
                (this._definitions = null),
                this._unsubscribeInputsUpdate(),
              ...
              return new Promise(function (i) {
                ...
                null !== n
                  ? e._model
                      ...
                      .then(function (n) {
                        ...
                        null === e._definitions
                          ? ((l = Object(L.ensureNotNull)(e._seriesMinTickWV)),
                            (s = o(e._undoModel, n.id, n.inputs, t, r, l, a)),
                            e._subscribeInputsUpdate(n.inputs, t),
                            i(s))
                          : i(null);
                      })
                  : i(null);
                ...
                return null !== e._definitions
                  ...
                  : ((o = Object(A.a)(
                    ...
                    (e._definitions = Object(P.__spreadArrays)(
                      [Object(B.k)(o, 'generalSymbolStylesGroup')],
                      e._seriesPriceLinesDefinitions(a),
                      e._seriesDataDefinitions(a),
                      [r, u],
                    )),
                    e._definitions);
              });
              ...
              return (
                this._series.hasClosePrice() &&
                  ((i = Object(B.h)(
                    ...
                    { id: e + 'SymbolLastValuePriceLine', title: l },
                  )),
                  t.push(i)),
                this._series.hasClosePrice(),
                t
