  ...
  ['dialogs-core'],
  {
              ...
              s(o, [
                {
                  ...
                  value: function () {
                    ...
                    if (!this.opened)
                      return (
                        (this.opened = !0),
                        (this._keyboardBinderLockId = p.disable()),
                        this.options.fixBodyState &&
                          c.default.setFixedBodyState(!0),
                        this._hotkeys ||
                          ((this._hotkeys = g.createGroup({
                            desc: 'Modal Dialog',
                            isDisabled: function () {
                              return !e.opened;
                            },
    ...
    nbyR: function (t, e, o) {
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }),
        ...
        (a = n(r)),
        (l = o('33OQ')),
        (c = (k = l) && k.__esModule ? k : { default: k }),
        (u = o('KHon')),
        (d = o('sFgq')),
        (h = o('5qpw')),
        (p = o('lxNp')),
        ...
        (e.TVPopup = (function (t) {
          function e() {
            ...
            return (
              ...
              )).$scrollWrap = t.$content.hasClass(y)
                ? t.$content
                : t.$content.find('.' + y)),
              t.$scrollWrap.length
              ...
              t.options.withScroll &&
                ((t.scroll = new d.SidebarCustomScroll(
                  t.$scrollWrap,
                  t.$scrollWrapInner,
                )),
                    ...
                    : ((this.opened = !0),
                      ...
                      this._doOpenAnimation().then(function () {
                        s.opened &&
                          ...
                          s.options.draggable &&
                            ((0, h.lazyJqueryUI)(s.$el).draggable({
              ...
              },
              {
                ...
                value: function () {
                  var t = this.$el[0].getBoundingClientRect(),
                    e = {};
                  t.bottom > c.default.height - _ &&
                    ((e.top = c.default.height - _ - t.height),
                    e.top < _ && (e.top = _)),
                    t.right > c.default.width - m &&
                      ((e.left = c.default.width - m - t.width),
                      e.left < m && (e.left = m)),
              ...
              },
              {
                ...
                value: function () {
                  var t,
                    ...
                    s =
                      this.options.height &&
                      this.options.height < c.default.height - 2 * _
                        ? this.options.height
                        : c.default.height - 2 * _;
                  this.$scrollWrap
                    .css({ height: '' })
            ...
            function o() {
              ...
              if (
                ...
                ((e = (function (t, e) {
                  ...
                  j.manager || (0, p.getRootOverlapManager)(j.ownerDocument)),
                (e._id = f++),
                (e.loadingActions = []),
                (e.disabledActions = []),
              ...
              return (
                ...
                e.options.closeButton &&
                  ((x = $(e.options.closeButtonTemplate)).addClass(
                    e.options.closeButtonAddClass || '',
                  ),
                  (T = e.$el),
                  1 === e.$el.find('.js-close-button-place').length &&
                    (T = e.$el.find('.js-close-button-place')),
                  x.appendTo(T)),
                e.setZIndex(b + g.length),
                j.errorMod && (e.errorMod = j.errorMod),
                e.on('afterOpen', function () {
                  e.$el.focus(),
