          ...
          (t = $(t)),
            ...
            (h = function (l, h, v) {
              ...
              switch (
                  ...
                  !(function e(o, s, i) {
                      ...
                      return 1 !== o.tabs.length || o.tabs[0].title
                        ? ((l = $(
                          ...
                          void $.each(o.tabs || [], function (t, a) {
                            ...
                            a.items &&
                              a.items.length &&
                              ((n = $('<div class="charts-popup-tab"></div>')
                                .hide()
                                .appendTo(l)),
                          ...
                          o.collapsible &&
                            ...
                            d.on('click', function () {
                              u.toggleClass('collapsed'),
                                'function' == typeof o.onChange &&
                                  o.onChange(u.hasClass('collapsed')),
                                w.height() === parseInt(w.css('max-height'))
                                  ? w.addClass('popup-menu-scroll-y')
                                  : w.height() <
                                      parseInt(w.css('max-height')) &&
                                    w.removeClass('popup-menu-scroll-y');
                            })),
                          u.append(d)),
                    ...
                    if (o instanceof p.Header)
                      ...
                      (h = $('<a class="item">')),
                        ...
                        o.date
                          ? ((m = $('<span class="title"></span>').appendTo(h)),
                            $('<span class="date"></span>')
                              ...
                              .appendTo(h))
                          : o.icon && !n.svg
                          ? ((g = $('<span class="icon"></span>').appendTo(
                              h,
                            )).css('background-image', o.icon.image || ''),
                            o.icon.offset &&
                              g.css(
                                'background-position',
                        ...
                        o.html
                          ? m.html(o.html)
                          : m.text(TradingView.clean(o.title, !0) || ''),
                ...
                case 'up':
                  'down' === E
                    ...
                    O
                      ? w
                          .css('left', Math.max(k.left + N + D - S, A) + 'px')
                          .css('right', 'auto')
                ...
                case 'left':
                  (I = Math.max(I, 4)),
                    'right' === E
                      ? w
                          .css('left', Math.floor(k.left + D + I) + 'px')
                          .css('right', 'auto')
                      : w
                          .css(
                            'left',
                            Math.floor(Math.max(k.left - S - I, A)) + 'px',
                          )
                          .css('right', 'auto'),
                    O
                      ? w.css(
                          'top',
                          Math.floor(Math.max(k.top + N + _ - M, A)) + 'px',
                        )
              ...
              w.show(),
                ...
                w[0].scrollHeight > w.height() &&
                  w.addClass('popup-with-scroll'),
                l && l.preventDefault();
            }),
            l && t.bind(l, h),
            c &&
        ...
        (n._cache = {}),
          ...
          (n.prototype.loadData = function () {
            ...
            return this._toolName in n._cache
              ? ((this._list = n._cache[this._toolName]),
                $.Deferred().resolve())
              : $.get(
                  '/drawing-templates/' + this._toolName + '/',
                  function (e) {
                ...
                e.stopPropagation(),
                  $(this).is('active') ||
                    ...
                    'function' == typeof t.getDataForSaveAs &&
                      ...
                      n.push({
                        title: t.saveAsText,
                        action: a.showSaveDialog.bind(a, o),
                        addClass: 'special',
                      })),
                        ...
                        deleteAction: function () {
                          runOrSignIn(
                            function () {
                              ...
                              p({ type: 'modal', content: t }).then(function (
                                t,
                              ) {
