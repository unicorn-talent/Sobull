    ...
    MfqI: function (e, t, n) {
          ...
          ((t = (function (t) {
            function n(e, n) {
              ...
              return (
                ...
                (i = a._binding = Object(v.ensureDefined)(
                  S.get(n.chartWidget),
                )),
                (a.state = i.state()),
                a
            ...
            availableTimeFrames: d.any.isRequired,
      ...
      function a(e) {
        var t,
          n = h(
            e.className,
            M.item,
            (((t = {})[M.isActive] = e.isActive),
            (t[M.isFirst] = e.isFirst),
            (t[M.isLast] = e.isLast),
            t),
          );
      ...
      function o(e) {
        var t = e.reference,
          n = e.className,
          i = e.children,
          a = Object(u.__rest)(e, ['reference', 'className', 'children']);
        return l.createElement(
          'button',
          Object(u.__assign)({}, a, { className: h(n, H.button), ref: t }),
          l.createElement('span', { className: H.inner }, i),
        );
      }
      function r(e) {
        return l.createElement('span', {
          className: h($.separator, e.className),
        });
      }
      function s(e) {
        0;
      ...
      n.r(t),
        ...
        (E = (function () {
          function e(e) {
            ...
            (this._state = { ranges: [] }),
              ...
              (t = (this._context = e).chartWidget).withModel(
                null,
                function () {
                  var e = t.model(),
                    i = e.mainSeries();
                  i.onStatusChanged().subscribe(n, n._updateAvailableRanges),
                    m.enabled('update_timeframes_set_on_symbol_resolve') &&
                      i
                        .dataEvents()
                        .symbolResolved()
                        .subscribe(n, n._updateAvailableRanges),
                    i
                      .priceScale()
                      .properties()
                      .lockScale.subscribe(n, n._updateAvailableRanges),
                    i.onIntervalChanged().subscribe(n, n._onRangeChanged),
                    e
                      .model()
                      .onResetScales()
                      .subscribe(n, n._resetActiveInterval),
                    i
                      .dataEvents()
                      .symbolResolved()
                      .subscribe(n, n._resetActiveInterval),
                    i
                      .properties()
                      .extendedHours.subscribe(n, n._resetActiveInterval),
          ...
          return (
            ...
            (e.prototype.selectRange = function (e) {
              ...
              this._setState({ activeRange: e.value }),
                (t = this._context.chartWidgetCollection),
            ...
            (e.prototype._updateAvailableRanges = function () {
              var e,
                ...
                o = i.chartWidget;
              o.model() &&
                (t = (e = o.model().mainSeries()).status()) !==
                  _.STATUS_LOADING &&
                t !== _.STATUS_RESOLVING &&
        ...
        (R = n('cdbK')),
        (W = n('J3OW')),
        (N = { title: window.t('Date Range'), goToDate: window.t('Go to...') }),
        (w = (function (e) {
          function t() {
        ...
        (D = Object(k.a)(T.a, B)),
        (j = n('qSb5')),
        (z = Object(T.c)(function (e) {
          return l.createElement(
            'div',
            { className: h(e.className, D.slider), ref: e.reference },
        ...
        (F = n('ei7k')),
        (P = n('c7H2')),
        (I = { title: window.t('Go to...') }),
        (L = Object(F.b)({ keys: ['Alt', 'G'], text: '{0} + {1}' })),
        (q = (function (e) {
          function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
            ...
            (t.prototype.render = function () {
              ...
              return (
                ...
                l.createElement(
                  'div',
                  {
                    className: h('apply-common-tooltip', P.button, t),
            ...
            return (
              ...
              (i._getActions = function () {
                return (function (e) {
                  e.updateActions();
                  var t = e.actions();
                  return t && t.applyTimeZone instanceof Z.Action
            ...
            (t.prototype.render = function () {
              ...
              return l.createElement(
                ...
                l.createElement(
                  o,
                  {
                    className: h(t, Y.button, 'apply-common-tooltip'),
                    title: J.hint,
                    disabled: n,
                  },
                  a && r && a + ' (' + r + ')',
        ...
        (pe = Object(F.b)({ keys: ['Alt', 'Enter'], text: '{0} + {1}' })),
        (me = (function (e) {
          var t;
          return (
            ((t = (function (t) {
              ...
              (r._injector =
                ...
                function (e, t, n) {
                  ...
                  return l.isValidElement(e) &&
                    ...
                    'string' == typeof (i = e.props).className
                    ? ((r = {
                        className: h(
                          i.className,
                          0 === t && oe.first,
                          t === n.length - 1 && oe.last,
                        ),
                      }),
                      (c = a()),
                      (u = Object(v.ensureDefined)(be.get(e.type))),
                      l.createElement(
                        'div',
                        {
              ...
              (r._handleResize = function () {
                null === r._raf &&
                  (r._raf = requestAnimationFrame(function () {
                    ...
                    if (
                      (Object.assign(m, { dateRangeMode: x }), 'expanded' !== x)
                    ) {
                      for (
                        i =
                          _ -
                          Object(v.ensureNotNull)(r._rangeCollapsed)
                            .offsetWidth -
                          0,
                          a = 0,
                          o = 0,
          ...
          return (
                  ...
                  l.createElement(
                    ...
                    l.createElement(
                      'div',
                      {
                        className: h(
                          oe.dateRangeWrapper,
                          'collapsed' !== e.dateRangeMode && oe.collapsed,
                        ),
                    ...
                    l.createElement(
                      ...
                      l.createElement(
                        'div',
                        {
                          className: h(
                            oe.dateRangeWrapper,
                            'expanded' !== e.dateRangeMode && oe.collapsed,
                          ),
                ...
                l.createElement(
                  ...
                  this.props.timeWidgetEnabled &&
                    l.createElement(
                      ...
                      l.createElement(
                        'div',
                        {
                          className: h(oe.inline, e.timeZones && oe.collapsed),
                  ...
                  l.createElement(
                    ...
                    this.props.logScaleButtonEnabled &&
                      l.createElement(ue, { className: oe.item }),
                    this.props.autoScaleButtonEnabled &&
                      l.createElement(de, { className: oe.item }),
            ...
            (t.prototype._applyResizing = function () {
              var e = this,
                t = this._layout,
                n = t.dateRangeMode,
                i = Object(u.__rest)(t, ['dateRangeMode']);
              this._rangeExpanded &&
        ...
        (Ce = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (n.state = {
                chartWidget: t.chartWidgetCollection.activeChartWidget.value(),
              }),
              n
            );
          }
            ...
            (t.prototype.render = function () {
              ...
              return n
                ? ((t = {
                  ...
                  l.createElement(ve, Object(u.__assign)({ key: n.id() }, t)))
                : null;
            }),
            (t.childContextTypes = {
