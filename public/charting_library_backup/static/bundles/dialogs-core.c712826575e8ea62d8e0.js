  ...
  ['dialogs-core'],
  {
    ...
    APlX: function (t, e, o) {
      ...
      (function (t) {
        ...
        var i, s, r, a, l, c, u, d, p, h, f, g, v, b, y;
        Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          (a = n(r)),
          (l = o('33OQ')),
          (c = (y = l) && y.__esModule ? y : { default: y }),
          (u = o('KHon')),
          (d = o('c2JX')),
          (p = o('Bruo')),
          (h = n(p)),
          ...
          (e.TVModal = (function (e) {
            function o() {
              ...
              return (
                ...
                )).$overlay = $(t.options.overlayTemplate)),
                ...
                t.on('change:zIndex', function () {
                  t.$overlay.css('z-index', t.zIndex),
                    t.$modalWrap.css('z-index', t.zIndex);
                }),
                t.on('destroy', function () {
                  ...
                  t.opened
                    ? (t.close(), setTimeout(e, t.options.closingDuration))
                    : e();
                }),
                  ...
                  $.extend(t.options.ajax, {
                    ...
                    success: function (e) {
                      t.trigger('afterLoading', [t]),
                        t.renderContent(n ? n(t, e) : e).showContent(),
              ...
              s(o, [
                {
                  ...
                  value: function () {
                    ...
                    if (!this.opened)
                      return (
                        (this.opened = !0),
                        (this._shortCutsLockId = h.disable()),
                        (this._keyboardBinderLockId = g.disable()),
                        c.default.setFixedBodyState(!0),
                        (t = function () {
                          e.focus(),
                            e.toTop(),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.opened)
                      return (
                        (this.opened = !1),
                        this._shortCutsLockId &&
                          h.enable(this._shortCutsLockId),
                        this._keyboardBinderLockId &&
                          g.enable(this._keyboardBinderLockId),
                ...
                },
                {
                  ...
                  value: function () {
                    if (this.$el)
                      return (
                        this.$modalWrap.addClass('i-closed'),
                        this.unfocus(),
                        this
                      );
                  },
                },
                {
                  ...
                  value: function () {
                    return (
                      (this.spinner = new d.Spinner('large')),
    ...
    nbyR: function (t, e, o) {
      'use strict';
      var n, i, s, r, a, l, c, u, d, p, h, f, g, v;
      Object.defineProperty(e, '__esModule', { value: !0 }),
        (e.TVPopup = void 0),
        (n =
          Object.assign ||
        ...
        (a = o('33OQ')),
        (l = (v = a) && v.__esModule ? v : { default: v }),
        (c = o('KHon')),
        (u = o('sFgq')),
        (d = o('5qpw')),
        (p = $('body')),
        ...
        (e.TVPopup = (function (t) {
          function e() {
            ...
            return (
              ...
              )).$scrollWrap = t.$content.hasClass(g)
                ? t.$content
                : t.$content.find('.' + g)),
              t.$scrollWrap.length
                ? (t.$scrollWrapInner = t.$scrollWrap.children().first())
                : ((t.$scrollWrap = t.$content
                    .wrap($(t.options.scrollWrap))
                    .parent()),
                  (t.$scrollWrapInner = t.$content
                    .wrap($(t.options.scrollWrapInner))
                    .parent())),
              t.$actions && t.$scrollWrap.addClass('i-with-actions'),
              t.options.withScroll &&
                ((t.scroll = new u.SidebarCustomScroll(
                  t.$scrollWrap,
                  t.$scrollWrapInner,
                )),
                    ...
                    t.opened &&
                      ...
                      $(document).on('click.tv-popup-' + o, function (e) {
                        if (!t._preventClick) {
                          ...
                          (t.options.closeOnClickAtOtherDialogs ||
                            0 === o.length) &&
                            t.isEventOut(e) &&
                            t.close();
                        }
              ...
              t.on('destroy', function () {
                ...
                t.opened ? (t.close(), setTimeout(e, r.dur / 2)) : e();
              }),
              t
            );
          }
                    ...
                    : ((this.opened = !0),
                      ...
                      this.$el
                        ...
                        .css(
                          ...
                          (o = s.$el.height()),
                          (n = s.$el.width()),
                          (i = s.options.position) ||
                            (i = { top: t / 2 - o / 2, left: e / 2 - n / 2 }),
                          i.top > t - o && (i.top = t - o),
                          i.left > e - n && (i.left = e - n),
                          i),
                        ),
                      this.focus(),
                      this.toTop(),
                      this._doOpenAnimation().then(function () {
                        s.opened &&
                          (s.$el.removeClass('i-closed'),
                          s.options.draggable &&
                            ((0, d.lazyJqueryUI)(s.$el).draggable({
                          ...
                          s.trigger('afterOpen', [s]));
                      }),
                      h.on(
                        'resize.tv-popup-' + this.getDialogId(),
                        function () {
                ...
                value: function () {
                  ...
                  if (this.opened)
                    return (
                      ...
                      h.off('resize.tv-popup-' + this.getDialogId()),
                      this
                    );
                },
              },
                ...
                value: function () {
                  ...
                  this.$scrollWrap
                    ...
                    (this.options.height || t.height > s) &&
                      ((s -= o.height - i.height) < 60 && (s = 60),
                      this.$scrollWrap.css({ height: s })),
                    this.options.withScroll && this.scroll.resize(),
                    (e = s < n.height) || this.$scrollWrapInner.css('top', 0),
                  ...
                  (this.stopping = !0),
                    ...
                    setTimeout(function () {
                      (t.loading = !1),
                        ...
                        (t._stopPromise = !1),
                        t.$btn.removeClass(
                          'i-loading i-start-load i-stop-load',
                        ),
    ...
    v2PZ: function (t, e, o) {
      ...
      (function (t, n) {
        ...
        var s, r, a, l, c, u, d, p, h, f, g, v, b, y, _, m, w, k;
        Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          (k = (function (e) {
            function o() {
              ...
              if (
                ...
                )).manager = (0, h.getRootOverlapManager)(x.ownerDocument)),
                (e._id = f++),
                (e.loadingActions = []),
                (e.disabledActions = []),
                ...
                try {
                  for (
                    l = Object.entries(e.options.dataset)[Symbol.iterator]();
                    !(n = (c = l.next()).done);
                    n = !0
                  )
                    (u = c.value),
              ...
              for (
                e.options.addClass && e.$el.addClass(e.options.addClass),
                  e.options.width &&
                    e.$el.css({ width: '100%', 'max-width': e.options.width }),
                  ...
                  e.options.title &&
                    (e.$title = $(
                      t.render(e.options.titleTemplate, {
                        title: e.options.title,
                      }),
                    ).appendTo(e.$el)),
              ...
              if (
                ...
                (e.options.actions || e.options.help) &&
                  ...
                  (e.$actions = $(e.options.actionsWrapTemplate).appendTo(
                    e.$el,
                  ))),
                e.options.actions)
              )
                for (
                  e.actions = {},
                    e.$el.on(
                      ...
                      function (t) {
                        t.preventDefault(),
                          e.actionDispatcher($(t.currentTarget).data('name'));
                      },
                    ),
                    C = function (o) {
                      var n,
                      ...
                      c.type || (c.type = 'default'),
                        c.class ||
                          (c.class = m[c.type] ? m[c.type] : m.default),
                        'checkbox' === c.type
                          ? ((n = new d.default({
                              labelRight: c.text,
                              name: c.name,
                            ...
                            (e.actions[c.name] = n.$el.appendTo(e.$actions)),
              ...
              return (
                e.options.help &&
                  $(
                    t.render(e.options.helpButtonTemplate, e.options.help),
                  ).prependTo(e.$actions.addClass(e.options.helpActionsMod)),
                e.options.closeButton &&
                  ((T = $(e.options.closeButtonTemplate)).addClass(
                    e.options.closeButtonAddClass || '',
                  ),
                  (j = e.$el),
                  1 === e.$el.find('.js-close-button-place').length &&
                    (j = e.$el.find('.js-close-button-place')),
                  T.appendTo(j)),
                e.setZIndex(b + g.length),
                x.errorMod && (e.errorMod = x.errorMod),
                e.on('afterOpen', function () {
                ...
                e.$el.on('click', '.js-dialog__close', e.close.bind(e)),
            ...
            return (
              ...
              a(o, [
                ...
                },
                {
                  ...
                  value: function () {
                    for (var t = g.length - 1; t >= 0; t--)
                      g[t].zIndex > this.zIndex &&
                        g[t].setZIndex(g[t].zIndex - 1);
                    return (
                      this.setZIndex(b + g.length),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e, o, n;
                    return this.options.isClickOutFn &&
                      void 0 !== (e = this.options.isClickOutFn(t))
                      ? e
                      : ((o = !0),
                        (n = $(t.target)).get(0) !== this.$el.get(0) &&
                      ...
                      setTimeout(function () {
                        y.on(
                          ...
                          function (e) {
                            t.isEventOut(e) &&
                              (t.unfocus(),
                              y.off('mousedown.tv-dialog-unfocus-' + t._id));
                          },
                        );
                      }, 20);
                  },
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      ...
                      y.one('touchstart mousedown keydown', n),
          ...
          y.on('keyup.tv-dialog-esc', function (t) {
            v &&
              v.options.closeOnEsc &&
