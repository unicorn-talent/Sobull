          ...
          (o.prototype.show = function (e) {
            ...
            if (
              ...
              TradingView.isInherited(this._source.constructor, s) &&
                this._model.addSourceToSelection(this._source),
              (g = b.createStudyStrategyPropertyPage(
                this._source,
                this._model,
              )),
              ...
              return (
                ...
                $(window).bind('keyup.hidePropertyDialog', function (t) {
                  13 === t.keyCode &&
                    ...
                    (P._templateButton &&
                      P._templateButton.trigger('hide-popup'),
                    P.hide());
                }),
                $('select', D).each(function () {
                  var t = $(this),
                ...
                T &&
                  'function' == typeof T.dialogPosition &&
                  (A = T.dialogPosition(A, O) || A),
