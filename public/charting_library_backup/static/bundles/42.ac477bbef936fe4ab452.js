  ...
  [42],
  {
    ...
    'MP+M': function (o, e, i) {
      ...
      i.d(e, 'a', function () {
        ...
        (r = { keys: ['Shift'], text: window.t('{0} — circle') }),
        ...
        (d = {
          ...
          LineToolHorzLine: {
            ...
            hotKey: Object(l.b)({ keys: ['Alt', 'H'], text: '{0} + {1}' }),
          },
          LineToolHorzRay: {
          ...
          LineToolVertLine: {
            ...
            hotKey: Object(l.b)({ keys: ['Alt', 'V'], text: '{0} + {1}' }),
          },
          LineToolCrossLine: {
          ...
          arrow: { icon: a.a.arrow, localizedName: window.t('Arrow') },
          cursor: { icon: a.a.cursor, localizedName: window.t('Cross') },
          dot: { icon: a.a.dot, localizedName: window.t('Dot') },
          drawginmode: {
            icon: a.a.drawginmode,
            iconActive: a.a.drawginmodeActive,
            localizedName: window.t('Stay in Drawing Mode'),
          },
          eraser: { icon: a.a.eraser, localizedName: window.t('Eraser') },
          group: {
            icon: a.a.group,
          ...
          magnet: {
            ...
            hotKey: Object(l.b)({ keys: ['Ctrl'], text: '{0}' }),
          },
          measure: {
            icon: a.a.measure,
          ...
          zoom: { icon: a.a.zoom, localizedName: window.t('Zoom In') },
          'zoom-out': {
            icon: a.a['zoom-out'],
