      ...
      Object.defineProperty(e, '__esModule', { value: !0 }),
        (e.show = function (t, e) {
          ...
          for (
            w = $.extend(
              {},
              { title: $.t('Confirm Inputs'), callback: function (t) {} },
              w,
            ),
              n = null,
              a = (0, o.createDialog)({
                ...
                isClickOutFn: function (t) {
                  ...
                  if (e)
                    return (
                      e[0] !== t.target && !e[0].contains(t.target) && void 0
                    );
                },
                actions: [
                  {
          ...
          (f = new s.default({ inputs: d })),
            ...
            (g = a.$content),
            a.open(),
            (y = (n = new i.StudyInputsPropertyPage(
              f,
              t.model(),
              v,
              !0,
            ...
            Array.prototype.forEach.call(g.find('select'), function (t) {
              ...
              e.hasClass('tv-select-container-fontsize') &&
                (n += ' tv-select-container-fontsize'),
