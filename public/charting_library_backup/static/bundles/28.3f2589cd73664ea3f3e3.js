        ...
        v = (function (t) {
            ...
            return (
              (e._renderNumber = function (t, n) {
                var o,
                  r = _(
                    f.number,
                    (((o = {})[f.active] = t === e.props.activeNumber),
                    (o[f.inner] = e.props.isInner),
                    o),
                  ),
                ...
                return d.createElement(
                  'span',
                  {
                    key: t,
                    className: r,
                    style: e._numberStyle(e.props.radius - e.props.spacing, n),
                    'data-value': s,
                  },
          ...
          return (
            ...
            (e.prototype._numberStyle = function (t, e) {
              ...
              return {
                left: t + t * Math.sin(n) + this.props.spacing,
                top: t - t * Math.cos(n) + this.props.spacing,
              };
            }),
            e
          );
          ...
          function e(e) {
            ...
            return (
              ...
              (n._onChangeHours = function (t) {
                n.state.time.hours() !== t &&
                  n._onChange(n.state.time.clone().hours(t));
              }),
              (n._onChangeMinutes = function (t) {
                n.state.time.minutes() !== t &&
                  n._onChange(n.state.time.clone().minutes(t));
              }),
              ...
              (n._onSelectMinutes = function (t) {
                t &&
                  ...
                  n._clockFace &&
                  n._clockFace.contains(t.target) &&
                  t.preventDefault(),
          ...
          return (
              ...
              return d.createElement(
                  ...
                  d.createElement(
                    'span',
                    {
                      className: _(
                        f.number,
                        ((t = {}),
                        (t[f.active] = this.state.faceType === u.Hours),
                        t),
                      ),
                  ...
                  d.createElement(
                    'span',
                    {
                      className: _(
                        f.number,
                        ((e = {}),
                        (e[f.active] = this.state.faceType === u.Minutes),
                        e),
                      ),
                ...
                d.createElement(
                  ...
                  d.createElement(
                    ...
                    this.state.faceType === u.Hours
                      ? this._renderHours()
                      : null,
                    this.state.faceType === u.Minutes
                      ? this._renderMinutes()
                      : null,
            ...
            (e.prototype._onChange = function (t) {
              this.setState({ time: t }),
                this.props.onChange && this.props.onChange(t.clone());
            }),
            (e.prototype._calculateShape = function () {
              var t = this;
              null === this._raf &&
                (this._raf = requestAnimationFrame(function () {
                  var e = Object(m.ensureNotNull)(
                      t._clockFace,
              ...
              return (
                ...
                (n.state = {
                  ...
                  width: n.props.inheritWidthFromTarget
                    ? n.props.target &&
                      n.props.target.getBoundingClientRect().width
                    : n.props.width,
                }),
                n
              );
              ...
              (e.prototype.componentWillReceiveProps = function (t) {
                if (
                  ...
                  t.width !== this.props.width &&
                    this.setState({ width: t.width }),
                  t.attachmentCommand !== this.props.attachmentCommand &&
                    t.attachmentCommand)
                )
              ...
              (e.prototype._calcProps = function (t) {
                ...
                if (t.target && t.attachment && t.targetAttachment) {
                  switch (
                    ...
                    (s = {
                      width:
                        void 0 === (r = n.inheritWidthFromTarget) || r
                          ? e.width
                          : o,
                    }),
              ...
              (e.prototype._calcTargetProps = function (t, e, n) {
                var o = t.getBoundingClientRect(),
                  ...
                  s =
                    'parent' === this.props.root
                      ? this._getCoordsRelToParentEl(t, o)
                ...
                return (
                  'number' == typeof this.props.attachmentOffsetY &&
                    (u += this.props.attachmentOffsetY),
