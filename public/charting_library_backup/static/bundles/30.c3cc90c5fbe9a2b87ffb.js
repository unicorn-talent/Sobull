    ...
    '4Cm8': function (t, e, i) {
      ...
      function n(t) {
        return c.createElement(
          l,
          a.__assign({}, t, { className: b.scrollLeft }),
        );
      }
      function o(t) {
        return c.createElement(
          l,
          a.__assign({}, t, { className: b.scrollRight }),
        );
      }
      function l(t) {
        var e;
        return c.createElement(
          ...
          c.createElement(
            ...
            c.createElement(p.a, { icon: m, className: b.icon }),
          ),
        );
      }
      var a, c, h, u, p, d, f, w, m, b, _, R, S, V, v, g;
      i.d(e, 'a', function () {
        return _;
      }),
        (a = i('mrSG')),
          ...
          function e(e) {
            ...
            return (
              ...
              (i._handleScrollLeft = function () {
                i.props.onScrollButtonClick
                  ...
                  : i.animateTo(
                      Math.max(
                        0,
                        i.currentPosition() - (i.state.widthWrap - 50),
                      ),
                    );
              }),
              ...
              (i._checkButtonsVisibility = function () {
                var t, e, s, r, n;
                (i.props.isVisibleButtons || i.props.isVisibleFade) &&
                  ((e = (t = i.state).isVisibleLeftButton),
          ...
          return (
            ...
            (e.prototype.currentPosition = function () {
              return this._scroll.current
                ? w.IS_RTL
                  ? Object(w.getLTRScrollLeft)(this._scroll.current)
            ...
            (e.prototype.animateTo = function (t, e) {
              ...
              i &&
                (w.IS_RTL && (t = Object(w.getLTRScrollLeftOffset)(i, t)),
                e <= 0
            ...
            (e.prototype.render = function () {
              var t,
                ...
                p = this.state,
                d = p.isVisibleRightButton,
                f = p.isVisibleLeftButton,
                w = l && a;
              return c.createElement(
                u,
                {
                ...
                c.createElement(
                  'div',
                  { className: b.wrapOverflow },
                  c.createElement(
                    'div',
                    { className: h(b.wrap, w ? b.wrapWithArrowsOuting : '') },
                    c.createElement(
                      'div',
                      {
                        className: h(
                          b.scrollWrap,
                          ((t = {}), (t[b.noScrollBar] = !s), t),
                        ),
                    ...
                    r && c.createElement(V, { isVisible: f }),
                    r && c.createElement(v, { isVisible: d }),
                    n &&
                      c.createElement(R, {
