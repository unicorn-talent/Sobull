          ...
          return (
            ...
            (e.prototype.ensureWindow = function (e, t) {
              ...
              return (
                ...
                void 0 !== (s = this._windows.get(e))
                  ? s
                  : (this.registerWindow(e),
                    ((n = this._document.createElement('div')).style.position =
                      t.position),
                    (n.style.zIndex = this._index.toString()),
                    (n.dataset.id = e),
                    this._container.appendChild(n),
                    this._windows.set(e, n),
                    ++this._index,
                    n)
              );
            }),
          ...
          e.extend(s.prototype, {
            ...
            _attachSelectbox: function (t, s) {
              ...
              (l = e(t)),
                ...
                l.attr('sb', r.uid),
                e.extend(r.settings, a._defaults, s),
                (a._state[r.uid] = !1),
                l.hide(),
                (c = e('<div>', {
                  id: 'sbHolder_' + r.uid,
                ...
                (h = l.data('selectbox-css')) && c.css(h),
                (d = e('<a>', {
                ...
                (r.sbSelector = d),
                this._fillList(t, r),
                e.data(t, 'selectbox', r),
                d.appendTo(c),
                u.appendTo(c),
                c.insertAfter(l),
                r._onAttachCallback &&
                  (r._onAttachCallback(), delete r._onAttachCallback),
            ...
            _changeSelectbox: function (t, s, o) {
              var l,
                ...
                p =
                  r.find('#sbSelector_' + c.uid).text() === o &&
                  r
              ...
              p ||
                ...
                (a = r.find('#sbSelector_' + c.uid)).text(o),
                i(c, a, l),
                r
                  .find('#sbOptions_' + c.uid)
                  .find('.active')
                ...
                l.attr('selected', !0),
                d
                  ? d.apply(c.input ? c.input[0] : null, [s, c])
            ...
            _openSelectbox: function (t) {
              ...
              !f ||
                ...
                (h = null),
                (u = this._get(f, 'beforeOpen')) && (h = u()),
                'object' == typeof h && null !== h
                  ? i.css(h)
                  : (d > 50 && !f.settings.slidesUp
                      ? i.css({
                          bottom: 'auto',
                          top: c + 2 + 'px',
                          maxHeight: d - c + 'px',
                  ...
                  '__separator__' === f.val()
                    ...
                    : ((s = e('<a>', {
                        ...
                        click: function (t) {
                          ...
                          s.attr('id').split('_')[1],
                            c._closeSelectbox(l),
                            c._changeSelectbox(l, e(this).attr('rel'), p),
                            s.focus();
                        },
                      })),
                      ...
                      a && s.addClass(n.settings.classSub),
                      s.appendTo(b)),
                  (d = f.data('custom-option-prepend')) && s.prepend(d),
                  b.addClass(f.attr('class')),
                  b.appendTo(n.sbOptions);
              });
            },
                  ...
                  .each(function (n) {
                    ...
                    l.is('option')
                      ...
                      : l.is('optgroup') &&
                        ...
                        (a.sub = !0),
                        o._getOptions(l.find('option'), a, s, r, t));
                  }),
                s.isSelected ||
