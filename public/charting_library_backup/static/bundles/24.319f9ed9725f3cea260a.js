(window.webpackJsonp = window.webpackJsonp || []).push([
  [24],
  {
    ...
    '43BO': function (o, e) {
      o.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path d="m6 13a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2m1 0a2 2 0 0 0 1 1h12a2 2 0 0 0 1-1v-9a2 2 0 0 0-1-1H8a2 2 0 0 0-1 1m6 5a1 1 0 0 1 2 0v2a1 1 0 0 1-2 0m-3-9V8a1 1 0 0 1 8 0v3h-1V8a1 1 0 0 0-6 0v3"/></svg>';
    },
    '6oLA': function (o, e) {
      o.exports =
      ...
      i.d(e, 'a', function () {
        ...
        (r = {
          LineTool5PointsPattern: {
            icon: l.lineToolsIcons.LineTool5PointsPattern,
            localizedName: window.t('XABCD Pattern'),
          },
          LineToolABCD: {
            icon: l.lineToolsIcons.LineToolABCD,
            localizedName: window.t('ABCD Pattern'),
          },
          LineToolArc: {
            icon: l.lineToolsIcons.LineToolArc,
            localizedName: window.t('Arc'),
          },
          LineToolArrow: {
            icon: l.lineToolsIcons.LineToolArrow,
            localizedName: window.t('Arrow'),
          },
          LineToolArrowMarkDown: {
            icon: l.lineToolsIcons.LineToolArrowMarkDown,
            localizedName: window.t('Arrow Mark Down'),
          },
          LineToolArrowMarkLeft: {
            icon: l.lineToolsIcons.LineToolArrowMarkLeft,
            localizedName: window.t('Arrow Mark Left'),
          },
          LineToolArrowMarkRight: {
            icon: l.lineToolsIcons.LineToolArrowMarkRight,
            localizedName: window.t('Arrow Mark Right'),
          },
          LineToolArrowMarkUp: {
            icon: l.lineToolsIcons.LineToolArrowMarkUp,
            localizedName: window.t('Arrow Mark Up'),
          },
          LineToolBalloon: {
            icon: l.lineToolsIcons.LineToolBalloon,
            localizedName: window.t('Balloon'),
          },
          LineToolBarsPattern: {
            icon: l.lineToolsIcons.LineToolBarsPattern,
            localizedName: window.t('Bars Pattern'),
          },
          LineToolBezierCubic: {
            icon: l.lineToolsIcons.LineToolBezierCubic,
            localizedName: window.t('Double Curve'),
          },
          LineToolBezierQuadro: {
            icon: l.lineToolsIcons.LineToolBezierQuadro,
            localizedName: window.t('Curve'),
          },
          LineToolBrush: {
            icon: l.lineToolsIcons.LineToolBrush,
            localizedName: window.t('Brush'),
          },
          LineToolCallout: {
            icon: l.lineToolsIcons.LineToolCallout,
            localizedName: window.t('Callout'),
          },
          LineToolCircleLines: {
            icon: l.lineToolsIcons.LineToolCircleLines,
            localizedName: window.t('Cyclic Lines'),
          },
          LineToolCypherPattern: {
            icon: l.lineToolsIcons.LineToolCypherPattern,
            localizedName: window.t('Cypher Pattern'),
          },
          LineToolDateAndPriceRange: {
            icon: l.lineToolsIcons.LineToolDateAndPriceRange,
          ...
          LineToolGhostFeed: {
            icon: l.lineToolsIcons.LineToolGhostFeed,
            localizedName: window.t('Ghost Feed'),
          },
          LineToolHeadAndShoulders: {
            icon: l.lineToolsIcons.LineToolHeadAndShoulders,
            localizedName: window.t('Head and Shoulders'),
          },
          LineToolHorzLine: {
            icon: l.lineToolsIcons.LineToolHorzLine,
            localizedName: window.t('Horizontal Line'),
            hotKey: Object(n.b)({ keys: ['Alt', 'H'], text: '{0} + {1}' }),
          },
          LineToolHorzRay: {
            icon: l.lineToolsIcons.LineToolHorzRay,
            localizedName: window.t('Horizontal Ray'),
          },
          LineToolIcon: {
            icon: l.lineToolsIcons.LineToolIcon,
          ...
          LineToolNote: {
            icon: l.lineToolsIcons.LineToolNote,
            localizedName: window.t('Note'),
          },
          LineToolNoteAbsolute: {
            icon: l.lineToolsIcons.LineToolNoteAbsolute,
            localizedName: window.t('Anchored Note'),
          },
          LineToolParallelChannel: {
            icon: l.lineToolsIcons.LineToolParallelChannel,
            localizedName: window.t('Parallel Channel'),
            hotKey: Object(n.b)(a),
          },
          LineToolPitchfan: {
            icon: l.lineToolsIcons.LineToolPitchfan,
            localizedName: window.t('Pitchfan'),
          },
          LineToolPitchfork: {
            icon: l.lineToolsIcons.LineToolPitchfork,
            localizedName: window.t('Pitchfork'),
          },
          LineToolPolyline: {
            icon: l.lineToolsIcons.LineToolPolyline,
            localizedName: window.t('Polyline'),
          },
          LineToolPrediction: {
            icon: l.lineToolsIcons.LineToolPrediction,
            localizedName: window.t('Forecast'),
          },
          LineToolPriceLabel: {
            icon: l.lineToolsIcons.LineToolPriceLabel,
            localizedName: window.t('Price Label'),
          },
          LineToolPriceRange: {
            icon: l.lineToolsIcons.LineToolPriceRange,
            localizedName: window.t('Price Range'),
          },
          LineToolProjection: {
            icon: l.lineToolsIcons.LineToolProjection,
            localizedName: window.t('Projection'),
          },
          LineToolRay: {
            icon: l.lineToolsIcons.LineToolRay,
            localizedName: window.t('Ray'),
          },
          LineToolRectangle: {
            icon: l.lineToolsIcons.LineToolRectangle,
          ...
          SyncDrawing: {
            icon: t.a.SyncDrawing,
            iconActive: t.a.SyncDrawingActive,
            localizedName: window.t(
              'New drawings are replicated to all charts in the layout and shown when the same ticker is selected',
            ),
          },
          arrow: { icon: t.a.arrow, localizedName: window.t('Arrow') },
          cursor: { icon: t.a.cursor, localizedName: window.t('Cross') },
          dot: { icon: t.a.dot, localizedName: window.t('Dot') },
          drawginmode: {
            icon: t.a.drawginmode,
            iconActive: t.a.drawginmodeActive,
            localizedName: window.t('Stay in Drawing Mode'),
          },
          eraser: { icon: t.a.eraser, localizedName: window.t('Eraser') },
          group: {
            icon: t.a.group,
            localizedName: window.t('Show Hidden Tools'),
          },
          hideAllDrawings: {
            icon: t.a.hideAllDrawings,
            iconActive: t.a.hideAllDrawingsActive,
            localizedName: window.t('Hide All Drawing Tools'),
          },
          lockAllDrawings: {
            icon: t.a.lockAllDrawings,
            iconActive: t.a.lockAllDrawingsActive,
          ...
          removeAllDrawingTools: {
            icon: t.a.removeAllDrawingTools,
            localizedName: window.t('Remove All Drawing Tools'),
          },
          showObjectsTree: {
            icon: t.a.showObjectTree,
            localizedName: window.t('Show Object Tree'),
          },
          zoom: { icon: t.a.zoom, localizedName: window.t('Zoom In') },
          'zoom-out': {
            icon: t.a['zoom-out'],
    ...
    Uh5y: function (o, e) {
      o.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path d="m6 13a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2m1 0a2 2 0 0 0 1 1h12a2 2 0 0 0 1-1v-9a2 2 0 0 0-1-1H8a2 2 0 0 0-1 1m6 5a1 1 0 0 1 2 0v2a1 1 0 0 1-2 0m-3-9V7a1 1 0 0 1 8 0h-1a1 1 0 0 0-6 0v4"/></svg>';
    },
    WHEt: function (o, e) {
      o.exports =
    ...
    b2d7: function (o, e, i) {
      ...
      i.d(e, 'a', function () {
        ...
        (function (o) {
          function e() {
            (o.favorites = []),
              Object(t.getJSON)('chart.favoriteDrawings', []).forEach(function (
                e,
              ) {
        ...
        (function (o) {
          ...
          (o.favoriteAdded = new l.a()),
            (o.favoriteRemoved = new l.a()),
            (o.favoriteMoved = new l.a()),
            ...
            (o.isFavorite = i),
            (o.moveFavorite = function (i, n) {
              if (n < 0 || n >= e()) return !1;
              var l = a.favoriteIndex(i);
              return (
                -1 !== l &&
                n !== l &&
                (a.favorites.splice(l, 1),
                a.favorites.splice(n, 0, i),
                a.saveFavorites(),
                o.favoriteMoved.fire(i, l, n),
                !0)
              );
            });
        })(c || (c = {}));
    ...
    oCKS: function (o, e) {
      o.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"><path d="M2 9.75a1.5 1.5 0 0 0-1.5 1.5v5.5a1.5 1.5 0 0 0 1.5 1.5h24a1.5 1.5 0 0 0 1.5-1.5v-5.5a1.5 1.5 0 0 0-1.5-1.5zm0 1h3v2.5h1v-2.5h3.25v3.9h1v-3.9h3.25v2.5h1v-2.5h3.25v3.9h1v-3.9H22v2.5h1v-2.5h3a.5.5 0 0 1 .5.5v5.5a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5v-5.5a.5.5 0 0 1 .5-.5z" transform="rotate(-45 14 14)"/></svg>';
    },
    qQ3E: function (o, e) {
      o.exports =
