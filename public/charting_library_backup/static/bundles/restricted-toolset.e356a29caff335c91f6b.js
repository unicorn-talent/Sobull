    ...
    miV2: function (e, t, n) {
      ...
      function i(e) {
        ...
        return d.createElement(
          ...
          h.__assign({}, s, {
            text: r ? t : void 0,
            className: C(n, L.button, r ? L.withText : L.withoutText),
          }),
        );
      }
      function o(e) {
        ...
        return d.createElement(
          w.a,
          h.__assign({}, n, { className: C(t, F.button) }),
        );
      }
      function a(e) {
        var t;
      ...
      function s(e, t) {
        return (
          void 0 === t && (t = !1),
          { name: ce[e], items: [], mayOmitSeparator: t }
        );
      }
      function r(e) {
      ...
      n.r(t),
        ...
        (y = (function (e) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return d.createElement(
                'div',
                h.__assign({ className: C(n, S.wrap) }, i),
                t,
              );
            }),
            t
        ...
        (I = (function (e) {
          function t(t, n) {
            ...
            return (
              ...
              c.enabled('chart_style_hilo') &&
                l.state.styles.push(v.STYLE_HILO),
              l
            );
          }
          return (
                    ...
                    _.a,
                    {
                      ...
                      content: e
                        ...
                        : d.createElement(
                            y,
                            null,
                            d.createElement(f.a, { icon: p.SERIES_ICONS[h] }),
                          ),
            ...
            return (
              (i._handleClick = function () {
                i.setState({ isActive: !0 }),
                  i.context.chartWidgetCollection
        ...
        (K = (function (e) {
          ...
          return (
            h.__extends(t, e),
            (t.prototype.componentDidMount = function () {
              this.props.studyMarket.visibilityChanged.subscribe(
                this,
                this._setActiveState,
              );
            }),
            (t.prototype.componentWillUnmount = function () {
              this.props.studyMarket.visibilityChanged.unsubscribe(
                this,
                this._setActiveState,
              );
            }),
            ...
            return (
              ...
              (n._handleClickAdd = function () {
                ...
                s ===
                  ...
                  Math.max(
                    1,
                    Math.min(e, Object(G.getMaxResolutionValue)(t)),
                  )) &&
                  n.props.onAdd(
                    isNaN(parseInt(a)) ? String(s) + a : String(s * Number(a)),
                  );
              }),
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return d.createElement(
                ...
                d.createElement(
                  'div',
                  { className: Z.add, onClick: this._handleClickAdd },
                  $.add,
                ),
                d.createElement(
                  X.a,
        ...
        ((le = {})[(re = n('LxhU')).ResolutionKind.Seconds] = window.t(
          'Second',
          { context: 'interval_group_name' },
        )),
        (le[re.ResolutionKind.Minutes] = window.t('Minute', {
          context: 'interval_group_name',
        })),
        (le[re.ResolutionKind.Hours] = window.t('Hour', {
          context: 'interval_group_name',
        })),
        (le[re.ResolutionKind.Days] = window.t('Day', {
          context: 'interval_group_name',
        })),
        (le[re.ResolutionKind.Weeks] = window.t('Week', {
          context: 'interval_group_name',
        })),
        (le[re.ResolutionKind.Months] = window.t('Month', {
          context: 'interval_group_name',
        })),
        (le[re.ResolutionKind.Range] = window.t('Range', {
          context: 'interval_group_name',
        })),
            ...
            return (
              (u._renderResolutionsGroup = function (e) {
                ...
                return (
                  (!e.mayOmitSeparator || e.items.length > 1) &&
                    (t.unshift(
                      d.createElement(E.a, { key: 'begin-' + e.name }),
                    ),
              ...
              (u._handleSelectInterval = function (e) {
                void 0 !== e &&
                  ...
                  (Object(G.setLastUsedResolution)(e),
                  Y.linking.interval.setValue(e));
              }),
              (u._handleClickFavorite = function (e) {
                (e = Object(Q.ensureDefined)(e)),
                  u._isIntervalFavorite(e)
                    ? u._handleRemoveFavorite(e)
                    : u._handleAddFavorite(e);
              }),
              ...
              (u._handleAddInterval = function (e) {
                ...
                void 0 !== n &&
                  (u._isIntervalDefault(i) ||
                    t.includes(i) ||
                    n.set(Object(G.sortResolutions)(t.concat([i])))),
              ...
              (r =
                (s = Y.linking.interval.value()) &&
                Object(G.normalizeIntervalString)(s)),
              (l = o.get()),
              (h = void 0 !== a ? a.get() : []),
              (u._defaultsIntervals = i
                .defaultResolutions()
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              ...
              t.getOnChange().subscribe(this, this._handleChangeFavorites),
                ...
                Y.linking.supportedResolutions.subscribe(
            ...
            (t.prototype.componentWillUnmount = function () {
              ...
              t.getOnChange().unsubscribe(this, this._handleChangeFavorites),
                ...
                Y.linking.supportedResolutions.unsubscribe(
                  this._bindedForceUpdate,
                );
            }),
            ...
            (t.prototype.render = function () {
              ...
              return (
                ...
                (void 0 !== u ? n.concat(u) : n)
                  .filter(G.isAvailable)
                  .forEach(function (e) {
                    return (t[e] = !0);
                  }),
                (i = this._createMenuItems(n).concat(
                  this._createIntervalForm(),
                )),
                (o =
                  void 0 !== u
                    ? Object(G.getTranslatedResolutionModel)(u)
                    : null),
                d.createElement(
                  y,
                  { id: c },
            ...
            (t.prototype._getQuicks = function (e) {
              ...
              return this.props.isShownQuicks &&
                ...
                ? (void 0 === e ? this.state.favorites : e).filter(function (
                    e,
                  ) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return d.createElement(
                'div',
                {
                  className: C(t, ot.item, 'apply-common-tooltip'),
                  onClick: this._handleClick,
                  title: n.name,
                },
                d.createElement(
        ...
        (lt = {
          ...
          tooltip: window.t('Indicator Templates'),
        }),
        (ct = (function (e) {
          function t(t, n) {
            var i,
            ...
            return (
              (r._handleFavorTemplate = function (e) {
                if (r.props.isShownQuicks) {
                  var t = e.name;
                  r._isTemplateFavorite(t)
                    ? r._removeFavoriteTemplate(t)
                    : r._addFavoriteTemplate(t);
                }
              }),
              ...
              (r._handleApplyTemplate = function (e) {
                r._handleClose(),
                  r.context.studyTemplates.applyTemplate(e.name);
              }),
              (r._handleRemoveTemplate = function (e) {
                r._handleClose(),
                  r.context.studyTemplates.deleteStudyTemplate(e.name);
              }),
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              if (this.props.isFake)
                this.props.stateSyncEmitter.on('change', this._syncStateChange);
              else {
                var e = this.context,
                ...
                n.getOnChange().subscribe(this, this._handleTemplatesChange),
                  ...
                  void 0 !== t &&
                    t
                      .getOnChange()
                      .subscribe(this, this._handleFavoritesChange);
              }
            }),
            (t.prototype.componentWillUnmount = function () {
              if (this.props.isFake)
                this.props.stateSyncEmitter.off(
                  'change',
                  this._syncStateChange,
                );
              else {
                var e = this.context,
                  t = e.favoriteStudyTemplatesService;
            ...
            (t.prototype._addFavoriteTemplate = function (e) {
              var t,
                n = this.context.favoriteStudyTemplatesService;
              void 0 !== n &&
                ((t = this.state.favorites), n.set(t.concat([e])));
            }),
            ...
            (t.contextTypes = {
              ...
              studyTemplates: u.any.isRequired,
            }),
            t
          );
        })(d.PureComponent)),
            ...
            return (
              (i._handleClickUndo = function () {
                Object(ht.trackEvent)('GUI', 'Undo'),
                  i.context.chartWidgetCollection.undoHistory.undo();
              }),
              (i._handleClickRedo = function () {
                Object(ht.trackEvent)('GUI', 'Redo'),
                  i.context.chartWidgetCollection.undoHistory.redo();
              }),
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              ...
              i
                ...
                : ((e = Object(Q.ensureNotNull)(this._ref)),
                  St.findDOMNode(e).appendChild(n));
            }),
            (t.prototype.componentWillUnmount = function () {
              var e = this.props,
                t = e.width;
