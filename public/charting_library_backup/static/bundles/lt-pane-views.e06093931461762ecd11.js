(window.webpackJsonp = window.webpackJsonp || []).push([
  ['lt-pane-views'],
  {
          ...
          return (
            ...
            (e.prototype.hitTest = function (e) {
              ...
              return null === this._data || this._data.points.length < 2
                ...
                : ((i = (t = this._data.points)[0]),
                  (a = t[1]),
                  Object(r.distanceToSegment)(i, a, e).distance <= 3
                    ? new n.HitTestResult(n.HitTestResult.MOVEPOINT)
                    : 3 !== this._data.points.length
                    ? null
                    : ((o = this._data.points[2]),
                      Object(r.distanceToSegment)(a, o, e).distance <= 3
                        ? new n.HitTestResult(n.HitTestResult.MOVEPOINT)
                        : Object(r.distanceToSegment)(o, i, e).distance <= 3
                        ? new n.HitTestResult(n.HitTestResult.MOVEPOINT)
                        : this._data.fillBackground &&
                          Object(s.pointInTriangle)(i, a, o, e)
                        ? new n.HitTestResult(
          ...
          return (
            ...
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((a = (s = this._source.properties()).extendTop.value()),
                (o = s.extendBottom.value()),
                (l = this._points[0]),
                (p = this._points[1]),
                (f = a ? 0 : Math.min(l.y, p.y)),
                (g = o ? e : Math.max(l.y, p.y)),
                s.fillBackground &&
                  s.fillBackground.value() &&
                  (((v = {}).points = [new r(l.x, f), new r(p.x, g)]),
                  (v.color = 'white'),
                  (v.linewidth = 0),
                ...
                (y = function (e, t, i) {
                  ...
                  (r.points = [t, i]),
                    ...
                    e.setData(r),
                    n.append(e);
                })(this._leftBorderRenderer, new r(l.x, f), new r(l.x, g)),
                y(this._rightBorderRenderer, new r(p.x, f), new r(p.x, g)),
                (m = (l.y + p.y) / 2),
                (x = new r(l.x, m)),
                (b = new r(p.x, m)),
                ((v = {}).points = [x, b]),
                ...
                (v.linestyle = CanvasEx.LINESTYLE_DASHED),
                (v.extendleft = !1),
                (v.extendright = !1),
                (v.leftend = c.Normal),
                (v.rightend = c.Arrow),
                this._distancePriceRenderer.setData(v),
                n.append(this._distancePriceRenderer),
                (R = this._source.points()[0].index),
                (T = (S = this._source.points()[1].index) - R),
                (P = this._model.timeScale().indexToUserTime(R)),
                (L = this._model.timeScale().indexToUserTime(S)),
                (C = ''),
                P &&
                  L &&
                  ((B = (L.valueOf() - P.valueOf()) / 1e3),
                  (C = ', ' + u(new d().format(B)))),
                (k = $.t('{0} bars').format(_(T)) + C),
                (O = 0),
                (I = 10),
                ((v = {}).text = k),
                ...
                s.fillLabelBackground &&
                  ...
                  (v.backgroundTransparency =
                    1 - s.labelBackgroundTransparency.value() / 100 || 0)),
                s.drawBorder &&
                  s.drawBorder.value() &&
                ...
                (E = this._textRenderer.measure()),
                (V = {
                  x:
                    M +
                    v.backgroundHorzInflate +
                    E.textBgPadding -
                    E.width / E.textBgPadding,
                  y:
                    l.y > p.y
                      ? D.y - E.height - 2 * E.textBgPadding - I > 0
                        ? A - E.height - I - 2 * E.textBgPadding
                        : I - 2 * E.textBgPadding
                      : D.y + E.height + E.textBgPadding + I > v.height
                      ? v.height - E.height - I
                      : A + E.textBgPadding,
                }),
                this._textRenderer.setPoints([new r(M, V.y)]),
      ...
      (n.prototype.setData = function (e) {
        ...
        (r.prototype.renderer = function () {
          ...
          if (
            ...
            if (
              ((t = new p()).append(this._marksRenderer), this._anchorsOffset)
            ) {
              for (i = [], n = 0; n < e.points.length; n++)
                i.push(e.points[n].clone().add(this._anchorsOffset));
              t.append(new c({ points: i }));
            } else t.append(new c({ points: e.points }));
            return t;
          }
          ...
          if (
            ...
            for (
              e = this._source.points()[0],
                ...
                i = this._source.points()[2],
                n = !1,
                (r = this._source.properties()).reverse &&
                  r.reverse.value() &&
                  (n = r.reverse.value()),
                this._levels = [],
              ...
              (d = r['level' + h]).visible.value() &&
                ((c = d.coeff.value()),
                (p = d.color.value()),
                (_ = i.price + c * a),
                (u = this._source.priceScale().priceToCoordinate(_, o)),
                this._levels.push({
                  color: p,
                  y: u,
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            i &&
              ...
              this._p3 &&
                (o.push(this._p3.add(this._p4).scaled(0.5)),
                (o[o.length - 1].data = o.length - 1)),
              (l = 3 === this._points.length && !this._p3),
              this._model.lineBeingCreated() !== this._source || l || o.pop(),
            ...
            (H = this._targetFontSize1 + 4),
              ...
              'up' === this._data.direction
                ...
                : (b(
                  ...
                  e.fill(),
                  (e.fillStyle = N),
                  e.fillText(E, T.x + F + j, T.y + this._targetHeight + 5),
                  e.drawImage(
                    z,
                    T.x + F - z.width - 4,
    ...
    BSCN: function (e, t, i) {
      'use strict';
      function n(e, t) {
        r.call(this, e, t), (this._lineRenderer = new a());
      }
      i('aO4+').Point;
      var r = i('aB9a').LineSourcePaneView,
        s = (i('MMac').PaneRendererClockIcon, i('Zy3/').CompositeRenderer),
      ...
      inherit(n, r),
        (n.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            (r = new s()).append(this._lineRenderer),
            i && this.addAnchors(r),
            r
          );
        }),
      ...
      (n.prototype.update = function (e) {
        ...
        (r.prototype.drawTooltipOn = function (e) {
          ...
          for (
            e.save(),
              ...
              n = c.prototype.wordWrap(t, i, e.font),
              r = this._data.point,
        ...
        (s.prototype.renderer = function (e, t, i) {
          ...
          return (
            ...
            (n = new u()),
            (s =
              (r = this._source.properties()).locked && r.locked.value()
                ? this._source.fixedPoints()
                : this._points).length < 1
              ? n
              : ((a = this.isLabelVisible()),
                (o = $.extend(r.state(), {
                  point: s[0],
                  width: 24,
                  height: 32,
    ...
    'Ht/7': function (e, t, i) {
      ...
      inherit(n, p),
        (n.prototype.renderer = function (e, t, i) {
          var n, s, p, v, w, y, m, x, b, R, S, T, P, L, C, B, k, O, I, M, A, D;
          ...
          for (
            y = 1,
              ...
              b = [],
              R = 0,
              this._model.lineBeingCreated() === this._source && (R = 1),
              S =
              ...
              T = p.color.value(),
              v = 0;
            v < this._points.length - R;
            v++, y = -y
          )
            v < n ||
              ((L = (P = this._source.label(v)).label),
              'circle' === P.decoration &&
                ((C = this._points[v].clone()),
                1 === y
                  ? (C.y += 13 + P.fontIncrease / 2)
                  : (C.y -= 14 + P.fontIncrease / 2),
                (B = (12 + P.fontIncrease) / 2 + 2),
                (k = {
                  points: [
                    (m = C.subtract(new r(B, B))),
                    (x = C.add(new r(B, B))),
                  ],
                  color: l(o(a(T), 'black' === S ? 15 : -15)),
                  linewidth: 1,
                  fillBackground: !1,
                }),
                (O = new d(k)),
                s.append(O)),
              'brackets' === P.decoration && (L = '(' + L + ')'),
              (I = {
                points: [this._points[v]],
                text: L,
                color: l(o(a(T), 'black' === S ? 15 : -15)),
                vertAlign: 1 === y ? 'top' : 'bottom',
                horzAlign: 'center',
                font: 'Arial',
                offsetX: 0,
                offsetY: 1 === y ? 5 : -10,
              ...
              b.push(I),
              '' !== P && s.append(new c(I, new u(u.CHANGEPOINT, v))));
          if (i) {
            for (M = [], A = 0; A < b.length; A++)
              ((D = this._points[A].clone()).y = b[A].points[0].y),
                (D.data = A),
                M.push(D);
            this._model.lineBeingCreated() === this._source && M.pop(),
              s.append(this.createLineAnchor({ points: M }));
          }
          return s;
        }),
        (n.prototype._updateImpl = function () {
          ...
          return (
            ...
            i && 1 === n.points.length
              ? ((r = new p()).append(this._renderer),
                r.append(new d({ points: n.points })),
                r)
              : this._renderer
          );
        }),
      ...
      (n.prototype.setData = function (e) {
        ...
        (n.prototype.hitTest = function (e) {
          ...
          if (
            ...
            var t = this._adapter._onMoveCallback ? o.MOVEPOINT : o.REGULAR;
    ...
    MMac: function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        s = i('toUb').PaneRendererUnicodeChar;
      inherit(n, s),
        ...
        (n.prototype._updateImpl = function () {
          ...
          if (
            ...
            !(this._source.points().length < 2) &&
              ...
              (t = this._source.points()[1]),
              (i = !1),
              (n = this._source.properties()).reverse &&
                n.reverse.value() &&
                (i = n.reverse.value()),
              (this._levels = []),
              (r = i ? t.price - e.price : e.price - t.price),
              (s = i ? e.price : t.price),
              null != (o = this._source.ownerSource().firstValue())))
          )
            for (l = this._source.levelsCount(), h = 1; h <= l; h++)
              (d = n['level' + h]).visible.value() &&
                ((c = d.coeff.value()),
                (p = d.color.value()),
                (_ = s + c * r),
                (u = this._source.priceScale().priceToCoordinate(_, o)),
            ...
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((s = this._source.properties()).fillBackground &&
                ...
                (l = function (e, t, i) {
                  var r = {};
                  (r.points = [t, i]),
                    (r.width = o._model.timeScale().width()),
                    (r.height = o._source.priceScale().height()),
                    (r.color = o._source.properties().linecolor.value()),
                    (r.linewidth = o._source.properties().linewidth.value()),
                    (r.linestyle = CanvasEx.LINESTYLE_SOLID),
                    (r.extendleft = !1),
                    (r.extendright = !1),
                    (r.leftend = _.Normal),
                ...
                (d = this._points[0]),
                (u = this._points[1]),
                l(this._topBorderRenderer, d, new r(u.x, d.y)),
                l(this._bottomBorderRenderer, new r(d.x, u.y), u),
                l(this._leftBorderRenderer, d, new r(d.x, u.y)),
                l(this._rightBorderRenderer, new r(u.x, d.y), u),
                (v = (d.y + u.y) / 2),
                (w = new r(d.x, v)),
                (y = new r(u.x, v)),
                ((a = {}).points = [w, y]),
                (a.width = o._model.timeScale().width()),
                (a.height = o._source.priceScale().height()),
                (a.color = o._source.properties().linecolor.value()),
                (a.linewidth = o._source.properties().linewidth.value()),
                (a.linestyle = CanvasEx.LINESTYLE_DASHED),
                (a.extendleft = !1),
                (a.extendright = !1),
                (a.leftend = _.Normal),
                (a.rightend = _.Arrow),
                ...
                n.append(this._distancePriceRenderer),
                (x = this._source.points()[0].price),
                (S =
                  (100 * (R = (b = this._source.points()[1].price) - x)) / x),
                (T = this._source.points()[0].index),
                ...
                (M =
                  ...
                  ' (' +
                  this._percentageFormatter.format(Math.round(100 * S) / 100) +
                  ') ' +
                  (this._pipFormatter ? this._pipFormatter.format(R) : '')),
                (A = f(M) + '\n' + $.t('{0} bars').format(L) + k),
                (a = {}),
                b > x
                  ? (((D = u.clone()).y -= 2 * s.fontsize.value()),
                    (D.x = 0.5 * (d.x + u.x)),
                    (a.points = [D]))
                  : (((D = u.clone()).x = 0.5 * (d.x + u.x)),
                ...
                (F = {
                  x:
                    N +
                    a.backgroundHorzInflate +
                    W.textBgPadding -
                    W.width / W.textBgPadding,
                  y:
                    d.y > u.y
                      ? H.y - W.height - 2 * W.textBgPadding - V > 0
                        ? z - W.height - V + W.textBgPadding
                        : V - 2 * W.textBgPadding
                      : H.y + W.height + W.textBgPadding + V > a.height
                      ? a.height - W.height - V
                      : z + W.textBgPadding,
                }),
                this._textRenderer.setPoints([new r(N, F.y)]),
                n.append(this._textRenderer),
                i && this.addAnchors(n),
                n)
          );
          ...
          return (
            ...
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((a = (s = this._source.properties()).extendLeft.value()),
                (o = s.extendRight.value()),
                (t = this._model.timeScale().width()),
                (l = this._points[0]),
                (d = this._points[1]),
                (u = a ? 0 : Math.min(l.x, d.x)),
                (f = o ? t : Math.max(l.x, d.x)),
                s.fillBackground &&
                  s.fillBackground.value() &&
                  (((g = {}).points = [new r(u, l.y), new r(f, d.y)]),
                  (g.color = 'white'),
                  (g.linewidth = 0),
                  (g.backcolor = s.backgroundColor.value()),
                  (g.fillBackground = !0),
                  (g.transparency = s.backgroundTransparency.value()),
                  this._backgroundRenderer.setData(g),
                  n.append(this._backgroundRenderer)),
                (v = this),
                (w = function (e, t, i) {
                  var r = {};
                  (r.points = [t, i]),
                    (r.width = v._model.timeScale().width()),
                    (r.height = v._source.priceScale().height()),
                    (r.color = v._source.properties().linecolor.value()),
                    (r.linewidth = v._source.properties().linewidth.value()),
                    (r.linestyle = CanvasEx.LINESTYLE_SOLID),
                    (r.extendleft = !1),
                    (r.extendright = !1),
                    (r.leftend = p.Normal),
                    ...
                    e.setData(r),
                    n.append(e);
                })(this._topBorderRenderer, new r(u, l.y), new r(f, l.y)),
                w(this._bottomBorderRenderer, new r(u, d.y), new r(f, d.y)),
                (l = this._points[0]),
                (d = this._points[1]),
                (y = (l.x + d.x) / 2),
                (m = new r(y, l.y)),
                (x = new r(y, d.y)),
                ((g = {}).points = [m, x]),
                (g.width = v._model.timeScale().width()),
                (g.height = v._source.priceScale().height()),
                (g.color = v._source.properties().linecolor.value()),
                (g.linewidth = v._source.properties().linewidth.value()),
                (g.linestyle = CanvasEx.LINESTYLE_DASHED),
                (g.extendleft = !1),
                (g.extendright = !1),
                (g.leftend = p.Normal),
                (g.rightend = p.Arrow),
                this._distanceRenderer.setData(g),
                ...
                (g = {}),
                R > b
                  ? (((C = d.clone()).y -= 2 * s.fontsize.value()),
                    (C.x = 0.5 * (l.x + d.x)),
                    (g.points = [C]))
                  : (((C = d.clone()).x = 0.5 * (l.x + d.x)),
                    (C.y += 0.7 * s.fontsize.value()),
                    (g.points = [C])),
                (B = 0),
                (k = 10),
                (g.text = L),
                (g.color = s.textcolor.value()),
                (g.height = v._source.priceScale().height()),
                (g.font = s.font.value()),
                (g.offsetX = B),
                (g.offsetY = k),
                (g.vertAlign = 'middle'),
                (g.horzAlign = 'center'),
                (g.fontsize = s.fontsize.value()),
                (g.backgroundRoundRect = 4),
                (g.backgroundHorzInflate = 0.4 * s.fontsize.value()),
                (g.backgroundVertInflate = 0.2 * s.fontsize.value()),
                s.fillLabelBackground &&
                  s.fillLabelBackground.value() &&
                  ((g.backgroundColor = s.labelBackgroundColor.value()),
                  (g.backgroundTransparency =
                    1 - s.labelBackgroundTransparency.value() / 100 || 0)),
                s.drawBorder &&
                  s.drawBorder.value() &&
                  (g.borderColor = s.borderColor.value()),
                (O = 0.5 * (l.x + d.x)),
                (I = d.y),
                (M = new r(O, I)),
                this._labelRenderer.setData(g),
                (A = this._labelRenderer.measure()),
                (D = {
                  x:
                    O +
                    g.backgroundHorzInflate +
                    A.textBgPadding -
                    A.width / A.textBgPadding,
                  y:
                    l.y > d.y
                      ? M.y - A.height - 2 * A.textBgPadding - k > 0
                        ? I - A.height - k - 2 * A.textBgPadding
                        : k - 2 * A.textBgPadding
                      : M.y + A.height + A.textBgPadding + k > g.height
                      ? g.height - A.height - k
                      : I + A.textBgPadding,
                }),
                this._labelRenderer.setPoints([new r(O, D.y)]),
                n.append(this._labelRenderer),
                i && this.addAnchors(n),
                n)
          );
    ...
    XHET: function (e, t, i) {
      ...
      var s = i('aO4+').Point,
        ...
        g = (i('MMac').PaneRendererClockIcon, i('Ialn').forceLTRStr);
      (n.prototype.setData = function (e) {
        this._data = e;
      }),
          ...
          return (
            ...
            this._secondPoint &&
              ...
              s &&
                ...
                (this._points[1].y > this._points[0].y &&
                  this._points[1].x > this._points[0].x)
                  ? ((c.vertAlign = 'bottom'), (c.offsetY = -_))
                  : (c.offsetY = _),
                n.append(new o(c, this._rendererCache))),
              a &&
                this._middlePoint &&
                n.append(new p({ points: [this._middlePoint] })),
              ...
              (w = Math.round((180 * v.angle) / Math.PI) + 'º'),
              ...
              this._angleLabelRenderer.setData(y),
        ...
        (n.prototype.renderer = function (e, t, i) {
          ...
          for (
            ...
            (s = {
              ...
              (c = new a()).setData(s),
              c.setHitTest(new o(o.MOVEPOINT, null)),
              n.append(c);
          for (
            _ = (p = this._source.properties()).candleStyle.drawWick.value(),
              u = p.candleStyle.drawBorder.value(),
              f = p.candleStyle.borderColor.value(),
              g = p.candleStyle.wickColor.value(),
              (v = new h()).setGlobalAlpha(1 - p.transparency.value() / 100),
              r = 0;
            ...
            (w = {
              ...
              v.append(new l(w));
          return n.append(v), i && this.addAnchors(n), n;
        }),
    ...
    mr3a: function (e, t, i) {
      ...
      inherit(n, s),
        ...
        (n.prototype.renderer = function (e, t, i) {
          var n, s, l, c, p, _, u, f, g, v, w, y, m, x, b, R;
          return (
            this._invalidated && this._updateImpl(),
            !(n = this._source.priceScale()) || n.isEmpty()
              ...
              : ((s = {}),
                (c =
                  (l = this._source.properties()).locked && l.locked.value()),
                (s.points = c ? this._source.fixedPoints() : this._points),
                (s.text = l.text.value()),
                ...
                c ||
                  ...
                  (p = n.height() / n.priceRange().length()),
                  this._source._isPriceDencityLog &&
                    !n.isLog() &&
                    ((_ = n.priceRange().minValue()),
                    (u = n.priceRange().maxValue()),
                    (_ = d(_)),
                    (f = (u = d(u)) - _),
                    (p = n.height() / f)),
                  !this._source._isPriceDencityLog &&
                    ...
                    (f = u - _),
                    (p = n.height() / f)),
                  (s.scaleY = p / this._source._priceDencity),
                  (!isFinite(s.scaleY) || s.scaleY <= 0) && delete s.scaleY),
                this._renderer.setData(s),
                this.isAnchorsRequired() &&
                1 === s.points.length &&
                !this._noSelection
                  ? ((g = new a()).append(this._renderer),
                    (v = s.points[0].clone()),
                    (w = s.wordWrapWidth || this._renderer.measure().width),
                    (y = s.lines ? s.lines.length * s.fontsize : 0),
                    (m = ~~(s.fontsize / 6)),
                    (x = s.wordWrapWidth ? m : 0),
                    (v.x -= m),
                    s.wordWrapWidth &&
                      (((b = new r(v.x + w + 2 * x, v.y + y / 2 + m)).data = 0),
                      g.append(this.createLineAnchor({ points: [b] }))),
                    ((R = new r(v.x + w / 2 + x, v.y + y + 2 * m)).data = 0),
                    g.append(new o({ points: [R] })),
                    g)
                  : this._renderer)
          );
        }),
            ...
            this._labelDataInvalidated &&
              ...
              (n = this._source.properties()).showPriceRange.value() &&
                ...
                (a =
                  ...
                  ')'),
                (f = this._model.mainSeries().symbolInfo()) &&
                ...
                (a += this._pipFormatter
                  ...
                  : ''),
                s.push('priceRange')),
              (w = n.showBarsRange.value()),
              (y = n.showDateTimeRange.value()),
              (m = n.showDistance.value()),
              (w || y || m) &&
                ((o = ''),
                w &&
                  ((p = i.index - t.index),
                  (o += $.t('{0} bars').format(g(p)))),
                y &&
                  ((x = this._model.timeScale().indexToUserTime(t.index)),
                  (b = this._model.timeScale().indexToUserTime(i.index)),
                  x &&
                    b &&
                    ((R = (b.valueOf() - x.valueOf()) / 1e3),
                    (S = v(new d().format(R))) &&
                      (o += w ? ' (' + S + ')' : S))),
                m &&
                  (o && (o += ', '),
                  ...
                  (T = Math.round(1e5 * Math.sqrt(h * h + p * p)) / 1e5),
                  (o += $.t('distance: {0}').format(
                    g(this._numericFormatter.format(T)),
                  ))),
                o && s.push('barsRange')),
              n.showAngle.value() &&
                ((P = this._source.pointToScreenPoint(t)),
                (L = this._source.pointToScreenPoint(i)),
                (P = P instanceof Array ? P[0] : P instanceof r ? P : null),
                (L = L instanceof Array ? L[0] : L instanceof r ? L : null),
                P instanceof r &&
                  L instanceof r &&
                  (B = L.subtract(P)).length() > 0 &&
                  ((B = B.normalized()),
                  (C = Math.acos(B.x)),
                  B.y > 0 && (C = -C)),
                'number' != typeof C ||
            ...
            this._points.length < 2 || this._source.points().length < 2
              ...
              : ((s = this),
                ...
                (S = function (e, t, i, r, o, l, h) {
                  if (s.isLabelVisible() || TradingView.printing) {
                    var d = {};
                    (d.points = [t]),
                      (d.text = i),
                ...
                (W = this._percentageFormatter.format(B)),
                (A = a.compact.value()
                  ? H + ' (' + W + ') ' + a.amountStop.value()
                ...
                (W = this._percentageFormatter.format(O)),
                (A = a.compact.value()
                  ? H + ' (' + W + ') ' + a.amountTarget.value()
                ...
                i &&
                  (((F = this._points[0].clone()).data = 0),
                  ((j = new r(o, this._stopLevel)).data = 1),
                  ((Y = new r(o, this._profitLevel)).data = 2),
                  ((q = new r(c, F.y)).data = 3),
                  n.append(this.createLineAnchor({ points: [F, j, Y, q] }))),
                n)
          );
        }),
