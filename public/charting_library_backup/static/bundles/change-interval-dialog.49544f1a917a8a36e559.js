(window.webpackJsonp = window.webpackJsonp || []).push([
  ['change-interval-dialog'],
  {
    MuC6: function (t, e, i) {
      ...
      var s = i('PT1i').linking,
        r = i('h24c').parseIntervalValue,
        a = i('h24c').intervalIsSupported,
        p = i('h24c').sanitizeIntervalValue,
        h = i('Kxc7'),
        l = i('pPtI'),
      ...
      (n.prototype._setInput = function () {
        ...
        (n.prototype._validate = function () {
          ...
          (this._parsed = r(e)),
            ...
            (this._supported = !this._parsed.error && a(e)),
            (t = this._parsed.unit),
            this._supported &&
              ('R' === t && this._parsed.qty > l.getMaxResolutionValue('R')
                ? (this._supported = !1)
                : null === t || 'H' === t
                ? this._parsed.qty * ('H' === t ? 60 : 1) > 1440 &&
                  (this._supported = !1)
                : 'S' !== t ||
                  _.includes(this._parsed.qty) ||
                  (this._supported = !1));
        }),
        (n.prototype._updateCaption = function () {
          var t, e, i;
          this._valid && this._supported
            ? ((e = this._parsed.qty || 1),
              (i = this._parsed.unit || ''),
              (t = l.getTranslatedResolutionModel(e + i).hint),
        ...
        (n.prototype._handleInput = function (t) {
          ...
          13 !== t.which
            ? t.ctrlKey ||
              ...
              (i = /[\dhdwms]/i),
              (n = /[\dhdwm]/i),
              (o() ? i.test(e) : n.test(e)) || t.preventDefault())
            : this._submit();
        }),
        (n.prototype._submit = function () {
          var t, e;
          d.isOpen(this._dialogTitle) &&
            (this._valid &&
              this._supported &&
              ((t = p(this._input.val())),
              (e = s.interval.value()),
        ...
        (n.prototype.show = function (t) {
          var e = d.createDialog(this._dialogTitle, {
              hideCloseCross: !0,
        ...
        (t.exports.ChangeIntervalDialog = n);
    },
    jAh7: function (t, e, i) {
      'use strict';
      function n(t) {
        ...
        return (
          ...
          null !== (e = t.getElementById('overlap-manager-root'))
            ? Object(o.ensureDefined)(a.get(e))
            : ((i = new r(t)),
              (n = (function (t) {
