      ...
      (function (o) {
        ...
        for (
          Object.defineProperty(e, '__esModule', { value: !0 }),
            r = i('4O8T'),
            a = (f = r) && f.__esModule ? f : { default: f },
            h = i('BI5g'),
            l = $('body'),
            c = $(window),
            d = 0,
            ...
            o.extend(p, a.default.prototype),
            n(),
            $(n),
            c.on('resize', n),
            _ = function (t) {
        ...
        return t in $.fn
          ...
          : (r ||
              (r = new Promise(function (t) {
                Promise.all([i.e(76), i.e('lazy-jquery-ui')])
                  .then(
                    function (e) {
                      i('ONnG'), t();
                    }.bind(null, i),
    ...
    QwKQ: function (t, e, i) {
      ...
      (function (o) {
        ...
        Object.defineProperty(e, '__esModule', { value: !0 }),
          ...
          (s = i('29gu')),
          i('b6p+'),
          (r = i('uOxu').getLogger('Ui.TvControlCheckbox')),
          (a = {
            labelWrapper:
          ...
          (l = (function () {
            function t(e) {
              ...
              if (
                ...
                this._setInputId(s, l),
                  this._setInputClass(s, n),
                  this._setInputName(s, c),
            ...
            return (
              n(t, [
                ...
                },
                {
                  key: '_setInputClass',
                  value: function (t, e) {
                    var i = o.render(a.checkboxClass, { customClass: e });
                    t.addClass(i);
                  },
                },
                {
          ...
          ($.fn.tvControlCheckbox = (0, s.createTvBlockWithInstance)(
            'tv-control-checkbox',
            function (t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              return new l(TradingView.mergeObj(e, { $checkbox: t }));
            },
          )),
          (e.default = l),
          (t.exports = e.default);
      ...
      (function (t) {
        function o(e, i, o) {
          ...
          if (
            ...
            (this._$wrapper = e),
            this._$wrapper.addClass(n.wrapper),
            (this._$content = i),
          ...
          this._$wrapper.css('overflow', 'hidden'),
            this._$wrapper
              .on('mouseenter.sidebar-scroll', function () {
                a._bottomFixed ||
                  a._dragging ||
                  (a._options.alwaysVisible || a._$scrollBar.addClass('active'),
                  a._onScroll());
              })
              .on('mouseleave.sidebar-scroll', function () {
                a._bottomFixed ||
                  a._dragging ||
                  (a._options.alwaysVisible ||
                    a._$scrollBar.removeClass('active'),
                  a._onScroll());
              })
            ...
            (s = this._options.additionalClass
            ...
            (this._$scrollBar = $(
              '<div class="sb-scrollbar sb-scrollbar-body' + s + r + '"></div>',
            ).appendTo(this._$scrollBarWrapper)),
            this._onScroll();
        }
        var n,
          s = i('5qpw').lazyJqueryUI;
        i('nzny'),
          (n = i('pLUm')),
          ...
          (o.prototype.updateScroll = function () {
            ...
            return this._touch
              ...
              : ((t = 1),
                ...
                (n = (o = this._$content.outerHeight()) - i - t),
                i <= 0
                  ? this
