      ...
      function a() {
        Object(ne.saveDefaultProperties)(!0),
          v
            .properties()
            .childs()
            .magnet.setValue(!v.properties().childs().magnet.value()),
      ...
      function l() {
        Object(ye.trackEvent)('GUI', 'Magnet mode', 'Strong'),
          ...
          v
            .properties()
            .childs()
            .magnetMode.setValue(we.MagnetMode.StrongMagnet),
          v.properties().childs().magnet.setValue(!0),
          Object(ne.saveDefaultProperties)(!1);
      }
      var c,
      ...
      o.r(t),
          ...
          },
          {
            ...
            items: [
              ...
              { name: 'LineToolHorzRay' },
              {
                ...
                shortcut: { keys: 'Alt+V', immediately: !0 },
              },
              {
                name: 'LineToolCrossLine',
                shortcut: { keys: 'Alt+C', immediately: !0 },
              },
              { name: 'LineToolArrow' },
              { name: 'LineToolRay' },
            ...
            return (
              ...
              (o._checkButtonsVisibility = function () {
                ...
                (o.props.isVisibleButtons || o.props.isVisibleFade) &&
                  ...
                  r || n
                    ? r && n && o.setState({ isVisibleBotButton: !1 })
                  ...
                  !h &&
                    ...
                    u.createElement(
                      'div',
                      {
                        className: m(
                          Y.arrow,
                          c && 'apply-common-tooltip common-tooltip-vertical',
                        ),
                        title: c,
          ...
          function t(t) {
            ...
            return (
              ...
              (o._handleSelect = function (e) {
                var t, n;
                Object(K.saveDefaults)(
                  'linetoolicon',
                  c.__assign({}, Object(K.defaults)('linetoolicon'), {
                    icon: e,
                  }),
                ),
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              v.tool.subscribe(this._onChangeDrawingState),
                f.onSync.subscribe(this, this._onSyncSettings);
            }),
            (t.prototype.componentWillUnmount = function () {
              v.tool.unsubscribe(this._onChangeDrawingState),
                f.onSync.unsubscribe(this, this._onSyncSettings);
            }),
            (t.prototype.render = function () {
              var e = this,
                t = this.props,
              ...
              return u.createElement(
                ...
                u.createElement(
                  'div',
                  { key: 'all', className: $.wrap },
                  q.availableIcons.map(this._renderItem),
                ),
              );
            }),
        ...
        (de = (function (e) {
          ...
          return (
            ...
            (t.prototype.componentDidUpdate = function (e) {
              (this.props.keys === e.keys &&
                this.props.handler === e.handler) ||
                (ue.unbind(e.keys),
                ue.bind(this.props.keys, this.props.handler));
            }),
            (t.prototype.componentWillUnmount = function () {
        ...
        (be = (function (e) {
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              var e = this,
                t = (this._promise = Object(p.ensureNotNull)(
                  Object(fe.getFavoriteDrawingToolbarPromise)(),
                ));
              t.then(function (o) {
                e._promise === t &&
                  ((e._instance = o),
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              S.isDrawingToolbarVisible.subscribe(this._handleChangeVisibility),
                ...
                v
                  .properties()
                  .childs()
                  .magnet.subscribe(this, this._updateMagnetEnabled),
                v
                  .properties()
                  .childs()
                  .magnetMode.subscribe(this, this._updateMagnetMode);
            }),
            (t.prototype.componentWillUnmount = function () {
              S.isDrawingToolbarVisible.unsubscribe(
                ...
                v
                  .properties()
                  .childs()
                  .magnet.unsubscribe(this, this._updateMagnetEnabled),
                v
                  .properties()
                  .childs()
                  .magnetMode.unsubscribe(this, this._updateMagnetMode);
            }),
            (t.prototype.componentDidUpdate = function (e, t) {
            ...
            (t.prototype._negotiateResizer = function () {
              this.props.resizerBridge.negotiateWidth(
                this.state.isVisible ? Te.b : Te.a,
              );
            }),
            ...
            (t.childContextTypes = {
              chartWidgetCollection: h.any.isRequired,
              customCloseDelegate: h.any.isRequired,
            }),
            t
          );
        })(u.PureComponent)),
          ...
          function e(e, t) {
            ...
            (this._component = null),
              ...
              d.render(
                u.createElement(
                  De,
                  c.__assign({}, t, { ref: this._handleRef }),
                ),
                this._container,
              );
          }
            ...
            return (
              ...
              (t._handleMouseUp = function (e) {
                ...
                1 === e.button &&
                  n &&
                  i &&
                  Object(c.trackEvent)(i.category, i.event, i.label);
              }),
            ...
            (t.prototype.render = function () {
              ...
              return a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement('div', { className: k.label }, b),
                ),
                (void 0 !== c || p) &&
                  a.createElement(
                    'div',
    ...
    QpNh: function (e, t, o) {
      ...
      function n(e) {
        var t,
          ...
          l = {};
        for (t = 0, o = s; t < o.length; t++)
          (r = (n = o[t])[0]), (a = n[1]), (l[r] = a);
        return l;
      }
      function i(e) {
        var t = e[0],
