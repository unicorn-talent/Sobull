      ...
      (function (t) {
        ...
        function d(t, e, i, o, n, s, r) {
          L.call(this, t, e, i, o, n),
            ...
            r &&
              (r.subscribe(this, this._updateDisplayedSymbol),
              (this._updateDelegate = r));
        }
            ...
            s &&
              ...
              $(s).each(function () {
                $(this).on('keydown', function (t) {
                  parseInt($(s[0]).val()) < l._transformers[0]
                    ...
                    : parseInt($(s[1]).val()) > l._transformers[1] &&
                      $(s[1]).val(l._transformers[1]),
              ...
              $(s[0]).on('keyup', function (t) {
                parseInt($(this).val()) < l._transformers[0]
                  ...
                  parseInt($(this).val()) > parseInt($(s[1]).val()) &&
                    $(this).val(s[1].val()),
        ...
        i('jgM0'),
          ...
          (P = S.rgbaToString),
          (O = S.parseRgb),
          (I = i('XPit').TimePointIndexSearchMode),
          (D = i('zXvd').NumericFormatter),
          (F = i('T6Of').LimitedPrecisionNumericFormatter),
          (R = i('Tmoa')),
          (A = i('jNEI').addColorPicker),
          (L = i('2h0C').Binding),
          (H = i('uOxu').getLogger('Chart.PropertyPage')),
          (B = i('MWAT').allPriceScaleSelectionStrategyInfo),
          ...
          (n.prototype.addLabeledRow = function (t, e, i, n) {
            ...
            return (
              n && ((n = parseInt(n)), V(n) && (n = 2), l.attr('colspan', n)),
          ...
          inherit(u, c),
          inherit(p, L),
          (p.prototype._forEachSubControl = function (t) {
          ...
          (k.prototype.destroy = function () {
            this._propFrom &&
              ...
              (this._propFrom
                .listeners()
                .unsubscribe(this, L.prototype.propertyChanged),
              this._propTo
                .listeners()
                .unsubscribe(this, L.prototype.propertyChanged));
          }),
                ...
                values: function (e, i) {
                  ...
                  if (!t.isArray(arguments[0]))
                    return this._hasMultipleValues()
                      ...
                      : this.value();
                  for (
                    o = this.options.values, n = arguments[0], s = 0;
                    s < o.length;
                    s += 1
                  )
          ...
          (t = $(t)),
            ...
            (d = function (l, d, v) {
              ...
              if (
                ...
                return l.preventDefault(), p(), void (b = h.scrollTop);
              switch (
                ((p = function () {
                  (h.scrollTop = y.scrollTop()),
                    y.remove(),
                    j.removeWindow(W),
                    ...
                    $(G).off('click', m),
                    $(G).off('mousedown', g),
                    Modernizr.mobiletouch && $(G).off('touchstart.chartgui', g),
                    $(G).off('selectstart.' + f),
                    G.removeEventListener('keydown', _, !1),
                    (p = u),
                    n.onRemove && n.onRemove();
                }),
                t.addClass('active open ' + n.activeClass),
                (y = $('<div class="charts-popup-list">')),
                n.addClass && y.addClass(n.addClass),
                n.zIndex && y.css('z-index', n.zIndex),
                (C = y),
                n.listInner && (C = $('<div class="list-inner">').appendTo(C)),
                n.listTable && (C = $('<div class="list-table">').appendTo(C)),
                $.each(Y, function (e) {
                  !(function e(s, r, a) {
                    var l, c, u, p, h, d, f, v, g, m, _, b, C, T, k;
                    if (s instanceof o.TabGroup) {
                      if (!s.tabs || !s.tabs.length) return;
                      return 1 !== s.tabs.length || s.tabs[0].title
                        ? ((l = $(
                      ...
                      return (
                        ...
                        s.title &&
                          ...
                          s.collapsible &&
                            ...
                            p.toggleClass('collapsed', s.collapsed),
                            h.on('click', function () {
                              p.toggleClass('collapsed'),
                                'function' == typeof s.onChange &&
                                  s.onChange(p.hasClass('collapsed')),
                                y.height() === parseInt(y.css('max-height'))
                                  ? y.addClass('popup-menu-scroll-y')
                                  : y.height() <
                                      parseInt(y.css('max-height')) &&
                                    y.removeClass('popup-menu-scroll-y');
                            })),
                          p.append(h)),
                        void $.each(s.items, function (t) {
                          e(this, 1, p);
                        })
                      );
                    if (s instanceof o.Header)
                      a.append(
                      ...
                      (d = $('<a class="item">')),
                        s.url && d.attr('href', s.url),
                        s.target && d.attr('target', s.target),
                        r || d.addClass('first'),
                        'function' == typeof s.active
                          ? s.active(s) && d.addClass('active')
                          : s.active && d.addClass('active'),
                        s.addClass && d.addClass(s.addClass),
                        s.addData && d.data(s.addData),
                        s.disabled && d.addClass('disabled'),
                        ...
                        s.date
                          ? ((g = $('<span class="title"></span>').appendTo(d)),
                            $('<span class="date"></span>')
                              ...
                              .appendTo(d))
                          : s.icon && !n.svg
                          ? ((m = $('<span class="icon"></span>').appendTo(
                              d,
                            )).css('background-image', s.icon.image || ''),
                            s.icon.offset &&
                              m.css(
                                'background-position',
                        ...
                        s.html
                          ? g.html(s.html)
                          : g.text(TradingView.clean(s.title, !0) || ''),
                        (_ = $('<span class="shortcut"></span>').appendTo(d)),
                        s.shortcut && _.text(s.shortcut.keys),
                        'function' == typeof s.deleteAction &&
                          ((b = s.deleteAction),
                          (C = s.deleteAction.title || $.t('Delete')),
                          (T = $('<span class="icon-delete">')).html(i('uo4K')),
                          T.attr('title', C),
                        ...
                        void 0 !== s.counter &&
                          ('function' == typeof s.counter
                            ? $('<span class="counter"></span>')
                                .html(s.counter())
                                .appendTo(d)
                            : ((k = s.counterBlue ? 'blue' : ''),
                              $('<span class="counter"></span>')
                                .text(s.counter + '')
                                .addClass(k)
                                .appendTo(d))),
                        s.name && d.attr('data-name', s.name),
                        a.append(d),
                        t.data('popup-menu', a);
                    }
                  })(this, e, C);
                ...
                $(G).on('click', m),
                $(G).on('mousedown', g),
                G.addEventListener('keydown', _, !1),
                Modernizr.mobiletouch && $(G).on('touchstart.chartgui', g),
                n.upAction &&
                  $(G).on('selectstart.popup-menu', function () {
                    return !1;
                  }),
                y.appendTo(j.ensureWindow(W)),
                (T = G.documentElement.clientWidth),
                (k = G.documentElement.clientHeight),
                (w = t.outerWidth()),
                (x = t.outerHeight()),
                (M = t.offset()),
                (b = $(U).scrollTop() || 0),
                ...
                (V = y.outerWidth()),
                (S = y.outerHeight()),
                (E = void 0 !== n.viewportSpacing ? n.viewportSpacing : 10),
                (P = n.popupSpacing ? ~~n.popupSpacing : 1),
                (O = n.popupDrift ? ~~n.popupDrift : 0),
                (I = S - y.height()),
                (D = 'down'),
                n.direction &&
                  (D =
                    'function' == typeof n.direction
                      ? n.direction()
                      : n.direction),
                (F = !!n.reverse),
                'down' === D
                  ? ((R = k - M.top - x - P - E - I),
                    (A = M.top - P - E - I),
                    R < Math.max(S || 0, 100) && A > R && (D = 'up'))
                  : 'right' === D &&
                    ((L = T - M.left - w - P - E - I),
                    (H = M.left - P - E - I),
                    L < Math.max(V || 0, 100) && H > L && (D = 'left')),
                D)
              ) {
                case 'down':
                case 'up':
                  'down' === D
                    ? y.css('top', M.top + x + P + 'px')
                    : y.css('bottom', k - M.top + P + 'px').css('top', 'auto'),
                    F
                      ? y
                          .css('left', Math.max(M.left + O + w - V, E) + 'px')
                          .css('right', 'auto')
                      : y.css('left', M.left + O + 'px').css('right', 'auto');
                  break;
                case 'right':
                case 'left':
                  (P = Math.max(P, 4)),
                    'right' === D
                      ? y
                          .css('left', Math.floor(M.left + w + P) + 'px')
                          .css('right', 'auto')
                      : y
                          .css(
                            'left',
                            Math.floor(Math.max(M.left - V - P, E)) + 'px',
                          )
                          .css('right', 'auto'),
                    F
                      ? y.css(
                          'top',
                          Math.floor(Math.max(M.top + O + x - S, E)) + 'px',
                        )
                      : y.css('top', Math.floor(M.top + O) + 'px');
              }
              y.show(),
                (B = M.top),
                'up' === D || ({ left: 1, right: 1 }[D] && F)
                  ? 'up' !== D
                    ? (B += x)
                    : (B -= x + P + I + E)
                  : (B = k - B - x - 2 * P - I),
                y.height() > B && y.addClass('popup-menu-scroll-y'),
                y.css('max-height', B + 'px'),
                n.careRightBorder &&
                  ((z = T + $(U).scrollLeft()),
                  parseInt(y.css('left')) + y.width() + E > z &&
                    y
                      .css('left', z - y.width() - E + 'px')
                      .css('right', 'auto')),
                n.careBottomBorder &&
                  parseInt(y.css('top')) + y.height() + E > k + b &&
                  y.css('top', k - y.height() - E + b + 'px'),
                (N = y.offset()),
                y.css({
                  position: 'fixed',
                ...
                y[0].scrollHeight > y.height() &&
                  y.addClass('popup-with-scroll'),
                l && l.preventDefault();
            }),
            l && t.bind(l, d),
            c &&
        ...
        (function (t) {
          ...
          function o($) {
            ...
            function M(e, i) {
              ...
              return (
                (i = i || {}),
                (n = (o = this).prop('ownerDocument')),
                (r = t(o).val().toLowerCase()),
                (a = n.createElement('table')),
                (l = n.createElement('tbody')),
                a.appendChild(l),
                (u = 0),
                t.each(e, function (e, n) {
                  ...
                  u++,
                    ...
                    n &&
                      ((n = n.toLowerCase()),
                      r && s(v(r), v(n)) && p.addClass('active'),
                      p.css({ backgroundColor: n }).data('color', n),
            ...
            function V(e) {
              function i(t) {
                ...
                V.css({ left: i + 'px', top: o + 'px' }),
                  (z[0] = a(i / A)),
                  (z[1] = l(1 - o / R)),
                  I.css({ backgroundColor: d(h(u(z[0], z[1], 1))) }),
                  b();
              }
              function o(e) {
                1 == e.which &&
                  ((L = !1), U.is('.opened') && t(W).get(0).focus());
              }
              function s(e) {
                var i = (function (e) {
                  var i = e.pageY,
              ...
              function _(e) {
                1 == e.which &&
                  ((H = !1),
                  t(G).unbind('mouseup', _),
                  U.is('.opened') && t(W).get(0).focus());
              }
              function b() {
                var t, e;
                B &&
              ...
              return (
                ...
                (y = t('<div class="tvcolorpicker-custom-area"></div>')
                  .css({ display: 'none' })
                  .appendTo(U)),
                ($ = t('<div class="tvcolorpicker-hsv"></div>').appendTo(y)),
                (x = t('<div class="tvcolorpicker-hs"></div>').appendTo($)),
                ...
                (O = t('<div class="tvcolorpicker-vv">').appendTo($)),
                (I = t('<div class="tvcolorpicker-v"></div>').appendTo(O)),
                (D = t('<div class="tvcolorpicker-v-handle"></div>').appendTo(
                  I,
                )),
                (F = t('<div class="tvcolorpicker-v-area"></div>').appendTo(I)),
                (P = m(t(this), e.hideTransparency)).initEvents(),
                P.updateColor(),
                P.$el.appendTo(U),
                P.val(g(W.val() || T)[3]),
                (R = x.height()),
                ...
                G.addEventListener('keydown', E, !1),
                U
              );
            }
            function S() {
              var e = t(this).prop('ownerDocument') || document;
              t(e).find('.tvcolorpicker-popup').removeClass('opened').remove(),
                t(P).off('change'),
                t(P).off('afterChange'),
            ...
            return (
              ($ = t.extend({}, o.options, $ || {})),
              (O = this),
              $ && 'customColors' in $ && i($.customColors),
              this.each(function () {
                function i() {
                  var t = e(r.val());
                  x.call(r, t);
                ...
                r.val(e(r.val())),
                  ...
                  r
                    ...
                    .attr('readonly', !0),
                  (s = function () {
                    r.data('tvcolorpicker') ||
                      (S.call(r),
                      (o = V.call(r, $)),
                      r.data('tvcolorpicker-custom-color', null),
                      r.data('tvcolorpicker', o),
                      r.data('tvcolorpicker-previous-color', r.val()),
                      o.bind('mousedown click', function (e) {
                        t(e.target).parents().andSelf().is(o) &&
                          (r.focus(),
                          (n = !0),
                          setTimeout(function () {
                            n = !1;
            ...
            .tvcolorpicker({
              customColors: (function (t) {
                ...
                for (e = 0, i = t; e < i.length; e++)
                  (o = i[e]), null !== Object(r.tryParseRgb)(o) && n.push(o);
                return n;
