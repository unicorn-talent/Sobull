(window.webpackJsonp = window.webpackJsonp || []).push([
  ['restricted-toolset', 'series-icons-map'],
  {
    '+l9v': function (e, t) {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 13" width="13" height="13"><path fill="none" stroke="currentColor" stroke-width="1.2" d="M1 1l11 11m0-11L1 12"/></svg>';
    },
    '1Tx8': function (e, t, n) {
      e.exports = {
    ...
    S0BX: function (e, t, n) {
      e.exports = { dropdown: 'dropdown-3caJUCGx', label: 'label-3vchy5zS' };
    },
    SchQ: function (e, t, n) {
      e.exports = {
    ...
    emGF: function (e, t, n) {
      ...
      function a(e, t) {
        ...
        return 0 === e.length
          ? Promise.resolve([])
          : (r.logNormal('Requesting favorites info'),
            (n = []),
            (a = new Map()),
            (o = new Map()),
            (s = new Map()),
                  ...
                  .then(function (e) {
                    var t,
                      ...
                      i =
                        ...
                        a);
                    return (
                      0 !== i.notFoundItems.length &&
                        ((t = i.notFoundItems.map(function (e) {
                          return e.studyId;
                        })),
                        r.logWarn(
                          'Cannot find java scripts: ' + JSON.stringify(t),
                        )),
                      i.items
                    );
                  }),
            ...
            Promise.all(n).then(function (e) {
              return (
                r.logNormal('Requesting favorites info finished'),
      ...
      var i, o, r;
      n.r(t),
        n.d(t, 'getFavoritesInfo', function () {
          return a;
        }),
        (i = n('Eyy1')),
        (o = n('uOxu')),
        (r = Object(o.getLogger)('FavoritesInfo'));
    },
    fD7T: function (e, t) {
      e.exports =
    ...
    miV2: function (e, t, n) {
      ...
      function i(e) {
        ...
        return y.createElement(
          F.a,
          Object(b.__assign)({}, n, { className: z(t, X.button) }),
        );
      }
      function o(e) {
        return y.createElement(
      ...
      function r(e) {
        return y.createElement('div', { className: le.title }, e.children);
      }
      function s(e) {
        return (
          e.info.localizedName || Object(G.t)(e.info.name, { context: 'study' })
        );
      }
      function l(e) {
        var t;
        return y.createElement(
          'div',
          {
            className: z(
              fe.value,
              ((t = {}), (t[fe.selected] = e.isSelected), t),
            ),
          },
          e.value,
          e.metric,
      ...
      function h(e, t) {
        return (
          void 0 === t && (t = !1),
          { id: e, name: Oe[e], items: [], mayOmitSeparator: t }
        );
      }
      function u(e) {
        ...
        return S.a.createElement(A.b, {
          ...
          label: S.a.createElement(
            ...
            S.a.createElement(
              'div',
              { className: St.title },
              S.a.createElement(E.a, { className: St.icon, icon: yt }),
              S.a.createElement('div', { className: St.text }, kt.text),
            ),
          ),
          onClick: t,
        });
      ...
      function p(e) {
        ...
        return S.a.createElement(
          ...
          h &&
            S.a.createElement(A.b, {
              theme: At,
              label: S.a.createElement(v, { className: Ot.description }, h),
              onClick: t,
              isHovered: s,
            }),
        );
        ...
        return S.a.createElement(
          ...
          S.a.createElement(
            ...
            S.a.createElement(
              'div',
              { className: Ft.menu },
              S.a.createElement(d, { onClick: e.onTemplateSave }),
              s.length > 0 && S.a.createElement(L.a, null),
              S.a.createElement(g, {
      ...
      function g(e) {
        var t,
          n = e.templates.filter(function (e) {
            return e.is_default;
          }),
        ...
        return (
          Object(y.useEffect)(function () {
            if (null !== i) {
              var e = {};
              return (
                i.getOnChange().subscribe(e, function () {
                  r(), o && o.update();
                }),
                function () {
          ...
          S.a.createElement(
            ...
            i && n.length > 0 && 0 === a.length && n.map(t),
          )
        );
      }
      function _() {
        return {
          ...
          OpenPopup: Ne,
          Properties:
            C.enabled('header_settings') &&
            C.enabled('show_chart_property_page')
              ? Le
              : void 0,
      ...
      n.r(t),
        ...
        (R = (function (e) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return y.createElement(
                'div',
                Object(b.__assign)({ className: z(n, T.wrap) }, a),
                t,
              );
            }),
            t
        ...
        (P = n('YEs3')),
        ((D = {})[0] = window.t('Bars')),
        (D[1] = window.t('Candles')),
        (D[9] = window.t('Hollow Candles')),
        (D[8] = window.t('Heikin Ashi')),
        (D[2] = window.t('Line')),
        (D[3] = window.t('Area')),
        (D[10] = window.t('Baseline')),
        (D[12] = window.t('High-Low')),
        (V = D),
        (U = { barsStyle: window.t("Bar's Style"), labels: V }),
        (B = (function (e) {
          function t(t, n) {
            var a,
              i,
            ...
            return (
              ...
              (l._handleClickFavorite = function (e) {
                l._isStyleFavorited(e)
                  ? l._handleRemoveFavorite(e)
                  : l._handleAddFavorite(e);
              }),
              (a = n.chartWidgetCollection),
              (i = n.favoriteChartStylesService),
              (o = a.activeChartStyle.value()),
              (r = i.get()),
              ...
              C.enabled('chart_style_hilo') && l.state.styles.push(12),
              l
            );
          }
          return (
            ...
            (t.prototype.render = function () {
              ...
              return (
                f.includes(h) ? void 0 !== p && f.push(p) : f.push(h),
                (e = m && f.length > 1),
                (t = d.map(function (e) {
                    ...
                    I.a,
                    {
                      ...
                      content: e
                        ...
                        : y.createElement(
                            R,
                            null,
                            y.createElement(E.a, { icon: M.SERIES_ICONS[h] }),
                          ),
                      title: e ? U.barsStyle : U.labels[h],
                      className: P.menu,
                    },
                    t,
                    !!n.length && y.createElement(L.a, null),
                    n,
                  ),
                )
              );
            ...
            (t.contextTypes = {
              ...
              favoriteChartStylesService: w.any.isRequired,
            }),
            t
          );
        })(y.PureComponent)),
        ...
        (Y = (function (e) {
          ...
          return (
            ...
            (t.contextTypes = { chartWidgetCollection: w.any.isRequired }),
            t
          );
        })(y.PureComponent)),
        (X = n('EvtC')),
        ...
        (ve = (function (e) {
          function t(t, n) {
            ...
            return (
              (o._promise = null),
              (o._menu = S.a.createRef()),
              (o._handleClick = function () {
                var e = o.props.studyMarket;
                o.setState({ isActive: !0 }, function () {
                  e.isVisible() ? e.hide() : e.show();
                });
              }),
              (o._handleSelectIndicator = function (e) {
                var t, n;
                (e = Object(te.ensureDefined)(e)),
                  (t = o.context.chartWidgetCollection),
                  'java' !== e.type ||
                  null ===
                    (n = Object(ie.tryFindStudyLineToolNameByStudyId)(
                      e.studyId,
                    ))
              ...
              (o._handleFavoriteIndicatorsChange = function () {
                var e = o.context.favoriteScriptsModel,
                  t = Object(b.__spreadArrays)(
                    Object(te.ensureDefined)(e).favorites(),
                  );
                o.setState({ favorites: t }), o._clearCache();
              }),
              ...
              (o._clearCache = function () {
                (o._promise = null), o.setState({ infos: [] });
              }),
              (i =
                void 0 !== (a = n.favoriteScriptsModel) ? a.favorites() : []),
              (o.state = {
                isActive: !1,
                isLoading: !1,
                favorites: i,
          ...
          return (
                ...
                i.length > 0 &&
                  S.a.createElement(
                    ...
                    S.a.createElement(
                      ...
                      l && S.a.createElement(o, null),
                      !l &&
                        S.a.createElement(
                          S.a.Fragment,
                          null,
                          this.state.infos.length > 0
                            ? this.state.infos.map(function (t) {
                                return S.a.createElement(A.b, {
                                  key:
                                    'java' === t.item.type
                                      ? t.item.studyId
            ...
            (t.prototype._prefetchFavorites = function () {
              ...
              null === this._promise &&
                ((e = a.activeChartWidget
                  .value()
                  .model()
                  .model()
                  .studyMetaInfoRepository()),
                this.setState({ isLoading: !0 }),
                (t = this._promise = Object(ae.getFavoritesInfo)(
                  ...
                  if (t === n._promise) {
                    (e = Object(b.__spreadArrays)(e).sort(function (e, t) {
                      ...
                      n.setState({ infos: e, isLoading: !1 }, function () {
            ...
            return (
              ...
              (n._handleClickAdd = function () {
                ...
                r ===
                  ...
                  Math.max(
                    1,
                    Math.min(e, Object(me.getMaxResolutionValue)(t)),
                  )) &&
                  n.props.onAdd(
                    isNaN(parseInt(o)) ? String(r) + o : String(r * Number(o)),
                  );
              }),
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return y.createElement(
                'div',
                {
                  className: z(Ce.form, ((e = {}), (e[Ce.interacting] = i), e)),
                },
                ...
                y.createElement(
                  ...
                  y.createElement(_e.a, { dropped: i }),
                ),
                y.createElement(
                  'div',
        ...
        (ke = n('8d0Q')),
        ((Me = {})[
          (xe = n('LxhU')).ResolutionKind.Seconds
        ] = window.t('Seconds', { context: 'interval_group_name' })),
        (Me[xe.ResolutionKind.Minutes] = window.t('Minutes', {
          context: 'interval_group_name',
        })),
        (Me[xe.ResolutionKind.Hours] = window.t('Hours', {
          context: 'interval_group_name',
        })),
        (Me[xe.ResolutionKind.Days] = window.t('Days', {
          context: 'interval_group_name',
        })),
        (Me[xe.ResolutionKind.Weeks] = window.t('Weeks', {
          context: 'interval_group_name',
        })),
        (Me[xe.ResolutionKind.Months] = window.t('Months', {
          context: 'interval_group_name',
        })),
        (Me[xe.ResolutionKind.Range] = window.t('Ranges', {
          context: 'interval_group_name',
        })),
        (Me[xe.ResolutionKind.Invalid] = ''),
        (Oe = Me),
        (Ee = n('fioS')),
        (Ae = n('aVq2')),
        (Ie = {
        ...
        (ze = Object(ne.b)({ keys: [','], text: window.t('Number or {0}') })),
        (je = (function (e) {
          function t(t, n) {
            var a,
              i,
              ...
              h,
              u,
              d = e.call(this, t, n) || this;
            return (
              (d._menu = S.a.createRef()),
              (d._handleChangeInterval = function (e) {
                var t = d.state,
                  n = t.activeInterval,
                  a = t.lastNotQuicked,
                  i = d._getQuicks();
              ...
              (d._handleCloseMenu = function () {
                d.setState({ isOpenedFormMenu: !1 });
              }),
              (d._handleOpenMenu = function () {
                d.setState({ isOpenedFormMenu: !0 });
              }),
              ...
              (d._handleSelectInterval = function (e) {
                void 0 !== e &&
                  e !== pe.linking.interval.value() &&
                  (Object(me.setLastUsedResolution)(e),
                  pe.linking.interval.setValue(e));
              }),
              (d._handleClickFavorite = function (e) {
                (e = Object(te.ensureDefined)(e)),
                  d._isIntervalFavorite(e)
                    ? d._handleRemoveFavorite(e)
                    : d._handleAddFavorite(e);
              }),
              (d._handleAddFavorite = function (e) {
                var t = d.state.favorites;
                d.context.favoriteIntervalsService.set(
                  Object(b.__spreadArrays)(t, [e]),
                );
              }),
              ...
              (d._handleAddInterval = function (e) {
                ...
                void 0 !== n &&
                  (d._isIntervalDefault(a) ||
                    t.includes(a) ||
                    n.set(
                      Object(me.sortResolutions)(
                        Object(b.__spreadArrays)(t, [a]),
                      ),
                    )),
                  d.setState({ lastAddedInterval: a });
              }),
              ...
              (a = n.chartApiInstance),
              (i = n.favoriteIntervalsService),
              (o = n.customIntervalsService),
              (r = n.intervalsMenuViewStateService),
              (d._customIntervals = C.enabled('custom_resolutions')),
              (l =
                (s = pe.linking.interval.value()) &&
                Object(me.normalizeIntervalString)(s)),
              (c = i.get()),
              (h = void 0 !== o ? o.get() : []),
              (u = r.get()),
              (d._defaultsIntervals = a
                .defaultResolutions()
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              ...
              t.getOnChange().subscribe(this, this._handleChangeFavorites),
                ...
                pe.linking.interval.subscribe(this._handleChangeInterval),
                pe.linking.intraday.subscribe(this._bindedForceUpdate),
                pe.linking.supportedResolutions.subscribe(
            ...
            (t.prototype.componentWillUnmount = function () {
              ...
              t.getOnChange().unsubscribe(this, this._handleChangeFavorites),
                ...
                pe.linking.interval.unsubscribe(this._handleChangeInterval),
                pe.linking.intraday.unsubscribe(this._bindedForceUpdate),
                pe.linking.supportedResolutions.unsubscribe(
                  this._bindedForceUpdate,
                );
            }),
            ...
            (t.prototype.render = function () {
              ...
              return (
                void 0 !== u && f.includes(u)
                  ? void 0 !== v && f.push(v)
                  : void 0 !== u && f.push(u),
                (e = (!(!s || 0 === m.length) || void 0) && f.length > 1),
                (t = {}),
                (n = Object(me.mergeResolutions)(p, d)),
                (void 0 !== u ? n.concat(u) : n)
                  .filter(me.isAvailable)
                  .forEach(function (e) {
                    return (t[e] = !0);
                  }),
                (a = Object(b.__spreadArrays)(
                  this._createMenuItems(n),
                  this._createIntervalForm(),
                )),
                (i =
                  void 0 !== u
                    ? Object(me.getTranslatedResolutionModel)(u)
                    : null),
                S.a.createElement(
                  R,
                  { id: c },
                  e &&
                    f.map(function (e, n) {
                      var a,
                        i = Object(me.getTranslatedResolutionModel)(e);
                      return S.a.createElement(W, {
                        ...
                        className: z(
                          ...
                          ((a = {}),
                          (a[Ae.first] = 0 === n),
                          (a[Ae.last] = n === f.length - 1),
                          a),
                        ),
                        text: S.a.createElement(l, {
                  ...
                  S.a.createElement(
                    ...
                    S.a.createElement('div', { className: Ae.dropdown }, a),
                  ),
                )
              );
            }),
            (t.prototype._createMenuItems = function (e) {
              var t,
                ...
                c = this,
                u = ((n = e),
                (a = h(xe.ResolutionKind.Seconds)),
                (i = h(xe.ResolutionKind.Minutes)),
                (o = h(xe.ResolutionKind.Hours)),
                (r = h(xe.ResolutionKind.Days)),
                (s = h(xe.ResolutionKind.Range)),
                n.forEach(function (e) {
                  var t = new xe.Interval(e);
                  t.isHours()
                    ? o.items.push(e)
                    : t.isMinutes()
            ...
            (t.prototype._renderResolutionsGroup = function (e, t) {
              ...
              if (
                ...
                if (
                  ((i = this.context.intervalsMenuViewStateService),
                  (o = this.state.menuViewState),
                  !i.isAllowed(e.id))
                )
                  return [];
                (r = S.a.createElement(
              ...
              return (
                (!e.mayOmitSeparator || e.items.length > 1) &&
                  (n.unshift(
                    S.a.createElement(L.a, { key: 'begin-' + e.name }),
                  ),
                  n.push(S.a.createElement(L.a, { key: 'end-' + e.name }))),
                n
              );
            }),
            ...
            (t.contextTypes = {
              chartApiInstance: w.any.isRequired,
              favoriteIntervalsService: w.any.isRequired,
              intervalsMenuViewStateService: w.any.isRequired,
              customIntervalsService: w.any,
            }),
            t
          );
        })(S.a.PureComponent)),
        ...
        (Ne = (function (e) {
          ...
          return (
            ...
            (t.contextTypes = {
              isFundamental: w.any,
              chartWidgetCollection: w.any.isRequired,
              windowMessageService: w.any.isRequired,
            }),
            t
          );
        })(y.PureComponent)),
        (He = n('uafl')),
        (We = { hint: window.t('Chart Properties') }),
        (Le = (function (e) {
          function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
        ...
        (Je = {
          strokeDashOffset: (Qe = 0.79 * (Ge = 62.332908630371094)),
          strokeDash: (Ke = 0.8 * Ge),
          strokeGap: (qe = 0.21 * Ge),
          strokeDashCheck: 0,
        }),
        (Ye = {
            ...
            (t.prototype.render = function () {
              var e,
                ...
                v = z(
                  ...
                  s,
                  d && Ue.hovered,
                  (((e = {})[Ue.unsaved] = 'unsaved' === h),
                  (e[Ue.saving] = 'saving' === h),
                  (e[Ue.saved] = 'saved' === h),
                  e),
                );
              return y.createElement(
                ...
                y.createElement(
                  ...
                  y.createElement(
                    'g',
                    { className: Ue.arrow, stroke: 'currentColor' },
                    y.createElement('path', {
                      strokeLinecap: 'square',
                      d: 'M14.5 14.5v10',
                    }),
                    y.createElement('path', { d: 'M11 17l3.5-3.5L18 17' }),
                  ),
                  y.createElement(
                    'g',
                    { className: Ue.check, stroke: 'currentColor' },
                    y.createElement('path', {
            ...
            (t.prototype._goToNextState = function (e) {
              ...
              switch (e) {
                case 'unsaved':
                  ...
                  break;
                case 'saving':
                  'unsaved' !== this.props.state && this.setState(Je),
        ...
        (nt = n('SchQ')),
        (at = C.enabled('widget')),
        (it = Object(Ze.b)(tt, nt)),
        (ot = Object(b.__assign)(Object(b.__assign)({}, tt), it)),
        (rt = {
          copy: window.t('Copy'),
        ...
        (st = []),
        (lt = Object(ne.b)({ keys: ['Ctrl', 'S'], text: '{0} + {1}' })),
        (ct = (function (e) {
          function t(t) {
            var n = e.call(this, t) || this;
            return (
              (n._toolWidgetMenuRef = y.createRef()),
          ...
          return (
                  ...
                  n
                    ? y.createElement(
                        ...
                        y.createElement(a, {
                          id: t,
                          displayMode: i,
                          icon: y.createElement(E.a, { icon: $e }),
                          isDisabled: o,
                          onClick: c,
                          text: rt.copy,
                          title: rt.makeCopy,
            ...
            (t.prototype._renderMenuItems = function () {
              ...
              return (
                ...
                l.push(y.createElement(L.a, { key: 'platform-section-begin' })),
                l.push(
                  y.createElement(A.b, {
                    key: 'load-chart',
          ...
          function t(t, n) {
            ...
            return (
              ...
              (o._onChartSaved = function () {
                o.setState({ isProcessing: !1 });
              }),
              (o._handleAutoSaveEnabled = function (e) {
                0;
              }),
              (o._handleSharingEnabled = function (e) {}),
              (o._handleClickSave = function () {
                o.context.saveChartService.saveChartOrShowTitleDialog(),
                  o._trackEvent('Save click');
              }),
              (o._handleClickSaveFromMenu = function () {
                o.context.saveChartService.saveChartOrShowTitleDialog(),
                  o._trackEvent('Save From Menu');
              }),
              (o._handleClickClone = function () {
                o.context.saveChartService.cloneChart();
              }),
              (o._handleClickSaveAs = function () {
                o.context.saveChartService.saveChartAs(),
                  o._trackEvent('Make a copy');
              }),
              ...
              (o._handleClickLoad = function () {
                o.context.loadChartService.showLoadDialog(),
                  o._trackEvent('Load chart layout');
              }),
              (o._handleHotkey = function () {
                o.context.loadChartService.showLoadDialog();
              }),
              (o._handleClickRename = function () {
                o.context.saveChartService.renameChart(),
                  o._trackEvent('Rename');
              }),
              (a = n.chartWidgetCollection),
            ...
            (t.prototype.componentDidMount = function () {
              ...
              n
                ...
                : (r.getOnChange().subscribe(this, this._onChangeHasChanges),
                  ...
                  (this._hotkeys = Object(Pe.createGroup)({
                    desc: 'Save/Load',
                  })),
                  this._hotkeys.add({
            ...
            (t.prototype.componentWillUnmount = function () {
              ...
              n
                ...
                : (r.getOnChange().unsubscribe(this, this._onChangeHasChanges),
                  ...
                  Object(te.ensureDefined)(this._hotkeys).destroy(),
        ...
        (dt = n('FQhm')),
        (vt = { takeSnapshot: window.t('Take a snapshot') }),
        (pt = Object(ne.b)({ keys: ['Alt', 'S'], text: '{0} + {1}' })),
        (mt = n('koZ+')),
        (Xt = function (e) {
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              var e = this,
                ...
                n = (this._promise = Object(gt.symbolSearchUIService)()
                  .bindToInput(t, {
            ...
            (t.prototype.render = function () {
              ...
              return y.createElement(
                'div',
                { id: s, className: z(Ct.wrap, l) },
                y.createElement(
                  'div',
                  {
                    className: z(
                      Ct.inner,
                      ((e = {}), (e[Ct.isExpanded] = i), e),
                    ),
                  },
                  y.createElement('input', {
                    className: Ct.input,
                  ...
                  Object(_t.canShowSpreadActions)() &&
                    a &&
                    y.createElement('div', {
        ...
        (At = Object(Ze.a)(A.a, { item: Ot.item })),
        (It = n('9NBK')),
        (zt = (function (e) {
          function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            ...
            return (
              (s._handleFavorTemplate = function (e) {
                if (s.props.isShownQuicks) {
                  var t = e.name;
                  s._isTemplateFavorite(t)
                    ? s._removeFavoriteTemplate(t)
                    : s._addFavoriteTemplate(t);
                }
              }),
              ...
              (s._handleDropdownOpen = function () {
                var e = s.context.chartWidgetCollection,
                  ...
                  n = Object(xt.a)(t);
                s.setState({ indicatorNames: Object(xt.b)(n.indicators) });
              }),
              (a = n.favoriteStudyTemplatesService),
              (i = n.studyTemplates),
              (o = void 0 !== a ? a.get() : []),
              (r = i.list()),
              (s.state = { isActive: !1, studyTemplatesList: r, favorites: o }),
              s
            );
          }
          return (
        ...
        (Ut = {
          undoHotKey: Object(ne.b)({ keys: ['Ctrl', 'Z'], text: '{0} + {1}' }),
          redoHotKey: Object(ne.b)({ keys: ['Ctrl', 'Y'], text: '{0} + {1}' }),
        }),
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              ...
              a
                ...
                : ((e = Object(te.ensureNotNull)(this._ref)),
                  Qt.findDOMNode(e).appendChild(n));
            }),
            (t.prototype.componentWillUnmount = function () {
              var e = this.props,
                t = e.width;
