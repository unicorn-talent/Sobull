      ...
      (function () {
        ...
        function i(e, t, n) {
          return function (r, o, i) {
            ...
            if (o != o)
              return (i = t(D.call(r, s, a), V.isNaN)) >= 0 ? i + s : -1;
        ...
        function s(e, t) {
          ...
          for (V.has(e, i) && !V.contains(t, i) && t.push(i); n--; )
            (i = b[n]) in e && e[i] !== o[i] && !V.contains(t, i) && t.push(i);
        }
        var a,
          u,
          c,
        ...
        e.exports && (t = e.exports = V),
          ...
          (V.each = V.forEach = function (e, t, n) {
            ...
            if (((t = a(t, n)), h(e)))
              ...
              for (r = 0, o = (i = V.keys(e)).length; r < o; r++)
                t(e[i[r]], i[r], e);
            return e;
          }),
          ...
          (V.find = V.detect = function (e, t, n) {
            ...
            if (
              void 0 !==
                (r = h(e) ? V.findIndex(e, t, n) : V.findKey(e, t, n)) &&
              -1 !== r
            )
              return e[r];
          }),
          ...
          (V.every = V.all = function (e, t, n) {
            var r, o, i, s;
            for (
              t = u(t, n), o = ((r = !h(e) && V.keys(e)) || e).length, i = 0;
              i < o;
              i++
            )
          ...
          (V.max = function (e, t, n) {
            var r,
              ...
              c = -1 / 0;
            if (null == t && null != e)
              for (i = 0, s = (e = h(e) ? e : V.values(e)).length; i < s; i++)
                (r = e[i]) > a && (a = r);
            else
              (t = u(t, n)),
          ...
          (V.shuffle = function (e) {
            var t,
              ...
              i = Array(o);
            for (t = 0; t < o; t++)
              (n = V.random(0, t)) !== t && (i[t] = i[n]), (i[n] = r[t]);
            return i;
          }),
            ...
            for (
              ...
              (c = e[s]),
                ...
                t
                  ? ((s && i === l) || o.push(c), (i = l))
                  : n
                  ? V.contains(i, l) || (i.push(l), o.push(c))
                  : V.contains(o, c) || o.push(c);
            return o;
          }),
          (V.union = function () {
          ...
          (V.mapObject = function (e, t, n) {
            var r, o, i, s, a;
            for (
              t = u(t, n), o = (r = V.keys(e)).length, i = {}, a = 0;
              a < o;
              a++
            )
              i[(s = r[a])] = t(e[s], s, e);
          ...
          (_ = function (e, t, n, r) {
            ...
            if ((n.push(e), r.push(t), i)) {
              ...
              if (((u = (c = V.keys(e)).length), V.keys(t).length !== u))
                return !1;
              for (; u--; )
                if (((l = c[u]), !V.has(t, l) || !_(e[l], t[l], n, r)))
                  return !1;
            }
    ...
    F2Ge: function (e, t, n) {
      ...
      var r,
        ...
        te = function (e) {
          ...
          return (
            !(this === z && u(U, e) && !u(V, e)) &&
            (!(t || !u(this, e) || !u(U, e) || (u(this, H) && this[H][e])) || t)
          );
        },
        ne = function (e, t) {
          if (((e = k(e)), (t = O(t, !0)), e !== z || !u(U, t) || u(V, t))) {
            var n = P(e, t);
            return (
              !n || !u(U, t) || (u(e, H) && e[H][t]) || (n.enumerable = !0), n
            );
          }
        },
        re = function (e) {
          for (var t, n = M(k(e)), r = [], o = 0; n.length > o; )
            u(U, (t = n[o++])) || t == H || t == p || r.push(t);
          return r;
        },
        oe = function (e) {
          for (
            var t, n = e === z, r = M(n ? V : k(e)), o = [], i = 0;
            r.length > i;

          )
            !u(U, (t = r[i++])) || (n && !u(z, t)) || o.push(U[t]);
          return o;
        };
      for (
        $ ||
        ...
        yt.each(
          ...
          function (e, t) {
            (yt.fn[t] = function (e, n) {
              ...
              U.test(t) && (yt.event.fixHooks[t] = yt.event.keyHooks),
              V.test(t) && (yt.event.fixHooks[t] = yt.event.mouseHooks);
          },
        ),
        (function () {
