(window.webpackJsonp = window.webpackJsonp || []).push([
  ['editobjectdialog'],
  {
      ...
      (function (t) {
        ...
        i('jgM0'),
                ...
                !!i &&
                  ($.each(this._tabs, function (t, e) {
                    ...
                    $(e.wrapperObject)[o ? 'show' : 'hide'](),
                      $(e.labelObject)[o ? 'addClass' : 'removeClass'](
                        'active',
                      );
                  }),
                  e &&
                    (o = this.activeTabSettingsName()) &&
                    TVSettings.setValue(o, i.name),
          ...
          (o.prototype.insertTabs = function () {
            function t(t) {
              a &&
                a.toLowerCase() === t.name.toLowerCase() &&
                (t.defaultOpen = Math.max(
                  ~~t.defaultOpen,
                  c.TabOpenFrom.UserSave,
                )),
                ...
                t.labelObject.on('mousedown', function (t) {
                  function i(t) {
                    ...
                    n =
                      n ||
                      ((e = t),
                      Math.abs(o - e.pageX) > 5 || Math.abs(a - e.pageY) > 5);
                  }
                  var o = t.pageX,
                    a = t.pageY,
                    n = !1,
          ...
          (o.prototype.show = function (e) {
            ...
            if (
              ...
              TradingView.isInherited(this._source.constructor, r) &&
                ((_ = 'series-properties-dialog'),
                u('GUI', 'Series Properties')),
              ...
              h(this._source) &&
                ((_ = 'drawing-properties-dialog'),
                u('GUI', 'Drawing Properties', this._source.name())),
              TradingView.isInherited(this._source.constructor, s) &&
                ((g = this),
                this._model.selectionMacro(function (t) {
                  t.addSourceToSelection(g._source);
                })),
              (m = b.createStudyStrategyPropertyPage(
                this._source,
                this._model,
              )),
              (T = b.createInputsPropertyPage(this._source, this._model)),
              (v = b.createStylesPropertyPage(this._source, this._model)),
              (w = b.createVisibilitiesPropertyPage(this._source, this._model)),
              (P = b.createDisplayPropertyPage(this._source, this._model)),
              (T && !T.widget().is(':empty')) || v || m)
            )
              return (
                (g = this),
                (C = null !== T),
                ...
                !this._model.readOnly() &&
                  ...
                  m.widget().each(function (t, e) {
                    ...
                    isNaN(a) && (a = c.TabPriority.Properties),
                      ...
                      void 0 === (o = $(e).data('layout-tab')) &&
                        (o = c.TabNames.properties),
                      g.appendToTab(e, o, a, i);
                  }),
                this._model.readOnly() ||
                  !C ||
                  T.widget().is(':empty') ||
                  T.widget().each(function (t, e) {
                    ...
                    TradingView.isNaN(s) &&
                      (s = r
                        ? c.TabPriority.Coordinates
                        : c.TabPriority.Inputs),
                      (o = ~~$(e).data('layout-tab-open')),
                      void 0 === (a = $(e).data('layout-tab')) &&
                        (a = r ? c.TabNames.coordinates : c.TabNames.inputs),
                      g.appendToTab(e, a, s, o);
                  }),
                v &&
                  v.widget().each(function (t, e) {
                    ...
                    TradingView.isNaN(r) && (r = c.TabPriority.Style),
                      (o = ~~$(e).data('layout-tab-open')),
                      (a = i('Yc1q')),
                      !o && v instanceof a && (o = c.TabOpenFrom.Default),
                      void 0 === (n = $(e).data('layout-tab')) &&
                        (n = c.TabNames.style),
                      g.appendToTab(e, n, r, o);
                  }),
                P &&
                  P.widget().each(function (t, e) {
                    var i,
                      o,
                      a = +$(e).data('layout-tab-priority');
                ...
                w &&
                  w.widget().each(function (t, e) {
                    g.appendToTab(
                      e,
                      c.TabNames.visibility,
                      c.TabPriority.Display,
                      !1,
                    );
                  }),
                this._source instanceof n &&
                  !!this._source.metaInfo().pine &&
                ...
                (L = $('<div class="dialog-buttons">').appendTo(N)),
                (V = function () {
                  w && w.loadData(), T && T.loadData();
                }),
                (!f || window.is_authenticated) &&
                v &&
                'function' == typeof v.createTemplateButton &&
                t.enabled('linetoolpropertieswidget_template_button')
                  ...
                  ? ((R = [
                      ...
                      },
                      {
                        ...
                        action: function () {
                          g._source.properties().saveDefaults();
                        },
                      },
                    ]),
                    (F = $(
                      ...
                      .on('click', function (t) {
                        t.preventDefault();
                        var e = $(this);
                        e.is('.active') || e.trigger('button-popup', [R, !0]);
                      })
                      .appendTo(L),
                    p(F, null, {
                      direction: 'down',
                ...
                $('input[type="text"]', D).addClass(
                  'tv-text-input inset dialog',
                ),
                $('input.ticker', D).TVTicker(),
                k.css('min-width', I + 'px'),
                d.applyHandlers(k, e),
                (A = {
                  top: ($(window).height() - k.height()) / 2,
                  left: ($(window).width() - k.width()) / 2,
                }),
                v &&
                  'function' == typeof v.dialogPosition &&
                  (A = v.dialogPosition(A, k) || A),
                d.positionDialog(k, A),
                window.lineToolPropertiesToolbar &&
    ...
    Yc1q: function (t, e, i) {
      ...
      function o(t) {
        function e(e, i, o) {
          t.call(this, e, i, o), (this._linetool = o);
        }
        return (
          inherit(e, t),
    ...
    n3Kh: function (t, e, i) {
      ...
      i('PVgW'),
        ...
        (o.prototype.bindBarIndex = function (t, e, i, a) {
          var n = [
            l(t.value()),
            r(o.BarIndexPastLimit),
            s(o.BarIndexFutureLimit),
          ];
          ...
          for (e = 0; e < n.length; e++)
            (i = n[e]),
              (o = this._linetool.properties().points[e]) &&
                ((a = e || r > 1 ? ' ' + (e + 1) : ''),
                this._createPointRow(i, o, a).appendTo(t));
        }),
