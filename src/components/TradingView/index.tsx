...
export function TVChartContainer() {
  ...
  const selectedMarketName: string = findTVMarketFromAddress(
  ...
  }, [selectedMarketName, 'Dark'])

  // TODO: add market back to dep array
  // }, [market])

  return <div id="tv_chart_container" className="tradingview-chart" style={{ height: '900px' }}/>
}
